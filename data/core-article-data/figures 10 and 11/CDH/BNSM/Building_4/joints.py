...
def add_joints() -> None:
    ...
    # Central joint node
    ops.node(4025, 9.0, 0.0, 1.55, '-mass', 4.100726299694189, 4.100726299694189, 4.100726299694189, 0.0, 0.0, 0.0)
    ...
    # Central joint node
    ops.node(4026, 12.0, 0.0, 1.55, '-mass', 4.100726299694189, 4.100726299694189, 4.100726299694189, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4027, 9.0, 0.0, 4.5, '-mass', 4.290902140672783, 4.290902140672783, 4.290902140672783, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4028, 12.0, 0.0, 4.5, '-mass', 4.290902140672783, 4.290902140672783, 4.290902140672783, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4029, 9.0, 0.0, 7.3, '-mass', 4.023318042813456, 4.023318042813456, 4.023318042813456, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34029, 9.225, 0.0, 7.3)
    ...
    # Central joint node
    ops.node(4030, 12.0, 0.0, 7.3, '-mass', 4.023318042813456, 4.023318042813456, 4.023318042813456, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54030, 11.775, 0.0, 7.3)
    ...
    # Central joint node
    ops.node(4031, 9.0, 0.0, 10.1, '-mass', 3.8321865443425076, 3.8321865443425076, 3.8321865443425076, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34031, 9.225, 0.0, 10.1)
    ...
    # Central joint node
    ops.node(4032, 12.0, 0.0, 10.1, '-mass', 3.8321865443425076, 3.8321865443425076, 3.8321865443425076, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54032, 11.775, 0.0, 10.1)
    ...
    # Central joint node
    ops.node(1001, 0.0, 0.0, 3.1, '-mass', 10.762773955147809, 10.762773955147809, 10.762773955147809, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1002, 4.5, 0.0, 3.1, '-mass', 16.943807339449542, 16.943807339449542, 16.943807339449542, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1003, 9.0, 0.0, 3.1, '-mass', 10.942278287461772, 10.942278287461772, 10.942278287461772, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1004, 12.0, 0.0, 3.1, '-mass', 10.942278287461772, 10.942278287461772, 10.942278287461772, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1005, 16.5, 0.0, 3.1, '-mass', 16.943807339449542, 16.943807339449542, 16.943807339449542, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(21005, 16.5, 0.0, 2.825)
    ops.element('elasticBeamColumn', 21005, 21005, 1005, 99999, 99999)
    ops.node(71005, 16.5, 0.0, 3.375)
    ...
    # Central joint node
    ops.node(1006, 21.0, 0.0, 3.1, '-mass', 10.762773955147809, 10.762773955147809, 10.762773955147809, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1007, 0.0, 4.5, 3.1, '-mass', 16.857798165137616, 16.857798165137616, 16.857798165137616, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1008, 4.5, 4.5, 3.1, '-mass', 25.54822884811417, 25.54822884811417, 25.54822884811417, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1009, 9.0, 4.5, 3.1, '-mass', 22.398381753312943, 22.398381753312943, 22.398381753312943, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1010, 12.0, 4.5, 3.1, '-mass', 22.398381753312943, 22.398381753312943, 22.398381753312943, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1011, 16.5, 4.5, 3.1, '-mass', 25.54822884811417, 25.54822884811417, 25.54822884811417, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(21011, 16.5, 4.5, 2.825)
    ops.element('elasticBeamColumn', 21011, 21011, 1011, 99999, 99999)
    ops.node(71011, 16.5, 4.5, 3.375)
    ...
    # Central joint node
    ops.node(1012, 21.0, 4.5, 3.1, '-mass', 16.857798165137616, 16.857798165137616, 16.857798165137616, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1013, 0.0, 9.0, 3.1, '-mass', 16.857798165137616, 16.857798165137616, 16.857798165137616, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1014, 4.5, 9.0, 3.1, '-mass', 25.54822884811417, 25.54822884811417, 25.54822884811417, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1015, 9.0, 9.0, 3.1, '-mass', 22.146088175331293, 22.146088175331293, 22.146088175331293, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1016, 12.0, 9.0, 3.1, '-mass', 22.146088175331293, 22.146088175331293, 22.146088175331293, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1017, 16.5, 9.0, 3.1, '-mass', 25.54822884811417, 25.54822884811417, 25.54822884811417, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(21017, 16.5, 9.0, 2.825)
    ops.element('elasticBeamColumn', 21017, 21017, 1017, 99999, 99999)
    ops.node(71017, 16.5, 9.0, 3.375)
    ...
    # Central joint node
    ops.node(1018, 21.0, 9.0, 3.1, '-mass', 16.857798165137616, 16.857798165137616, 16.857798165137616, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1019, 0.0, 13.5, 3.1, '-mass', 10.48085499490316, 10.48085499490316, 10.48085499490316, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1020, 4.5, 13.5, 3.1, '-mass', 16.943807339449542, 16.943807339449542, 16.943807339449542, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(21020, 4.5, 13.5, 2.825)
    ops.element('elasticBeamColumn', 21020, 21020, 1020, 99999, 99999)
    ops.node(71020, 4.5, 13.5, 3.375)
    ...
    # Central joint node
    ops.node(1021, 9.0, 13.5, 3.1, '-mass', 14.80934633027523, 14.80934633027523, 14.80934633027523, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1022, 12.0, 13.5, 3.1, '-mass', 14.80934633027523, 14.80934633027523, 14.80934633027523, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1023, 16.5, 13.5, 3.1, '-mass', 16.943807339449542, 16.943807339449542, 16.943807339449542, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(21023, 16.5, 13.5, 2.825)
    ops.element('elasticBeamColumn', 21023, 21023, 1023, 99999, 99999)
    ops.node(71023, 16.5, 13.5, 3.375)
    ...
    # Central joint node
    ops.node(1024, 21.0, 13.5, 3.1, '-mass', 10.48085499490316, 10.48085499490316, 10.48085499490316, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2001, 0.0, 0.0, 5.9, '-mass', 10.629937563710499, 10.629937563710499, 10.629937563710499, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2002, 4.5, 0.0, 5.9, '-mass', 16.63704128440367, 16.63704128440367, 16.63704128440367, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2003, 9.0, 0.0, 5.9, '-mass', 10.784116972477063, 10.784116972477063, 10.784116972477063, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2004, 12.0, 0.0, 5.9, '-mass', 10.784116972477063, 10.784116972477063, 10.784116972477063, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2005, 16.5, 0.0, 5.9, '-mass', 16.63704128440367, 16.63704128440367, 16.63704128440367, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2006, 21.0, 0.0, 5.9, '-mass', 10.629937563710499, 10.629937563710499, 10.629937563710499, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2007, 0.0, 4.5, 5.9, '-mass', 16.78038990825688, 16.78038990825688, 16.78038990825688, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2008, 4.5, 4.5, 5.9, '-mass', 25.260575942915395, 25.260575942915395, 25.260575942915395, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2009, 9.0, 4.5, 5.9, '-mass', 22.302816004077467, 22.302816004077467, 22.302816004077467, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2010, 12.0, 4.5, 5.9, '-mass', 22.302816004077467, 22.302816004077467, 22.302816004077467, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2011, 16.5, 4.5, 5.9, '-mass', 25.260575942915395, 25.260575942915395, 25.260575942915395, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2012, 21.0, 4.5, 5.9, '-mass', 16.78038990825688, 16.78038990825688, 16.78038990825688, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2013, 0.0, 9.0, 5.9, '-mass', 16.78038990825688, 16.78038990825688, 16.78038990825688, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2014, 4.5, 9.0, 5.9, '-mass', 25.260575942915395, 25.260575942915395, 25.260575942915395, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2015, 9.0, 9.0, 5.9, '-mass', 22.050522426095817, 22.050522426095817, 22.050522426095817, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2016, 12.0, 9.0, 5.9, '-mass', 22.050522426095817, 22.050522426095817, 22.050522426095817, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2017, 16.5, 9.0, 5.9, '-mass', 25.260575942915395, 25.260575942915395, 25.260575942915395, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2018, 21.0, 9.0, 5.9, '-mass', 16.78038990825688, 16.78038990825688, 16.78038990825688, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2019, 0.0, 13.5, 5.9, '-mass', 10.434027777777777, 10.434027777777777, 10.434027777777777, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2020, 4.5, 13.5, 5.9, '-mass', 16.78038990825688, 16.78038990825688, 16.78038990825688, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2021, 9.0, 13.5, 5.9, '-mass', 14.731938073394495, 14.731938073394495, 14.731938073394495, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2022, 12.0, 13.5, 5.9, '-mass', 14.731938073394495, 14.731938073394495, 14.731938073394495, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2023, 16.5, 13.5, 5.9, '-mass', 16.78038990825688, 16.78038990825688, 16.78038990825688, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2024, 21.0, 13.5, 5.9, '-mass', 10.434027777777777, 10.434027777777777, 10.434027777777777, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3001, 0.0, 0.0, 8.7, '-mass', 10.486588939857286, 10.486588939857286, 10.486588939857286, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3002, 4.5, 0.0, 8.7, '-mass', 16.27866972477064, 16.27866972477064, 16.27866972477064, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3003, 9.0, 0.0, 8.7, '-mass', 10.449636850152904, 10.449636850152904, 10.449636850152904, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53003, 8.775, 0.0, 8.7)
    ops.element('elasticBeamColumn', 53003, 53003, 3003, 99999, 88888)
    ops.node(33003, 9.225, 0.0, 8.7)
    ...
    # Central joint node
    ops.node(3004, 12.0, 0.0, 8.7, '-mass', 10.449636850152904, 10.449636850152904, 10.449636850152904, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53004, 11.775, 0.0, 8.7)
    ops.element('elasticBeamColumn', 53004, 53004, 3004, 99999, 88888)
    ops.node(33004, 12.225, 0.0, 8.7)
    ...
    # Central joint node
    ops.node(3005, 16.5, 0.0, 8.7, '-mass', 16.27866972477064, 16.27866972477064, 16.27866972477064, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3006, 21.0, 0.0, 8.7, '-mass', 10.486588939857286, 10.486588939857286, 10.486588939857286, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3007, 0.0, 4.5, 8.7, '-mass', 16.422018348623855, 16.422018348623855, 16.422018348623855, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3008, 4.5, 4.5, 8.7, '-mass', 24.400484199796125, 24.400484199796125, 24.400484199796125, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3009, 9.0, 4.5, 8.7, '-mass', 21.514398572884808, 21.514398572884808, 21.514398572884808, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3010, 12.0, 4.5, 8.7, '-mass', 21.514398572884808, 21.514398572884808, 21.514398572884808, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3011, 16.5, 4.5, 8.7, '-mass', 24.400484199796125, 24.400484199796125, 24.400484199796125, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3012, 21.0, 4.5, 8.7, '-mass', 16.422018348623855, 16.422018348623855, 16.422018348623855, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3013, 0.0, 9.0, 8.7, '-mass', 16.350344036697248, 16.350344036697248, 16.350344036697248, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3014, 4.5, 9.0, 8.7, '-mass', 24.25713557594291, 24.25713557594291, 24.25713557594291, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3015, 9.0, 9.0, 8.7, '-mass', 21.142647808358813, 21.142647808358813, 21.142647808358813, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3016, 12.0, 9.0, 8.7, '-mass', 21.142647808358813, 21.142647808358813, 21.142647808358813, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3017, 16.5, 9.0, 8.7, '-mass', 24.25713557594291, 24.25713557594291, 24.25713557594291, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3018, 21.0, 9.0, 8.7, '-mass', 16.350344036697248, 16.350344036697248, 16.350344036697248, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3019, 0.0, 13.5, 8.7, '-mass', 10.21900484199796, 10.21900484199796, 10.21900484199796, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3020, 4.5, 13.5, 8.7, '-mass', 16.27866972477064, 16.27866972477064, 16.27866972477064, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53020, 4.275, 13.5, 8.7)
    ops.element('elasticBeamColumn', 53020, 53020, 3020, 99999, 88888)
    ops.node(33020, 4.725, 13.5, 8.7)
    ...
    # Central joint node
    ops.node(3021, 9.0, 13.5, 8.7, '-mass', 14.278000764525993, 14.278000764525993, 14.278000764525993, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53021, 8.775, 13.5, 8.7)
    ops.element('elasticBeamColumn', 53021, 53021, 3021, 99999, 88888)
    ops.node(33021, 9.225, 13.5, 8.7)
    ...
    # Central joint node
    ops.node(3022, 12.0, 13.5, 8.7, '-mass', 14.278000764525993, 14.278000764525993, 14.278000764525993, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53022, 11.775, 13.5, 8.7)
    ops.element('elasticBeamColumn', 53022, 53022, 3022, 99999, 88888)
    ops.node(33022, 12.225, 13.5, 8.7)
    ...
    ops.node(63022, 12.0, 13.275, 8.7)
    ...
    # Central joint node
    ops.node(3023, 16.5, 13.5, 8.7, '-mass', 16.27866972477064, 16.27866972477064, 16.27866972477064, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53023, 16.275, 13.5, 8.7)
    ops.element('elasticBeamColumn', 53023, 53023, 3023, 99999, 88888)
    ops.node(33023, 16.725, 13.5, 8.7)
    ...
    ops.node(63023, 16.5, 13.275, 8.7)
    ...
    # Central joint node
    ops.node(3024, 21.0, 13.5, 8.7, '-mass', 10.21900484199796, 10.21900484199796, 10.21900484199796, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4002, 4.5, 0.0, 11.5, '-mass', 11.34461009174312, 11.34461009174312, 11.34461009174312, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4003, 9.0, 0.0, 11.5, '-mass', 6.341265290519877, 6.341265290519877, 6.341265290519877, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54003, 8.775, 0.0, 11.5)
    ops.element('elasticBeamColumn', 54003, 54003, 4003, 99999, 88888)
    ops.node(34003, 9.225, 0.0, 11.5)
    ...
    # Central joint node
    ops.node(4004, 12.0, 0.0, 11.5, '-mass', 6.341265290519877, 6.341265290519877, 6.341265290519877, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54004, 11.775, 0.0, 11.5)
    ops.element('elasticBeamColumn', 54004, 54004, 4004, 99999, 88888)
    ops.node(34004, 12.225, 0.0, 11.5)
    ...
    ops.node(44004, 12.0, 0.225, 11.5)
    ...
    # Central joint node
    ops.node(4005, 16.5, 0.0, 11.5, '-mass', 11.34461009174312, 11.34461009174312, 11.34461009174312, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4007, 0.0, 4.5, 11.5, '-mass', 11.34461009174312, 11.34461009174312, 11.34461009174312, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4008, 4.5, 4.5, 11.5, '-mass', 21.176732925586137, 21.176732925586137, 21.176732925586137, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4009, 9.0, 4.5, 11.5, '-mass', 17.481205402650353, 17.481205402650353, 17.481205402650353, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4010, 12.0, 4.5, 11.5, '-mass', 17.481205402650353, 17.481205402650353, 17.481205402650353, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4011, 16.5, 4.5, 11.5, '-mass', 21.176732925586137, 21.176732925586137, 21.176732925586137, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4012, 21.0, 4.5, 11.5, '-mass', 11.34461009174312, 11.34461009174312, 11.34461009174312, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4013, 0.0, 9.0, 11.5, '-mass', 11.34461009174312, 11.34461009174312, 11.34461009174312, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4014, 4.5, 9.0, 11.5, '-mass', 21.176732925586137, 21.176732925586137, 21.176732925586137, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4015, 9.0, 9.0, 11.5, '-mass', 18.49037971457696, 18.49037971457696, 18.49037971457696, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4016, 12.0, 9.0, 11.5, '-mass', 18.49037971457696, 18.49037971457696, 18.49037971457696, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4017, 16.5, 9.0, 11.5, '-mass', 21.176732925586137, 21.176732925586137, 21.176732925586137, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4018, 21.0, 9.0, 11.5, '-mass', 11.34461009174312, 11.34461009174312, 11.34461009174312, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4019, 0.0, 13.5, 11.5, '-mass', 6.034817787971458, 6.034817787971458, 6.034817787971458, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4020, 4.5, 13.5, 11.5, '-mass', 11.34461009174312, 11.34461009174312, 11.34461009174312, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54020, 4.275, 13.5, 11.5)
    ops.element('elasticBeamColumn', 54020, 54020, 4020, 99999, 88888)
    ops.node(34020, 4.725, 13.5, 11.5)
    ...
    ops.node(64020, 4.5, 13.275, 11.5)
    ...
    # Central joint node
    ops.node(4021, 9.0, 13.5, 11.5, '-mass', 9.999522171253822, 9.999522171253822, 9.999522171253822, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54021, 8.775, 13.5, 11.5)
    ops.element('elasticBeamColumn', 54021, 54021, 4021, 99999, 88888)
    ops.node(34021, 9.225, 13.5, 11.5)
    ...
    ops.node(64021, 9.0, 13.275, 11.5)
    ...
    # Central joint node
    ops.node(4022, 12.0, 13.5, 11.5, '-mass', 9.999522171253822, 9.999522171253822, 9.999522171253822, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54022, 11.775, 13.5, 11.5)
    ops.element('elasticBeamColumn', 54022, 54022, 4022, 99999, 88888)
    ops.node(34022, 12.225, 13.5, 11.5)
    ...
    ops.node(64022, 12.0, 13.275, 11.5)
    ...
    # Central joint node
    ops.node(4023, 16.5, 13.5, 11.5, '-mass', 11.34461009174312, 11.34461009174312, 11.34461009174312, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54023, 16.275, 13.5, 11.5)
    ops.element('elasticBeamColumn', 54023, 54023, 4023, 99999, 88888)
    ops.node(34023, 16.725, 13.5, 11.5)
    ...
    ops.node(64023, 16.5, 13.275, 11.5)
    ...
    # Central joint node
    ops.node(4024, 21.0, 13.5, 11.5, '-mass', 6.034817787971458, 6.034817787971458, 6.034817787971458, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
