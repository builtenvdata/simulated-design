...
def add_joints() -> None:
    ...
    # Central joint node
    ops.node(4025, 9.0, 0.0, 1.55, '-mass', 4.28835372069317, 4.28835372069317, 4.28835372069317, 0.0, 0.0, 0.0)
    ...
    # Central joint node
    ops.node(4026, 12.0, 0.0, 1.55, '-mass', 4.28835372069317, 4.28835372069317, 4.28835372069317, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4027, 9.0, 0.0, 4.5, '-mass', 4.5846075433231395, 4.5846075433231395, 4.5846075433231395, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4028, 12.0, 0.0, 4.5, '-mass', 4.5846075433231395, 4.5846075433231395, 4.5846075433231395, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4029, 9.0, 0.0, 7.3, '-mass', 4.28835372069317, 4.28835372069317, 4.28835372069317, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4030, 12.0, 0.0, 7.3, '-mass', 4.28835372069317, 4.28835372069317, 4.28835372069317, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4031, 9.0, 0.0, 10.1, '-mass', 4.049439347604485, 4.049439347604485, 4.049439347604485, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4032, 12.0, 0.0, 10.1, '-mass', 4.049439347604485, 4.049439347604485, 4.049439347604485, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1001, 0.0, 0.0, 3.1, '-mass', 11.454988532110093, 11.454988532110093, 11.454988532110093, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1002, 4.5, 0.0, 3.1, '-mass', 17.94597349643221, 17.94597349643221, 17.94597349643221, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1003, 9.0, 0.0, 3.1, '-mass', 11.445750509683995, 11.445750509683995, 11.445750509683995, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1004, 12.0, 0.0, 3.1, '-mass', 11.445750509683995, 11.445750509683995, 11.445750509683995, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(21004, 12.0, 0.0, 2.825)
    ops.element('elasticBeamColumn', 21004, 21004, 1004, 99999, 99999)
    ops.node(71004, 12.0, 0.0, 3.375)
    ...
    # Central joint node
    ops.node(1005, 16.5, 0.0, 3.1, '-mass', 17.94597349643221, 17.94597349643221, 17.94597349643221, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1006, 21.0, 0.0, 3.1, '-mass', 11.454988532110093, 11.454988532110093, 11.454988532110093, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1007, 0.0, 4.5, 3.1, '-mass', 17.75962028542304, 17.75962028542304, 17.75962028542304, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31007, 0.25, 4.5, 3.1)
    ops.element('elasticBeamColumn', 31007, 1007, 31007, 99999, 88888)
    ops.node(21007, 0.0, 4.5, 2.825)
    ops.element('elasticBeamColumn', 21007, 21007, 1007, 99999, 99999)
    ops.node(71007, 0.0, 4.5, 3.375)
    ...
    # Central joint node
    ops.node(1008, 4.5, 4.5, 3.1, '-mass', 28.391628440366972, 28.391628440366972, 28.391628440366972, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1009, 9.0, 4.5, 3.1, '-mass', 23.108435270132517, 23.108435270132517, 23.108435270132517, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1010, 12.0, 4.5, 3.1, '-mass', 23.108435270132517, 23.108435270132517, 23.108435270132517, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(21010, 12.0, 4.5, 2.825)
    ops.element('elasticBeamColumn', 21010, 21010, 1010, 99999, 99999)
    ops.node(71010, 12.0, 4.5, 3.375)
    ...
    # Central joint node
    ops.node(1011, 16.5, 4.5, 3.1, '-mass', 28.391628440366972, 28.391628440366972, 28.391628440366972, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1012, 21.0, 4.5, 3.1, '-mass', 17.75962028542304, 17.75962028542304, 17.75962028542304, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51012, 20.75, 4.5, 3.1)
    ops.element('elasticBeamColumn', 51012, 51012, 1012, 99999, 88888)
    ops.node(21012, 21.0, 4.5, 2.825)
    ops.element('elasticBeamColumn', 21012, 21012, 1012, 99999, 99999)
    ops.node(71012, 21.0, 4.5, 3.375)
    ...
    # Central joint node
    ops.node(1013, 0.0, 9.0, 3.1, '-mass', 17.75962028542304, 17.75962028542304, 17.75962028542304, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31013, 0.25, 9.0, 3.1)
    ops.element('elasticBeamColumn', 31013, 1013, 31013, 99999, 88888)
    ops.node(21013, 0.0, 9.0, 2.825)
    ops.element('elasticBeamColumn', 21013, 21013, 1013, 99999, 99999)
    ops.node(71013, 0.0, 9.0, 3.375)
    ...
    # Central joint node
    ops.node(1014, 4.5, 9.0, 3.1, '-mass', 28.391628440366972, 28.391628440366972, 28.391628440366972, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1015, 9.0, 9.0, 3.1, '-mass', 22.856141692150864, 22.856141692150864, 22.856141692150864, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1016, 12.0, 9.0, 3.1, '-mass', 22.856141692150864, 22.856141692150864, 22.856141692150864, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(21016, 12.0, 9.0, 2.825)
    ops.element('elasticBeamColumn', 21016, 21016, 1016, 99999, 99999)
    ops.node(71016, 12.0, 9.0, 3.375)
    ...
    # Central joint node
    ops.node(1017, 16.5, 9.0, 3.1, '-mass', 28.391628440366972, 28.391628440366972, 28.391628440366972, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1018, 21.0, 9.0, 3.1, '-mass', 17.75962028542304, 17.75962028542304, 17.75962028542304, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51018, 20.75, 9.0, 3.1)
    ops.element('elasticBeamColumn', 51018, 51018, 1018, 99999, 88888)
    ops.node(21018, 21.0, 9.0, 2.825)
    ops.element('elasticBeamColumn', 21018, 21018, 1018, 99999, 99999)
    ops.node(71018, 21.0, 9.0, 3.375)
    ...
    # Central joint node
    ops.node(1019, 0.0, 13.5, 3.1, '-mass', 11.221489551478085, 11.221489551478085, 11.221489551478085, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31019, 0.2, 13.5, 3.1)
    ...
    # Central joint node
    ops.node(1020, 4.5, 13.5, 3.1, '-mass', 18.117991845056064, 18.117991845056064, 18.117991845056064, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1021, 9.0, 13.5, 3.1, '-mass', 15.634715851172274, 15.634715851172274, 15.634715851172274, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(21021, 9.0, 13.5, 2.825)
    ops.element('elasticBeamColumn', 21021, 21021, 1021, 99999, 99999)
    ops.node(71021, 9.0, 13.5, 3.375)
    ...
    # Central joint node
    ops.node(1022, 12.0, 13.5, 3.1, '-mass', 15.634715851172274, 15.634715851172274, 15.634715851172274, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(21022, 12.0, 13.5, 2.825)
    ops.element('elasticBeamColumn', 21022, 21022, 1022, 99999, 99999)
    ops.node(71022, 12.0, 13.5, 3.375)
    ...
    # Central joint node
    ops.node(1023, 16.5, 13.5, 3.1, '-mass', 18.117991845056064, 18.117991845056064, 18.117991845056064, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1024, 21.0, 13.5, 3.1, '-mass', 11.221489551478085, 11.221489551478085, 11.221489551478085, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51024, 20.8, 13.5, 3.1)
    ...
    # Central joint node
    ops.node(2001, 0.0, 0.0, 5.9, '-mass', 11.377580275229358, 11.377580275229358, 11.377580275229358, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32001, 0.225, 0.0, 5.9)
    ops.element('elasticBeamColumn', 32001, 2001, 32001, 99999, 88888)
    ops.node(22001, 0.0, 0.0, 5.625)
    ops.element('elasticBeamColumn', 22001, 22001, 2001, 99999, 99999)
    ops.node(72001, 0.0, 0.0, 6.175)
    ...
    # Central joint node
    ops.node(2002, 4.5, 0.0, 5.9, '-mass', 17.850407747196737, 17.850407747196737, 17.850407747196737, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2003, 9.0, 0.0, 5.9, '-mass', 11.397967635066257, 11.397967635066257, 11.397967635066257, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2004, 12.0, 0.0, 5.9, '-mass', 11.397967635066257, 11.397967635066257, 11.397967635066257, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2005, 16.5, 0.0, 5.9, '-mass', 17.850407747196737, 17.850407747196737, 17.850407747196737, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2006, 21.0, 0.0, 5.9, '-mass', 11.377580275229358, 11.377580275229358, 11.377580275229358, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52006, 20.775, 0.0, 5.9)
    ops.element('elasticBeamColumn', 52006, 52006, 2006, 99999, 88888)
    ops.node(22006, 21.0, 0.0, 5.625)
    ops.element('elasticBeamColumn', 22006, 22006, 2006, 99999, 99999)
    ops.node(72006, 21.0, 0.0, 6.175)
    ...
    # Central joint node
    ops.node(2007, 0.0, 4.5, 5.9, '-mass', 17.664054536187564, 17.664054536187564, 17.664054536187564, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2008, 4.5, 4.5, 5.9, '-mass', 28.17660550458715, 28.17660550458715, 28.17660550458715, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2009, 9.0, 4.5, 5.9, '-mass', 22.992800713557592, 22.992800713557592, 22.992800713557592, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2010, 12.0, 4.5, 5.9, '-mass', 22.992800713557592, 22.992800713557592, 22.992800713557592, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2011, 16.5, 4.5, 5.9, '-mass', 28.17660550458715, 28.17660550458715, 28.17660550458715, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2012, 21.0, 4.5, 5.9, '-mass', 17.664054536187564, 17.664054536187564, 17.664054536187564, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2013, 0.0, 9.0, 5.9, '-mass', 17.664054536187564, 17.664054536187564, 17.664054536187564, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2014, 4.5, 9.0, 5.9, '-mass', 28.17660550458715, 28.17660550458715, 28.17660550458715, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2015, 9.0, 9.0, 5.9, '-mass', 22.740507135575942, 22.740507135575942, 22.740507135575942, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2016, 12.0, 9.0, 5.9, '-mass', 22.740507135575942, 22.740507135575942, 22.740507135575942, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2017, 16.5, 9.0, 5.9, '-mass', 28.17660550458715, 28.17660550458715, 28.17660550458715, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2018, 21.0, 9.0, 5.9, '-mass', 17.664054536187564, 17.664054536187564, 17.664054536187564, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2019, 0.0, 13.5, 5.9, '-mass', 11.16032747196738, 11.16032747196738, 11.16032747196738, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32019, 0.2, 13.5, 5.9)
    ops.element('elasticBeamColumn', 32019, 2019, 32019, 99999, 88888)
    ops.node(22019, 0.0, 13.5, 5.625)
    ops.element('elasticBeamColumn', 22019, 22019, 2019, 99999, 99999)
    ops.node(72019, 0.0, 13.5, 6.175)
    ops.element('elasticBeamColumn', 72019, 2019, 72019, 99999, 99999)
    ops.node(62019, 0.0, 13.3, 5.9)
    ...
    # Central joint node
    ops.node(2020, 4.5, 13.5, 5.9, '-mass', 18.022426095820588, 18.022426095820588, 18.022426095820588, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2021, 9.0, 13.5, 5.9, '-mass', 15.5391501019368, 15.5391501019368, 15.5391501019368, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2022, 12.0, 13.5, 5.9, '-mass', 15.5391501019368, 15.5391501019368, 15.5391501019368, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2023, 16.5, 13.5, 5.9, '-mass', 18.022426095820588, 18.022426095820588, 18.022426095820588, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2024, 21.0, 13.5, 5.9, '-mass', 11.16032747196738, 11.16032747196738, 11.16032747196738, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52024, 20.8, 13.5, 5.9)
    ops.element('elasticBeamColumn', 52024, 52024, 2024, 99999, 88888)
    ops.node(22024, 21.0, 13.5, 5.625)
    ops.element('elasticBeamColumn', 22024, 22024, 2024, 99999, 99999)
    ops.node(72024, 21.0, 13.5, 6.175)
    ops.element('elasticBeamColumn', 72024, 2024, 72024, 99999, 99999)
    ops.node(62024, 21.0, 13.3, 5.9)
    ...
    # Central joint node
    ops.node(3001, 0.0, 0.0, 8.7, '-mass', 10.933199541284404, 10.933199541284404, 10.933199541284404, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33001, 0.225, 0.0, 8.7)
    ...
    # Central joint node
    ops.node(3002, 4.5, 0.0, 8.7, '-mass', 16.975981141692152, 16.975981141692152, 16.975981141692152, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3003, 9.0, 0.0, 8.7, '-mass', 10.810238277268093, 10.810238277268093, 10.810238277268093, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3004, 12.0, 0.0, 8.7, '-mass', 10.810238277268093, 10.810238277268093, 10.810238277268093, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3005, 16.5, 0.0, 8.7, '-mass', 16.975981141692152, 16.975981141692152, 16.975981141692152, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3006, 21.0, 0.0, 8.7, '-mass', 10.933199541284404, 10.933199541284404, 10.933199541284404, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53006, 20.775, 0.0, 8.7)
    ...
    # Central joint node
    ops.node(3007, 0.0, 4.5, 8.7, '-mass', 16.975981141692152, 16.975981141692152, 16.975981141692152, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3008, 4.5, 4.5, 8.7, '-mass', 26.829128440366972, 26.829128440366972, 26.829128440366972, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53008, 4.125, 4.5, 8.7)
    ops.element('elasticBeamColumn', 53008, 53008, 3008, 99999, 88888)
    ops.node(33008, 4.875, 4.5, 8.7)
    ...
    # Central joint node
    ops.node(3009, 9.0, 4.5, 8.7, '-mass', 22.15182212028542, 22.15182212028542, 22.15182212028542, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3010, 12.0, 4.5, 8.7, '-mass', 22.15182212028542, 22.15182212028542, 22.15182212028542, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3011, 16.5, 4.5, 8.7, '-mass', 26.829128440366972, 26.829128440366972, 26.829128440366972, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53011, 16.125, 4.5, 8.7)
    ops.element('elasticBeamColumn', 53011, 53011, 3011, 99999, 88888)
    ops.node(33011, 16.875, 4.5, 8.7)
    ...
    ops.node(63011, 16.5, 4.125, 8.7)
    ops.element('elasticBeamColumn', 63011, 63011, 3011, 99999, 77777)
    ops.node(43011, 16.5, 4.875, 8.7)
    ...
    # Central joint node
    ops.node(3012, 21.0, 4.5, 8.7, '-mass', 16.975981141692152, 16.975981141692152, 16.975981141692152, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3013, 0.0, 9.0, 8.7, '-mass', 16.975981141692152, 16.975981141692152, 16.975981141692152, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3014, 4.5, 9.0, 8.7, '-mass', 26.829128440366972, 26.829128440366972, 26.829128440366972, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53014, 4.125, 9.0, 8.7)
    ops.element('elasticBeamColumn', 53014, 53014, 3014, 99999, 88888)
    ops.node(33014, 4.875, 9.0, 8.7)
    ...
    # Central joint node
    ops.node(3015, 9.0, 9.0, 8.7, '-mass', 21.89952854230377, 21.89952854230377, 21.89952854230377, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3016, 12.0, 9.0, 8.7, '-mass', 21.89952854230377, 21.89952854230377, 21.89952854230377, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3017, 16.5, 9.0, 8.7, '-mass', 26.829128440366972, 26.829128440366972, 26.829128440366972, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53017, 16.125, 9.0, 8.7)
    ops.element('elasticBeamColumn', 53017, 53017, 3017, 99999, 88888)
    ops.node(33017, 16.875, 9.0, 8.7)
    ...
    ops.node(63017, 16.5, 8.625, 8.7)
    ops.element('elasticBeamColumn', 63017, 63017, 3017, 99999, 77777)
    ops.node(43017, 16.5, 9.375, 8.7)
    ...
    # Central joint node
    ops.node(3018, 21.0, 9.0, 8.7, '-mass', 16.975981141692152, 16.975981141692152, 16.975981141692152, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3019, 0.0, 13.5, 8.7, '-mass', 10.6299375637105, 10.6299375637105, 10.6299375637105, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3020, 4.5, 13.5, 8.7, '-mass', 16.975981141692152, 16.975981141692152, 16.975981141692152, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3021, 9.0, 13.5, 8.7, '-mass', 14.808072120285424, 14.808072120285424, 14.808072120285424, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3022, 12.0, 13.5, 8.7, '-mass', 14.808072120285424, 14.808072120285424, 14.808072120285424, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3023, 16.5, 13.5, 8.7, '-mass', 16.975981141692152, 16.975981141692152, 16.975981141692152, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3024, 21.0, 13.5, 8.7, '-mass', 10.6299375637105, 10.6299375637105, 10.6299375637105, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4001, 0.0, 0.0, 11.5, '-mass', 6.3202408256880735, 6.3202408256880735, 6.3202408256880735, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34001, 0.225, 0.0, 11.5)
    ...
    # Central joint node
    ops.node(4002, 4.5, 0.0, 11.5, '-mass', 11.51408002038736, 11.51408002038736, 11.51408002038736, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4003, 9.0, 0.0, 11.5, '-mass', 6.426000254841997, 6.426000254841997, 6.426000254841997, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4004, 12.0, 0.0, 11.5, '-mass', 6.426000254841997, 6.426000254841997, 6.426000254841997, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4005, 16.5, 0.0, 11.5, '-mass', 11.51408002038736, 11.51408002038736, 11.51408002038736, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4006, 21.0, 0.0, 11.5, '-mass', 6.3202408256880735, 6.3202408256880735, 6.3202408256880735, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54006, 20.775, 0.0, 11.5)
    ...
    ops.node(44006, 21.0, 0.225, 11.5)
    ...
    # Central joint node
    ops.node(4007, 0.0, 4.5, 11.5, '-mass', 11.51408002038736, 11.51408002038736, 11.51408002038736, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4008, 4.5, 4.5, 11.5, '-mass', 22.104357798165136, 22.104357798165136, 22.104357798165136, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54008, 4.125, 4.5, 11.5)
    ops.element('elasticBeamColumn', 54008, 54008, 4008, 99999, 88888)
    ops.node(34008, 4.875, 4.5, 11.5)
    ...
    ops.node(64008, 4.5, 4.125, 11.5)
    ops.element('elasticBeamColumn', 64008, 64008, 4008, 99999, 77777)
    ops.node(44008, 4.5, 4.875, 11.5)
    ...
    # Central joint node
    ops.node(4009, 9.0, 4.5, 11.5, '-mass', 17.668514271151885, 17.668514271151885, 17.668514271151885, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4010, 12.0, 4.5, 11.5, '-mass', 17.668514271151885, 17.668514271151885, 17.668514271151885, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4011, 16.5, 4.5, 11.5, '-mass', 22.104357798165136, 22.104357798165136, 22.104357798165136, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54011, 16.125, 4.5, 11.5)
    ops.element('elasticBeamColumn', 54011, 54011, 4011, 99999, 88888)
    ops.node(34011, 16.875, 4.5, 11.5)
    ...
    ops.node(64011, 16.5, 4.125, 11.5)
    ops.element('elasticBeamColumn', 64011, 64011, 4011, 99999, 77777)
    ops.node(44011, 16.5, 4.875, 11.5)
    ...
    # Central joint node
    ops.node(4012, 21.0, 4.5, 11.5, '-mass', 11.51408002038736, 11.51408002038736, 11.51408002038736, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4013, 0.0, 9.0, 11.5, '-mass', 11.51408002038736, 11.51408002038736, 11.51408002038736, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4014, 4.5, 9.0, 11.5, '-mass', 22.104357798165136, 22.104357798165136, 22.104357798165136, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54014, 4.125, 9.0, 11.5)
    ops.element('elasticBeamColumn', 54014, 54014, 4014, 99999, 88888)
    ops.node(34014, 4.875, 9.0, 11.5)
    ...
    ops.node(64014, 4.5, 8.625, 11.5)
    ops.element('elasticBeamColumn', 64014, 64014, 4014, 99999, 77777)
    ops.node(44014, 4.5, 9.375, 11.5)
    ...
    # Central joint node
    ops.node(4015, 9.0, 9.0, 11.5, '-mass', 18.677688583078492, 18.677688583078492, 18.677688583078492, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4016, 12.0, 9.0, 11.5, '-mass', 18.677688583078492, 18.677688583078492, 18.677688583078492, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4017, 16.5, 9.0, 11.5, '-mass', 22.104357798165136, 22.104357798165136, 22.104357798165136, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54017, 16.125, 9.0, 11.5)
    ops.element('elasticBeamColumn', 54017, 54017, 4017, 99999, 88888)
    ops.node(34017, 16.875, 9.0, 11.5)
    ...
    ops.node(64017, 16.5, 8.625, 11.5)
    ops.element('elasticBeamColumn', 64017, 64017, 4017, 99999, 77777)
    ops.node(44017, 16.5, 9.375, 11.5)
    ...
    # Central joint node
    ops.node(4018, 21.0, 9.0, 11.5, '-mass', 11.51408002038736, 11.51408002038736, 11.51408002038736, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4020, 4.5, 13.5, 11.5, '-mass', 11.51408002038736, 11.51408002038736, 11.51408002038736, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4021, 9.0, 13.5, 11.5, '-mass', 10.168992099898063, 10.168992099898063, 10.168992099898063, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4022, 12.0, 13.5, 11.5, '-mass', 10.168992099898063, 10.168992099898063, 10.168992099898063, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4023, 16.5, 13.5, 11.5, '-mass', 11.51408002038736, 11.51408002038736, 11.51408002038736, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
