...
def add_joints() -> None:
    ...
    # Central joint node
    ops.node(4027, 9.0, 0.0, 4.5, '-mass', 4.771916411824669, 4.771916411824669, 4.771916411824669, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4028, 12.0, 0.0, 4.5, '-mass', 4.771916411824669, 4.771916411824669, 4.771916411824669, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4031, 9.0, 0.0, 10.1, '-mass', 4.2845310907237515, 4.2845310907237515, 4.2845310907237515, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4032, 12.0, 0.0, 10.1, '-mass', 4.2845310907237515, 4.2845310907237515, 4.2845310907237515, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1001, 0.0, 0.0, 3.1, '-mass', 11.54099770642202, 11.54099770642202, 11.54099770642202, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1002, 4.5, 0.0, 3.1, '-mass', 18.512678389398573, 18.512678389398573, 18.512678389398573, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1003, 9.0, 0.0, 3.1, '-mass', 11.958460754332314, 11.958460754332314, 11.958460754332314, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1004, 12.0, 0.0, 3.1, '-mass', 11.958460754332314, 11.958460754332314, 11.958460754332314, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1005, 16.5, 0.0, 3.1, '-mass', 18.512678389398573, 18.512678389398573, 18.512678389398573, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1006, 21.0, 0.0, 3.1, '-mass', 11.54099770642202, 11.54099770642202, 11.54099770642202, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1007, 0.0, 4.5, 3.1, '-mass', 18.512678389398577, 18.512678389398577, 18.512678389398577, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1008, 4.5, 4.5, 3.1, '-mass', 29.108371559633028, 29.108371559633028, 29.108371559633028, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1009, 9.0, 4.5, 3.1, '-mass', 24.951898572884808, 24.951898572884808, 24.951898572884808, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1010, 12.0, 4.5, 3.1, '-mass', 24.951898572884808, 24.951898572884808, 24.951898572884808, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1011, 16.5, 4.5, 3.1, '-mass', 29.108371559633028, 29.108371559633028, 29.108371559633028, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1012, 21.0, 4.5, 3.1, '-mass', 18.512678389398577, 18.512678389398577, 18.512678389398577, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1013, 0.0, 9.0, 3.1, '-mass', 18.3263251783894, 18.3263251783894, 18.3263251783894, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1014, 4.5, 9.0, 3.1, '-mass', 28.735665137614674, 28.735665137614674, 28.735665137614674, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1015, 9.0, 9.0, 3.1, '-mass', 24.389016309887868, 24.389016309887868, 24.389016309887868, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1016, 12.0, 9.0, 3.1, '-mass', 24.389016309887868, 24.389016309887868, 24.389016309887868, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1017, 16.5, 9.0, 3.1, '-mass', 28.735665137614674, 28.735665137614674, 28.735665137614674, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1018, 21.0, 9.0, 3.1, '-mass', 18.3263251783894, 18.3263251783894, 18.3263251783894, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1019, 0.0, 13.5, 3.1, '-mass', 11.713016055045873, 11.713016055045873, 11.713016055045873, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1020, 4.5, 13.5, 3.1, '-mass', 18.85671508664628, 18.85671508664628, 18.85671508664628, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1021, 9.0, 13.5, 3.1, '-mass', 16.48811799184506, 16.48811799184506, 16.48811799184506, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1022, 12.0, 13.5, 3.1, '-mass', 16.48811799184506, 16.48811799184506, 16.48811799184506, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1023, 16.5, 13.5, 3.1, '-mass', 18.85671508664628, 18.85671508664628, 18.85671508664628, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(
 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3006, 21.0, 0.0, 8.7, '-mass', 11.14822247706422, 11.14822247706422, 11.14822247706422, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3007, 0.0, 4.5, 8.7, '-mass', 17.86665392456677, 17.86665392456677, 17.86665392456677, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33007, 0.275, 4.5, 8.7)
    ...
    # Central joint node
    ops.node(3008, 4.5, 4.5, 8.7, '-mass', 27.459862385321102, 27.459862385321102, 27.459862385321102, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3009, 9.0, 4.5, 8.7, '-mass', 23.84906982670744, 23.84906982670744, 23.84906982670744, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53009, 8.675, 4.5, 8.7)
    ops.element('elasticBeamColumn', 53009, 53009, 3009, 99999, 88888)
    ops.node(33009, 9.325, 4.5, 8.7)
    ...
    # Central joint node
    ops.node(3010, 12.0, 4.5, 8.7, '-mass', 23.84906982670744, 23.84906982670744, 23.84906982670744, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53010, 11.675, 4.5, 8.7)
    ops.element('elasticBeamColumn', 53010, 53010, 3010, 99999, 88888)
    ops.node(33010, 12.325, 4.5, 8.7)
    ...
    ops.node(63010, 12.0, 4.175, 8.7)
    ops.element('elasticBeamColumn', 63010, 63010, 3010, 99999, 77777)
    ops.node(43010, 12.0, 4.825, 8.7)
    ...
    # Central joint node
    ops.node(3011, 16.5, 4.5, 8.7, '-mass', 27.459862385321102, 27.459862385321102, 27.459862385321102, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3012, 21.0, 4.5, 8.7, '-mass', 17.86665392456677, 17.86665392456677, 17.86665392456677, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53012, 20.725, 4.5, 8.7)
    ...
    ops.node(63012, 21.0, 4.225, 8.7)
    ops.element('elasticBeamColumn', 63012, 63012, 3012, 99999, 77777)
    ops.node(43012, 21.0, 4.775, 8.7)
    ...
    # Central joint node
    ops.node(3013, 0.0, 9.0, 8.7, '-mass', 17.78064475025484, 17.78064475025484, 17.78064475025484, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33013, 0.275, 9.0, 8.7)
    ...
    # Central joint node
    ops.node(3014, 4.5, 9.0, 8.7, '-mass', 27.287844036697244, 27.287844036697244, 27.287844036697244, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3015, 9.0, 9.0, 8.7, '-mass', 23.453427624872578, 23.453427624872578, 23.453427624872578, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53015, 8.675, 9.0, 8.7)
    ops.element('elasticBeamColumn', 53015, 53015, 3015, 99999, 88888)
    ops.node(33015, 9.325, 9.0, 8.7)
    ...
    # Central joint node
    ops.node(3016, 12.0, 9.0, 8.7, '-mass', 23.453427624872578, 23.453427624872578, 23.453427624872578, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53016, 11.675, 9.0, 8.7)
    ops.element('elasticBeamColumn', 53016, 53016, 3016, 99999, 88888)
    ops.node(33016, 12.325, 9.0, 8.7)
    ...
    ops.node(63016, 12.0, 8.675, 8.7)
    ops.element('elasticBeamColumn', 63016, 63016, 3016, 99999, 77777)
    ops.node(43016, 12.0, 9.325, 8.7)
    ...
    # Central joint node
    ops.node(3017, 16.5, 9.0, 8.7, '-mass', 27.287844036697244, 27.287844036697244, 27.287844036697244, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3018, 21.0, 9.0, 8.7, '-mass', 17.78064475025484, 17.78064475025484, 17.78064475025484, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53018, 20.725, 9.0, 8.7)
    ...
    ops.node(63018, 21.0, 8.725, 8.7)
    ops.element('elasticBeamColumn', 63018, 63018, 3018, 99999, 77777)
    ops.node(43018, 21.0, 9.275, 8.7)
    ...
    # Central joint node
    ops.node(3019, 0.0, 13.5, 8.7, '-mass', 11.14822247706422, 11.14822247706422, 11.14822247706422, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33019, 0.225, 13.5, 8.7)
    ...
    # Central joint node
    ops.node(3020, 4.5, 13.5, 8.7, '-mass', 17.579956676860345, 17.579956676860345, 17.579956676860345, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3021, 9.0, 13.5, 8.7, '-mass', 15.53150484199796, 15.53150484199796, 15.53150484199796, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3022, 12.0, 13.5, 8.7, '-mass', 15.53150484199796, 15.53150484199796, 15.53150484199796, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3023, 16.5, 13.5, 8.7, '-mass', 17.579956676860345, 17.579956676860345, 17.579956676860345, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3024, 21.0, 13.5, 8.7, '-mass', 11.14822247706422, 11.14822247706422, 11.14822247706422, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53024, 20.775, 13.5, 8.7)
    ...
    ops.node(63024, 21.0, 13.275, 8.7)
    ...
    # Central joint node
    ops.node(4003, 9.0, 0.0, 11.5, '-mass', 6.5196546890927625, 6.5196546890927625, 6.5196546890927625, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4004, 12.0, 0.0, 11.5, '-mass', 6.5196546890927625, 6.5196546890927625, 6.5196546890927625, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4007, 0.0, 4.5, 11.5, '-mass', 11.70138888888889, 11.70138888888889, 11.70138888888889, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34007, 0.275, 4.5, 11.5)
    ...
    ops.node(64007, 0.0, 4.225, 11.5)
    ops.element('elasticBeamColumn', 64007, 64007, 4007, 99999, 77777)
    ops.node(44007, 0.0, 4.775, 11.5)
    ...
    # Central joint node
    ops.node(4008, 4.5, 4.5, 11.5, '-mass', 22.247706422018346, 22.247706422018346, 22.247706422018346, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4009, 9.0, 4.5, 11.5, '-mass', 18.096648827726806, 18.096648827726806, 18.096648827726806, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54009, 8.675, 4.5, 11.5)
    ops.element('elasticBeamColumn', 54009, 54009, 4009, 99999, 88888)
    ops.node(34009, 9.325, 4.5, 11.5)
    ...
    ops.node(64009, 9.0, 4.175, 11.5)
    ops.element('elasticBeamColumn', 64009, 64009, 4009, 99999, 77777)
    ops.node(44009, 9.0, 4.825, 11.5)
    ...
    # Central joint node
    ops.node(4010, 12.0, 4.5, 11.5, '-mass', 18.096648827726806, 18.096648827726806, 18.096648827726806, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54010, 11.675, 4.5, 11.5)
    ops.element('elasticBeamColumn', 54010, 54010, 4010, 99999, 88888)
    ops.node(34010, 12.325, 4.5, 11.5)
    ...
    ops.node(64010, 12.0, 4.175, 11.5)
    ops.element('elasticBeamColumn', 64010, 64010, 4010, 99999, 77777)
    ops.node(44010, 12.0, 4.825, 11.5)
    ...
    # Central joint node
    ops.node(4011, 16.5, 4.5, 11.5, '-mass', 22.247706422018346, 22.247706422018346, 22.247706422018346, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4012, 21.0, 4.5, 11.5, '-mass', 11.70138888888889, 11.70138888888889, 11.70138888888889, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54012, 20.725, 4.5, 11.5)
    ...
    ops.node(64012, 21.0, 4.225, 11.5)
    ops.element('elasticBeamColumn', 64012, 64012, 4012, 99999, 77777)
    ops.node(44012, 21.0, 4.775, 11.5)
    ...
    # Central joint node
    ops.node(4013, 0.0, 9.0, 11.5, '-mass', 11.70138888888889, 11.70138888888889, 11.70138888888889, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34013, 0.275, 9.0, 11.5)
    ...
    ops.node(64013, 0.0, 8.725, 11.5)
    ops.element('elasticBeamColumn', 64013, 64013, 4013, 99999, 77777)
    ops.node(44013, 0.0, 9.275, 11.5)
    ...
    # Central joint node
    ops.node(4014, 4.5, 9.0, 11.5, '-mass', 22.247706422018346, 22.247706422018346, 22.247706422018346, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4015, 9.0, 9.0, 11.5, '-mass', 19.105823139653413, 19.105823139653413, 19.105823139653413, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54015, 8.675, 9.0, 11.5)
    ops.element('elasticBeamColumn', 54015, 54015, 4015, 99999, 88888)
    ops.node(34015, 9.325, 9.0, 11.5)
    ...
    ops.node(64015, 9.0, 8.675, 11.5)
    ops.element('elasticBeamColumn', 64015, 64015, 4015, 99999, 77777)
    ops.node(44015, 9.0, 9.325, 11.5)
    ...
    # Central joint node
    ops.node(4016, 12.0, 9.0, 11.5, '-mass', 19.105823139653413, 19.105823139653413, 19.105823139653413, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54016, 11.675, 9.0, 11.5)
    ops.element('elasticBeamColumn', 54016, 54016, 4016, 99999, 88888)
    ops.node(34016, 12.325, 9.0, 11.5)
    ...
    ops.node(64016, 12.0, 8.675, 11.5)
    ops.element('elasticBeamColumn', 64016, 64016, 4016, 99999, 77777)
    ops.node(44016, 12.0, 9.325, 11.5)
    ...
    # Central joint node
    ops.node(4017, 16.5, 9.0, 11.5, '-mass', 22.247706422018346, 22.247706422018346, 22.247706422018346, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4018, 21.0, 9.0, 11.5, '-mass', 11.70138888888889, 11.70138888888889, 11.70138888888889, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54018, 20.725, 9.0, 11.5)
    ...
    ops.node(64018, 21.0, 8.725, 11.5)
    ops.element('elasticBeamColumn', 64018, 64018, 4018, 99999, 77777)
    ops.node(44018, 21.0, 9.275, 11.5)
    ...
    # Central joint node
    ops.node(4019, 0.0, 13.5, 11.5, '-mass', 6.3202408256880735, 6.3202408256880735, 6.3202408256880735, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34019, 0.225, 13.5, 11.5)
    ...
    ops.node(64019, 0.0, 13.275, 11.5)
    ...
    # Central joint node
    ops.node(4021, 9.0, 13.5, 11.5, '-mass', 10.35630096839959, 10.35630096839959, 10.35630096839959, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4022, 12.0, 13.5, 11.5, '-mass', 10.35630096839959, 10.35630096839959, 10.35630096839959, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4024, 21.0, 13.5, 11.5, '-mass', 6.3202408256880735, 6.3202408256880735, 6.3202408256880735, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54024, 20.775, 13.5, 11.5)
    ...
    ops.node(64024, 21.0, 13.275, 11.5)
