...
def add_foundations() -> None:
    ...
    # Foundation node
    ops.node(70001, 0.0, 0.0, 0.0, '-mass', 0.987512742099898, 0.987512742099898, 0.987512742099898, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70007, 0.0, 4.5, 0.0, '-mass', 1.668896534148828, 1.668896534148828, 1.668896534148828, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70013, 0.0, 9.0, 0.0, '-mass', 1.668896534148828, 1.668896534148828, 1.668896534148828, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70019, 0.0, 13.5, 0.0, '-mass', 0.987512742099898, 0.987512742099898, 0.987512742099898, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70008, 4.5, 4.5, 0.0, '-mass', 2.5280326197757397, 2.5280326197757397, 2.5280326197757397, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70014, 4.5, 9.0, 0.0, '-mass', 2.5280326197757397, 2.5280326197757397, 2.5280326197757397, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70009, 9.0, 4.5, 0.0, '-mass', 2.2219036697247705, 2.2219036697247705, 2.2219036697247705, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70015, 9.0, 9.0, 0.0, '-mass', 2.2219036697247705, 2.2219036697247705, 2.2219036697247705, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70010, 12.0, 4.5, 0.0, '-mass', 2.2219036697247705, 2.2219036697247705, 2.2219036697247705, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70016, 12.0, 9.0, 0.0, '-mass', 2.2219036697247705, 2.2219036697247705, 2.2219036697247705, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70011, 16.5, 4.5, 0.0, '-mass', 2.5280326197757397, 2.5280326197757397, 2.5280326197757397, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70017, 16.5, 9.0, 0.0, '-mass', 2.5280326197757397, 2.5280326197757397, 2.5280326197757397, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70006, 21.0, 0.0, 0.0, '-mass', 0.987512742099898, 0.987512742099898, 0.987512742099898, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70012, 21.0, 4.5, 0.0, '-mass', 1.668896534148828, 1.668896534148828, 1.668896534148828, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70018, 21.0, 9.0, 0.0, '-mass', 1.668896534148828, 1.668896534148828, 1.668896534148828, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70024, 21.0, 13.5, 0.0, '-mass', 0.987512742099898, 0.987512742099898, 0.987512742099898, 0.0, 0.0, 0.0)
