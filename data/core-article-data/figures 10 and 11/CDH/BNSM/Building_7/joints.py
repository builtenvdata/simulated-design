...
def add_joints() -> None:
    ...
    # Central joint node
    ops.node(4025, 9.0, 0.0, 1.55, '-mass', 4.591297145769623, 4.591297145769623, 4.591297145769623, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34025, 9.275, 0.0, 1.55)
    ...
    # Central joint node
    ops.node(4026, 12.0, 0.0, 1.55, '-mass', 4.591297145769623, 4.591297145769623, 4.591297145769623, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54026, 11.725, 0.0, 1.55)
    ...
    # Central joint node
    ops.node(4027, 9.0, 0.0, 4.5, '-mass', 4.647680937818552, 4.647680937818552, 4.647680937818552, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34027, 9.275, 0.0, 4.5)
    ...
    # Central joint node
    ops.node(4028, 12.0, 0.0, 4.5, '-mass', 4.647680937818552, 4.647680937818552, 4.647680937818552, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54028, 11.725, 0.0, 4.5)
    ...
    # Central joint node
    ops.node(4029, 9.0, 0.0, 7.3, '-mass', 4.475662589194699, 4.475662589194699, 4.475662589194699, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34029, 9.275, 0.0, 7.3)
    ...
    # Central joint node
    ops.node(4030, 12.0, 0.0, 7.3, '-mass', 4.475662589194699, 4.475662589194699, 4.475662589194699, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54030, 11.725, 0.0, 7.3)
    ...
    # Central joint node
    ops.node(4031, 9.0, 0.0, 10.1, '-mass', 4.380096839959226, 4.380096839959226, 4.380096839959226, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34031, 9.275, 0.0, 10.1)
    ops.element('elasticBeamColumn', 34031, 4031, 34031, 99999, 88888)
    ops.node(24031, 9.0, 0.0, 9.85)
    ops.element('elasticBeamColumn', 24031, 24031, 4031, 99999, 99999)
    ops.node(74031, 9.0, 0.0, 10.35)
    ops.element('elasticBeamColumn', 74031, 4031, 74031, 99999, 99999)

    # Joint grid ids (x, y, z): (3, 0, 3.5)
    # Central joint node
    ops.node(4032, 12.0, 0.0, 10.1, '-mass', 4.380096839959226, 4.380096839959226, 4.380096839959226, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54032, 11.725, 0.0, 10.1)
    ops.element('elasticBeamColumn', 54032, 54032, 4032, 99999, 88888)
    ops.node(24032, 12.0, 0.0, 9.85)
    ops.element('elasticBeamColumn', 24032, 24032, 4032, 99999, 99999)
    ops.node(74032, 12.0, 0.0, 10.35)
    ...
    # Central joint node
    ops.node(1001, 0.0, 0.0, 3.1, '-mass', 12.242131753312947, 12.242131753312947, 12.242131753312947, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31001, 0.25, 0.0, 3.1)
    ...
    # Central joint node
    ops.node(1002, 4.5, 0.0, 3.1, '-mass', 19.057403160040774, 19.057403160040774, 19.057403160040774, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1003, 9.0, 0.0, 3.1, '-mass', 12.43151121304791, 12.43151121304791, 12.43151121304791, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51003, 8.725, 0.0, 3.1)
    ops.element('elasticBeamColumn', 51003, 51003, 1003, 99999, 88888)
    ops.node(31003, 9.275, 0.0, 3.1)
    ...
    # Central joint node
    ops.node(1004, 12.0, 0.0, 3.1, '-mass', 12.43151121304791, 12.43151121304791, 12.43151121304791, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51004, 11.725, 0.0, 3.1)
    ops.element('elasticBeamColumn', 51004, 51004, 1004, 99999, 88888)
    ops.node(31004, 12.275, 0.0, 3.1)
    ...
    # Central joint node
    ops.node(1005, 16.5, 0.0, 3.1, '-mass', 19.057403160040774, 19.057403160040774, 19.057403160040774, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1006, 21.0, 0.0, 3.1, '-mass', 12.242131753312947, 12.242131753312947, 12.242131753312947, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51006, 20.75, 0.0, 3.1)
    ...
    # Central joint node
    ops.node(1007, 0.0, 4.5, 3.1, '-mass', 19.95954383282365, 19.95954383282365, 19.95954383282365, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31007, 0.325, 4.5, 3.1)
    ...
    # Central joint node
    ops.node(1008, 4.5, 4.5, 3.1, '-mass', 30.493756371049948, 30.493756371049948, 30.493756371049948, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51008, 4.1, 4.5, 3.1)
    ops.element('elasticBeamColumn', 51008, 51008, 1008, 99999, 88888)
    ops.node(31008, 4.9, 4.5, 3.1)
    ...
    # Central joint node
    ops.node(1009, 9.0, 4.5, 3.1, '-mass', 26.711582568807337, 26.711582568807337, 26.711582568807337, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51009, 8.625, 4.5, 3.1)
    ops.element('elasticBeamColumn', 51009, 51009, 1009, 99999, 88888)
    ops.node(31009, 9.375, 4.5, 3.1)
    ...
    # Central joint node
    ops.node(1010, 12.0, 4.5, 3.1, '-mass', 26.711582568807337, 26.711582568807337, 26.711582568807337, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51010, 11.625, 4.5, 3.1)
    ops.element('elasticBeamColumn', 51010, 51010, 1010, 99999, 88888)
    ops.node(31010, 12.375, 4.5, 3.1)
    ...
    ops.node(61010, 12.0, 4.125, 3.1)
    ops.element('elasticBeamColumn', 61010, 61010, 1010, 99999, 77777)
    ops.node(41010, 12.0, 4.875, 3.1)
    ...
    # Central joint node
    ops.node(1011, 16.5, 4.5, 3.1, '-mass', 30.493756371049948, 30.493756371049948, 30.493756371049948, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51011, 16.1, 4.5, 3.1)
    ops.element('elasticBeamColumn', 51011, 51011, 1011, 99999, 88888)
    ops.node(31011, 16.9, 4.5, 3.1)
    ...
    # Central joint node
    ops.node(1012, 21.0, 4.5, 3.1, '-mass', 19.95954383282365, 19.95954383282365, 19.95954383282365, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51012, 20.675, 4.5, 3.1)
    ...
    ops.node(61012, 21.0, 4.175, 3.1)
    ops.element('elasticBeamColumn', 61012, 61012, 1012, 99999, 77777)
    ops.node(41012, 21.0, 4.825, 3.1)
    ...
    # Central joint node
    ops.node(1013, 0.0, 9.0, 3.1, '-mass', 19.95954383282365, 19.95954383282365, 19.95954383282365, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31013, 0.325, 9.0, 3.1)
    ...
    # Central joint node
    ops.node(1014, 4.5, 9.0, 3.1, '-mass', 30.493756371049948, 30.493756371049948, 30.493756371049948, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51014, 4.1, 9.0, 3.1)
    ops.element('elasticBeamColumn', 51014, 51014, 1014, 99999, 88888)
    ops.node(31014, 4.9, 9.0, 3.1)
    ...
    # Central joint node
    ops.node(1015, 9.0, 9.0, 3.1, '-mass', 26.459288990825687, 26.459288990825687, 26.459288990825687, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51015, 8.625, 9.0, 3.1)
    ops.element('elasticBeamColumn', 51015, 51015, 1015, 99999, 88888)
    ops.node(31015, 9.375, 9.0, 3.1)
    ...
    # Central joint node
    ops.node(1016, 12.0, 9.0, 3.1, '-mass', 26.459288990825687, 26.459288990825687, 26.459288990825687, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51016, 11.625, 9.0, 3.1)
    ops.element('elasticBeamColumn', 51016, 51016, 1016, 99999, 88888)
    ops.node(31016, 12.375, 9.0, 3.1)
    ...
    ops.node(61016, 12.0, 8.625, 3.1)
    ops.element('elasticBeamColumn', 61016, 61016, 1016, 99999, 77777)
    ops.node(41016, 12.0, 9.375, 3.1)
    ...
    # Central joint node
    ops.node(1017, 16.5, 9.0, 3.1, '-mass', 30.493756371049948, 30.493756371049948, 30.493756371049948, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51017, 16.1, 9.0, 3.1)
    ops.element('elasticBeamColumn', 51017, 51017, 1017, 99999, 88888)
    ops.node(31017, 16.9, 9.0, 3.1)
    ...
    # Central joint node
    ops.node(1018, 21.0, 9.0, 3.1, '-mass', 19.95954383282365, 19.95954383282365, 19.95954383282365, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51018, 20.675, 9.0, 3.1)
    ...
    ops.node(61018, 21.0, 8.675, 3.1)
    ops.element('elasticBeamColumn', 61018, 61018, 1018, 99999, 77777)
    ops.node(41018, 21.0, 9.325, 3.1)
    ...
    # Central joint node
    ops.node(1019, 0.0, 13.5, 3.1, '-mass', 12.242131753312947, 12.242131753312947, 12.242131753312947, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31019, 0.25, 13.5, 3.1)
    ...
    # Central joint node
    ops.node(1020, 4.5, 13.5, 3.1, '-mass', 19.057403160040774, 19.057403160040774, 19.057403160040774, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1021, 9.0, 13.5, 3.1, '-mass', 16.67447120285423, 16.67447120285423, 16.67447120285423, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51021, 8.725, 13.5, 3.1)
    ops.element('elasticBeamColumn', 51021, 51021, 1021, 99999, 88888)
    ops.node(31021, 9.275, 13.5, 3.1)
    ...
    # Central joint node
    ops.node(1022, 12.0, 13.5, 3.1, '-mass', 16.67447120285423, 16.67447120285423, 16.67447120285423, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51022, 11.725, 13.5, 3.1)
    ops.element('elasticBeamColumn', 51022, 51022, 1022, 99999, 88888)
    ops.node(31022, 12.275, 13.5, 3.1)
    ...
    ops.node(61022, 12.0, 13.225, 3.1)
    ...
    # Central joint node
    ops.node(1023, 16.5, 13.5, 3.1, '-mass', 19.057403160040774, 19.057403160040774, 19.057403160040774, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1024, 21.0, 13.5, 3.1, '-mass', 12.242131753312947, 12.242131753312947, 12.242131753312947, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51024, 20.75, 13.5, 3.1)
    ...
    # Central joint node
    ops.node(2001, 0.0, 0.0, 5.9, '-mass', 12.146566004077473, 12.146566004077473, 12.146566004077473, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32001, 0.25, 0.0, 5.9)
    ...
    # Central joint node
    ops.node(2002, 4.5, 0.0, 5.9, '-mass', 18.741080530071354, 18.741080530071354, 18.741080530071354, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2003, 9.0, 0.0, 5.9, '-mass', 12.373693934760448, 12.373693934760448, 12.373693934760448, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52003, 8.725, 0.0, 5.9)
    ops.element('elasticBeamColumn', 52003, 52003, 2003, 99999, 88888)
    ops.node(32003, 9.275, 0.0, 5.9)
    ...
    # Central joint node
    ops.node(2004, 12.0, 0.0, 5.9, '-mass', 12.373693934760448, 12.373693934760448, 12.373693934760448, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52004, 11.725, 0.0, 5.9)
    ops.element('elasticBeamColumn', 52004, 52004, 2004, 99999, 88888)
    ops.node(32004, 12.275, 0.0, 5.9)
    ...
    # Central joint node
    ops.node(2005, 16.5, 0.0, 5.9, '-mass', 18.741080530071354, 18.741080530071354, 18.741080530071354, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2006, 21.0, 0.0, 5.9, '-mass', 12.146566004077473, 12.146566004077473, 12.146566004077473, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52006, 20.75, 0.0, 5.9)
    ...
    # Central joint node
    ops.node(2007, 0.0, 4.5, 5.9, '-mass', 19.798037716615696, 19.798037716615696, 19.798037716615696, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32007, 0.325, 4.5, 5.9)
    ops.element('elasticBeamColumn', 32007, 2007, 32007, 99999, 88888)
    ops.node(22007, 0.0, 4.5, 5.525)
    ops.element('elasticBeamColumn', 22007, 22007, 2007, 99999, 99999)
    ops.node(72007, 0.0, 4.5, 6.275)
    ops.element('elasticBeamColumn', 72007, 2007, 72007, 99999, 99999)
    ops.node(62007, 0.0, 4.175, 5.9)
    ops.element('elasticBeamColumn', 62007, 62007, 2007, 99999, 77777)
    ops.node(42007, 0.0, 4.825, 5.9)
    ...
    # Central joint node
    ops.node(2008, 4.5, 4.5, 5.9, '-mass', 29.847731906218144, 29.847731906218144, 29.847731906218144, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52008, 4.1, 4.5, 5.9)
    ops.element('elasticBeamColumn', 52008, 52008, 2008, 99999, 88888)
    ops.node(32008, 4.9, 4.5, 5.9)
    ...
    # Central joint node
    ops.node(2009, 9.0, 4.5, 5.9, '-mass', 26.49655963302752, 26.49655963302752, 26.49655963302752, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52009, 8.625, 4.5, 5.9)
    ops.element('elasticBeamColumn', 52009, 52009, 2009, 99999, 88888)
    ops.node(32009, 9.375, 4.5, 5.9)
    ...
    # Central joint node
    ops.node(2010, 12.0, 4.5, 5.9, '-mass', 26.49655963302752, 26.49655963302752, 26.49655963302752, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52010, 11.625, 4.5, 5.9)
    ops.element('elasticBeamColumn', 52010, 52010, 2010, 99999, 88888)
    ops.node(32010, 12.375, 4.5, 5.9)
    ...
    ops.node(62010, 12.0, 4.125, 5.9)
    ops.element('elasticBeamColumn', 62010, 62010, 2010, 99999, 77777)
    ops.node(42010, 12.0, 4.875, 5.9)
    ...
    # Central joint node
    ops.node(2011, 16.5, 4.5, 5.9, '-mass', 29.847731906218144, 29.847731906218144, 29.847731906218144, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52011, 16.1, 4.5, 5.9)
    ops.element('elasticBeamColumn', 52011, 52011, 2011, 99999, 88888)
    ops.node(32011, 16.9, 4.5, 5.9)
    ...
    # Central joint node
    ops.node(2012, 21.0, 4.5, 5.9, '-mass', 19.798037716615696, 19.798037716615696, 19.798037716615696, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52012, 20.675, 4.5, 5.9)
    ops.element('elasticBeamColumn', 52012, 52012, 2012, 99999, 88888)
    ops.node(22012, 21.0, 4.5, 5.525)
    ops.element('elasticBeamColumn', 22012, 22012, 2012, 99999, 99999)
    ops.node(72012, 21.0, 4.5, 6.275)
    ops.element('elasticBeamColumn', 72012, 2012, 72012, 99999, 99999)
    ops.node(62012, 21.0, 4.175, 5.9)
    ops.element('elasticBeamColumn', 62012, 62012, 2012, 99999, 77777)
    ops.node(42012, 21.0, 4.825, 5.9)
    ...
    # Central joint node
    ops.node(2013, 0.0, 9.0, 5.9, '-mass', 19.798037716615696, 19.798037716615696, 19.798037716615696, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32013, 0.325, 9.0, 5.9)
    ops.element('elasticBeamColumn', 32013, 2013, 32013, 99999, 88888)
    ops.node(22013, 0.0, 9.0, 5.525)
    ops.element('elasticBeamColumn', 22013, 22013, 2013, 99999, 99999)
    ops.node(72013, 0.0, 9.0, 6.275)
    ops.element('elasticBeamColumn', 72013, 2013, 72013, 99999, 99999)
    ops.node(62013, 0.0, 8.675, 5.9)
    ops.element('elasticBeamColumn', 62013, 62013, 2013, 99999, 77777)
    ops.node(42013, 0.0, 9.325, 5.9)
    ...
    # Central joint node
    ops.node(2014, 4.5, 9.0, 5.9, '-mass', 29.847731906218144, 29.847731906218144, 29.847731906218144, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52014, 4.1, 9.0, 5.9)
    ops.element('elasticBeamColumn', 52014, 52014, 2014, 99999, 88888)
    ops.node(32014, 4.9, 9.0, 5.9)
    ...
    # Central joint node
    ops.node(2015, 9.0, 9.0, 5.9, '-mass', 26.24426605504587, 26.24426605504587, 26.24426605504587, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52015, 8.625, 9.0, 5.9)
    ops.element('elasticBeamColumn', 52015, 52015, 2015, 99999, 88888)
    ops.node(32015, 9.375, 9.0, 5.9)
    ...
    # Central joint node
    ops.node(2016, 12.0, 9.0, 5.9, '-mass', 26.24426605504587, 26.24426605504587, 26.24426605504587, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52016, 11.625, 9.0, 5.9)
    ops.element('elasticBeamColumn', 52016, 52016, 2016, 99999, 88888)
    ops.node(32016, 12.375, 9.0, 5.9)
    ...
    ops.node(62016, 12.0, 8.625, 5.9)
    ops.element('elasticBeamColumn', 62016, 62016, 2016, 99999, 77777)
    ops.node(42016, 12.0, 9.375, 5.9)
    ...
    # Central joint node
    ops.node(2017, 16.5, 9.0, 5.9, '-mass', 29.847731906218144, 29.847731906218144, 29.847731906218144, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52017, 16.1, 9.0, 5.9)
    ops.element('elasticBeamColumn', 52017, 52017, 2017, 99999, 88888)
    ops.node(32017, 16.9, 9.0, 5.9)
    ...
    # Central joint node
    ops.node(2018, 21.0, 9.0, 5.9, '-mass', 19.798037716615696, 19.798037716615696, 19.798037716615696, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52018, 20.675, 9.0, 5.9)
    ops.element('elasticBeamColumn', 52018, 52018, 2018, 99999, 88888)
    ops.node(22018, 21.0, 9.0, 5.525)
    ops.element('elasticBeamColumn', 22018, 22018, 2018, 99999, 99999)
    ops.node(72018, 21.0, 9.0, 6.275)
    ops.element('elasticBeamColumn', 72018, 2018, 72018, 99999, 99999)
    ops.node(62018, 21.0, 8.675, 5.9)
    ops.element('elasticBeamColumn', 62018, 62018, 2018, 99999, 77777)
    ops.node(42018, 21.0, 9.325, 5.9)
    ...
    # Central joint node
    ops.node(2019, 0.0, 13.5, 5.9, '-mass', 12.146566004077473, 12.146566004077473, 12.146566004077473, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32019, 0.25, 13.5, 5.9)
    ...
    # Central joint node
    ops.node(2020, 4.5, 13.5, 5.9, '-mass', 18.741080530071354, 18.741080530071354, 18.741080530071354, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2021, 9.0, 13.5, 5.9, '-mass', 16.558836646279307, 16.558836646279307, 16.558836646279307, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52021, 8.725, 13.5, 5.9)
    ops.element('elasticBeamColumn', 52021, 52021, 2021, 99999, 88888)
    ops.node(32021, 9.275, 13.5, 5.9)
    ...
    # Central joint node
    ops.node(2022, 12.0, 13.5, 5.9, '-mass', 16.558836646279307, 16.558836646279307, 16.558836646279307, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52022, 11.725, 13.5, 5.9)
    ops.element('elasticBeamColumn', 52022, 52022, 2022, 99999, 88888)
    ops.node(32022, 12.275, 13.5, 5.9)
    ...
    ops.node(62022, 12.0, 13.225, 5.9)
    ...
    # Central joint node
    ops.node(2023, 16.5, 13.5, 5.9, '-mass', 18.741080530071354, 18.741080530071354, 18.741080530071354, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2024, 21.0, 13.5, 5.9, '-mass', 12.146566004077473, 12.146566004077473, 12.146566004077473, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52024, 20.75, 13.5, 5.9)
    ...
    # Central joint node
    ops.node(3001, 0.0, 0.0, 8.7, '-mass', 11.71652013251784, 11.71652013251784, 11.71652013251784, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33001, 0.25, 0.0, 8.7)
    ...
    # Central joint node
    ops.node(3002, 4.5, 0.0, 8.7, '-mass', 18.03867227319062, 18.03867227319062, 18.03867227319062, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53002, 4.225, 0.0, 8.7)
    ops.element('elasticBeamColumn', 53002, 53002, 3002, 99999, 88888)
    ops.node(33002, 4.775, 0.0, 8.7)
    ops.element('elasticBeamColumn', 33002, 3002, 33002, 99999, 88888)
    ops.node(23002, 4.5, 0.0, 8.375)
    ops.element('elasticBeamColumn', 23002, 23002, 3002, 99999, 99999)
    ops.node(73002, 4.5, 0.0, 9.025)
    ops.element('elasticBeamColumn', 73002, 3002, 73002, 99999, 99999)
    ops.node(43002, 4.5, 0.275, 8.7)
    ...
    # Central joint node
    ops.node(3003, 9.0, 0.0, 8.7, '-mass', 11.757294852191642, 11.757294852191642, 11.757294852191642, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53003, 8.725, 0.0, 8.7)
    ops.element('elasticBeamColumn', 53003, 53003, 3003, 99999, 88888)
    ops.node(33003, 9.275, 0.0, 8.7)
    ops.element('elasticBeamColumn', 33003, 3003, 33003, 99999, 88888)
    ops.node(23003, 9.0, 0.0, 8.375)
    ops.element('elasticBeamColumn', 23003, 23003, 3003, 99999, 99999)
    ops.node(73003, 9.0, 0.0, 9.025)
    ops.element('elasticBeamColumn', 73003, 3003, 73003, 99999, 99999)
    ops.node(43003, 9.0, 0.275, 8.7)
    ...
    # Central joint node
    ops.node(3004, 12.0, 0.0, 8.7, '-mass', 11.757294852191642, 11.757294852191642, 11.757294852191642, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53004, 11.725, 0.0, 8.7)
    ops.element('elasticBeamColumn', 53004, 53004, 3004, 99999, 88888)
    ops.node(33004, 12.275, 0.0, 8.7)
    ops.element('elasticBeamColumn', 33004, 3004, 33004, 99999, 88888)
    ops.node(23004, 12.0, 0.0, 8.375)
    ops.element('elasticBeamColumn', 23004, 23004, 3004, 99999, 99999)
    ops.node(73004, 12.0, 0.0, 9.025)
    ops.element('elasticBeamColumn', 73004, 3004, 73004, 99999, 99999)
    ops.node(43004, 12.0, 0.275, 8.7)
    ...
    # Central joint node
    ops.node(3005, 16.5, 0.0, 8.7, '-mass', 18.03867227319062, 18.03867227319062, 18.03867227319062, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53005, 16.225, 0.0, 8.7)
    ops.element('elasticBeamColumn', 53005, 53005, 3005, 99999, 88888)
    ops.node(33005, 16.775, 0.0, 8.7)
    ops.element('elasticBeamColumn', 33005, 3005, 33005, 99999, 88888)
    ops.node(23005, 16.5, 0.0, 8.375)
    ops.element('elasticBeamColumn', 23005, 23005, 3005, 99999, 99999)
    ops.node(73005, 16.5, 0.0, 9.025)
    ops.element('elasticBeamColumn', 73005, 3005, 73005, 99999, 99999)
    ops.node(43005, 16.5, 0.275, 8.7)
    ...
    # Central joint node
    ops.node(3006, 21.0, 0.0, 8.7, '-mass', 11.71652013251784, 11.71652013251784, 11.71652013251784, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53006, 20.75, 0.0, 8.7)
    ops.element('elasticBeamColumn', 53006, 53006, 3006, 99999, 88888)
    ops.node(23006, 21.0, 0.0, 8.425)
    ops.element('elasticBeamColumn', 23006, 23006, 3006, 99999, 99999)
    ops.node(73006, 21.0, 0.0, 8.975)
    ops.element('elasticBeamColumn', 73006, 3006, 73006, 99999, 99999)
    ops.node(43006, 21.0, 0.25, 8.7)
    ...
    # Central joint node
    ops.node(3007, 0.0, 4.5, 8.7, '-mass', 19.06695973496432, 19.06695973496432, 19.06695973496432, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33007, 0.325, 4.5, 8.7)
    ops.element('elasticBeamColumn', 33007, 3007, 33007, 99999, 88888)
    ops.node(23007, 0.0, 4.5, 8.375)
    ops.element('elasticBeamColumn', 23007, 23007, 3007, 99999, 99999)
    ops.node(73007, 0.0, 4.5, 9.025)
    ops.element('elasticBeamColumn', 73007, 3007, 73007, 99999, 99999)
    ops.node(63007, 0.0, 4.175, 8.7)
    ops.element('elasticBeamColumn', 63007, 63007, 3007, 99999, 77777)
    ops.node(43007, 0.0, 4.825, 8.7)
    ...
    # Central joint node
    ops.node(3012, 21.0, 4.5, 8.7, '-mass', 19.06695973496432, 19.06695973496432, 19.06695973496432, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53012, 20.675, 4.5, 8.7)
    ops.element('elasticBeamColumn', 53012, 53012, 3012, 99999, 88888)
    ops.node(23012, 21.0, 4.5, 8.375)
    ops.element('elasticBeamColumn', 23012, 23012, 3012, 99999, 99999)
    ops.node(73012, 21.0, 4.5, 9.025)
    ops.element('elasticBeamColumn', 73012, 3012, 73012, 99999, 99999)
    ops.node(63012, 21.0, 4.175, 8.7)
    ops.element('elasticBeamColumn', 63012, 63012, 3012, 99999, 77777)
    ops.node(43012, 21.0, 4.825, 8.7)
    ...
    # Central joint node
    ops.node(3013, 0.0, 9.0, 8.7, '-mass', 19.06695973496432, 19.06695973496432, 19.06695973496432, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33013, 0.325, 9.0, 8.7)
    ops.element('elasticBeamColumn', 33013, 3013, 33013, 99999, 88888)
    ops.node(23013, 0.0, 9.0, 8.375)
    ops.element('elasticBeamColumn', 23013, 23013, 3013, 99999, 99999)
    ops.node(73013, 0.0, 9.0, 9.025)
    ops.element('elasticBeamColumn', 73013, 3013, 73013, 99999, 99999)
    ops.node(63013, 0.0, 8.675, 8.7)
    ops.element('elasticBeamColumn', 63013, 63013, 3013, 99999, 77777)
    ops.node(43013, 0.0, 9.325, 8.7)
    ...
    # Central joint node
    ops.node(3018, 21.0, 9.0, 8.7, '-mass', 19.06695973496432, 19.06695973496432, 19.06695973496432, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53018, 20.675, 9.0, 8.7)
    ops.element('elasticBeamColumn', 53018, 53018, 3018, 99999, 88888)
    ops.node(23018, 21.0, 9.0, 8.375)
    ops.element('elasticBeamColumn', 23018, 23018, 3018, 99999, 99999)
    ops.node(73018, 21.0, 9.0, 9.025)
    ops.element('elasticBeamColumn', 73018, 3018, 73018, 99999, 99999)
    ops.node(63018, 21.0, 8.675, 8.7)
    ops.element('elasticBeamColumn', 63018, 63018, 3018, 99999, 77777)
    ops.node(43018, 21.0, 9.325, 8.7)
    ...
    # Central joint node
    ops.node(3019, 0.0, 13.5, 8.7, '-mass', 11.802529306829767, 11.802529306829767, 11.802529306829767, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33019, 0.25, 13.5, 8.7)
    ops.element('elasticBeamColumn', 33019, 3019, 33019, 99999, 88888)
    ops.node(23019, 0.0, 13.5, 8.425)
    ops.element('elasticBeamColumn', 23019, 23019, 3019, 99999, 99999)
    ops.node(73019, 0.0, 13.5, 8.975)
    ops.element('elasticBeamColumn', 73019, 3019, 73019, 99999, 99999)
    ops.node(63019, 0.0, 13.25, 8.7)
    ...
    # Central joint node
    ops.node(3020, 4.5, 13.5, 8.7, '-mass', 18.21069062181448, 18.21069062181448, 18.21069062181448, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53020, 4.225, 13.5, 8.7)
    ops.element('elasticBeamColumn', 53020, 53020, 3020, 99999, 88888)
    ops.node(33020, 4.775, 13.5, 8.7)
    ops.element('elasticBeamColumn', 33020, 3020, 33020, 99999, 88888)
    ops.node(23020, 4.5, 13.5, 8.375)
    ops.element('elasticBeamColumn', 23020, 23020, 3020, 99999, 99999)
    ops.node(73020, 4.5, 13.5, 9.025)
    ops.element('elasticBeamColumn', 73020, 3020, 73020, 99999, 99999)
    ops.node(63020, 4.5, 13.225, 8.7)
    ...
    # Central joint node
    ops.node(3021, 9.0, 13.5, 8.7, '-mass', 16.085786187563713, 16.085786187563713, 16.085786187563713, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53021, 8.725, 13.5, 8.7)
    ops.element('elasticBeamColumn', 53021, 53021, 3021, 99999, 88888)
    ops.node(33021, 9.275, 13.5, 8.7)
    ops.element('elasticBeamColumn', 33021, 3021, 33021, 99999, 88888)
    ops.node(23021, 9.0, 13.5, 8.375)
    ops.element('elasticBeamColumn', 23021, 23021, 3021, 99999, 99999)
    ops.node(73021, 9.0, 13.5, 9.025)
    ops.element('elasticBeamColumn', 73021, 3021, 73021, 99999, 99999)
    ops.node(63021, 9.0, 13.225, 8.7)
    ...
    # Central joint node
    ops.node(3022, 12.0, 13.5, 8.7, '-mass', 16.085786187563713, 16.085786187563713, 16.085786187563713, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53022, 11.725, 13.5, 8.7)
    ops.element('elasticBeamColumn', 53022, 53022, 3022, 99999, 88888)
    ops.node(33022, 12.275, 13.5, 8.7)
    ops.element('elasticBeamColumn', 33022, 3022, 33022, 99999, 88888)
    ops.node(23022, 12.0, 13.5, 8.375)
    ops.element('elasticBeamColumn', 23022, 23022, 3022, 99999, 99999)
    ops.node(73022, 12.0, 13.5, 9.025)
    ops.element('elasticBeamColumn', 73022, 3022, 73022, 99999, 99999)
    ops.node(63022, 12.0, 13.225, 8.7)
    ...
    # Central joint node
    ops.node(3023, 16.5, 13.5, 8.7, '-mass', 18.21069062181448, 18.21069062181448, 18.21069062181448, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53023, 16.225, 13.5, 8.7)
    ops.element('elasticBeamColumn', 53023, 53023, 3023, 99999, 88888)
    ops.node(33023, 16.775, 13.5, 8.7)
    ops.element('elasticBeamColumn', 33023, 3023, 33023, 99999, 88888)
    ops.node(23023, 16.5, 13.5, 8.375)
    ops.element('elasticBeamColumn', 23023, 23023, 3023, 99999, 99999)
    ops.node(73023, 16.5, 13.5, 9.025)
    ops.element('elasticBeamColumn', 73023, 3023, 73023, 99999, 99999)
    ops.node(63023, 16.5, 13.225, 8.7)
    ...
    # Central joint node
    ops.node(3024, 21.0, 13.5, 8.7, '-mass', 11.802529306829767, 11.802529306829767, 11.802529306829767, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53024, 20.75, 13.5, 8.7)
    ops.element('elasticBeamColumn', 53024, 53024, 3024, 99999, 88888)
    ops.node(23024, 21.0, 13.5, 8.425)
    ops.element('elasticBeamColumn', 23024, 23024, 3024, 99999, 99999)
    ops.node(73024, 21.0, 13.5, 8.975)
    ops.element('elasticBeamColumn', 73024, 3024, 73024, 99999, 99999)
    ops.node(63024, 21.0, 13.25, 8.7)
    ...
    # Central joint node
    ops.node(4001, 0.0, 0.0, 11.5, '-mass', 6.4897107543323145, 6.4897107543323145, 6.4897107543323145, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34001, 0.25, 0.0, 11.5)
    ...
    # Central joint node
    ops.node(4002, 4.5, 0.0, 11.5, '-mass', 11.773063200815493, 11.773063200815493, 11.773063200815493, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54002, 4.225, 0.0, 11.5)
    ops.element('elasticBeamColumn', 54002, 54002, 4002, 99999, 88888)
    ops.node(34002, 4.775, 0.0, 11.5)
    ...
    # Central joint node
    ops.node(4003, 9.0, 0.0, 11.5, '-mass', 6.591329001019368, 6.591329001019368, 6.591329001019368, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54003, 8.725, 0.0, 11.5)
    ops.element('elasticBeamColumn', 54003, 54003, 4003, 99999, 88888)
    ops.node(34003, 9.275, 0.0, 11.5)
    ...
    # Central joint node
    ops.node(4004, 12.0, 0.0, 11.5, '-mass', 6.591329001019368, 6.591329001019368, 6.591329001019368, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54004, 11.725, 0.0, 11.5)
    ops.element('elasticBeamColumn', 54004, 54004, 4004, 99999, 88888)
    ops.node(34004, 12.275, 0.0, 11.5)
    ...
    ops.node(44004, 12.0, 0.275, 11.5)
    ...
    # Central joint node
    ops.node(4005, 16.5, 0.0, 11.5, '-mass', 11.773063200815493, 11.773063200815493, 11.773063200815493, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54005, 16.225, 0.0, 11.5)
    ops.element('elasticBeamColumn', 54005, 54005, 4005, 99999, 88888)
    ops.node(34005, 16.775, 0.0, 11.5)
    ...
    ops.node(44005, 16.5, 0.275, 11.5)
    ...
    # Central joint node
    ops.node(4006, 21.0, 0.0, 11.5, '-mass', 6.4897107543323145, 6.4897107543323145, 6.4897107543323145, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54006, 20.75, 0.0, 11.5)
    ...
    # Central joint node
    ops.node(4007, 0.0, 4.5, 11.5, '-mass', 12.129523445463812, 12.129523445463812, 12.129523445463812, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34007, 0.325, 4.5, 11.5)
    ...
    ops.node(64007, 0.0, 4.175, 11.5)
    ops.element('elasticBeamColumn', 64007, 64007, 4007, 99999, 77777)
    ops.node(44007, 0.0, 4.825, 11.5)
    ...
    # Central joint node
    ops.node(4008, 4.5, 4.5, 11.5, '-mass', 22.52420998980632, 22.52420998980632, 22.52420998980632, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54008, 4.1, 4.5, 11.5)
    ops.element('elasticBeamColumn', 54008, 54008, 4008, 99999, 88888)
    ops.node(34008, 4.9, 4.5, 11.5)
    ...
    # Central joint node
    ops.node(4009, 9.0, 4.5, 11.5, '-mass', 18.739487767584095, 18.739487767584095, 18.739487767584095, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54009, 8.625, 4.5, 11.5)
    ops.element('elasticBeamColumn', 54009, 54009, 4009, 99999, 88888)
    ops.node(34009, 9.375, 4.5, 11.5)
    ...
    ops.node(64009, 9.0, 4.125, 11.5)
    ops.element('elasticBeamColumn', 64009, 64009, 4009, 99999, 77777)
    ops.node(44009, 9.0, 4.875, 11.5)
    ...
    # Central joint node
    ops.node(4010, 12.0, 4.5, 11.5, '-mass', 18.739487767584095, 18.739487767584095, 18.739487767584095, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54010, 11.625, 4.5, 11.5)
    ops.element('elasticBeamColumn', 54010, 54010, 4010, 99999, 88888)
    ops.node(34010, 12.375, 4.5, 11.5)
    ...
    ops.node(64010, 12.0, 4.125, 11.5)
    ops.element('elasticBeamColumn', 64010, 64010, 4010, 99999, 77777)
    ops.node(44010, 12.0, 4.875, 11.5)
    ...
    # Central joint node
    ops.node(4011, 16.5, 4.5, 11.5, '-mass', 22.52420998980632, 22.52420998980632, 22.52420998980632, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54011, 16.1, 4.5, 11.5)
    ops.element('elasticBeamColumn', 54011, 54011, 4011, 99999, 88888)
    ops.node(34011, 16.9, 4.5, 11.5)
    ...
    # Central joint node
    ops.node(4012, 21.0, 4.5, 11.5, '-mass', 12.129523445463812, 12.129523445463812, 12.129523445463812, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54012, 20.675, 4.5, 11.5)
    ...
    ops.node(64012, 21.0, 4.175, 11.5)
    ops.element('elasticBeamColumn', 64012, 64012, 4012, 99999, 77777)
    ops.node(44012, 21.0, 4.825, 11.5)
    ...
    # Central joint node
    ops.node(4013, 0.0, 9.0, 11.5, '-mass', 12.129523445463812, 12.129523445463812, 12.129523445463812, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34013, 0.325, 9.0, 11.5)
    ...
    ops.node(64013, 0.0, 8.675, 11.5)
    ops.element('elasticBeamColumn', 64013, 64013, 4013, 99999, 77777)
    ops.node(44013, 0.0, 9.325, 11.5)
    ...
    # Central joint node
    ops.node(4014, 4.5, 9.0, 11.5, '-mass', 22.52420998980632, 22.52420998980632, 22.52420998980632, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54014, 4.1, 9.0, 11.5)
    ops.element('elasticBeamColumn', 54014, 54014, 4014, 99999, 88888)
    ops.node(34014, 4.9, 9.0, 11.5)
    ...
    # Central joint node
    ops.node(4015, 9.0, 9.0, 11.5, '-mass', 19.7486620795107, 19.7486620795107, 19.7486620795107, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54015, 8.625, 9.0, 11.5)
    ops.element('elasticBeamColumn', 54015, 54015, 4015, 99999, 88888)
    ops.node(34015, 9.375, 9.0, 11.5)
    ...
    ops.node(64015, 9.0, 8.625, 11.5)
    ops.element('elasticBeamColumn', 64015, 64015, 4015, 99999, 77777)
    ops.node(44015, 9.0, 9.375, 11.5)
    ...
    # Central joint node
    ops.node(4016, 12.0, 9.0, 11.5, '-mass', 19.7486620795107, 19.7486620795107, 19.7486620795107, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54016, 11.625, 9.0, 11.5)
    ops.element('elasticBeamColumn', 54016, 54016, 4016, 99999, 88888)
    ops.node(34016, 12.375, 9.0, 11.5)
    ...
    ops.node(64016, 12.0, 8.625, 11.5)
    ops.element('elasticBeamColumn', 64016, 64016, 4016, 99999, 77777)
    ops.node(44016, 12.0, 9.375, 11.5)
    ...
    # Central joint node
    ops.node(4017, 16.5, 9.0, 11.5, '-mass', 22.52420998980632, 22.52420998980632, 22.52420998980632, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54017, 16.1, 9.0, 11.5)
    ops.element('elasticBeamColumn', 54017, 54017, 4017, 99999, 88888)
    ops.node(34017, 16.9, 9.0, 11.5)
    ...
    # Central joint node
    ops.node(4018, 21.0, 9.0, 11.5, '-mass', 12.129523445463812, 12.129523445463812, 12.129523445463812, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54018, 20.675, 9.0, 11.5)
    ...
    ops.node(64018, 21.0, 8.675, 11.5)
    ops.element('elasticBeamColumn', 64018, 64018, 4018, 99999, 77777)
    ops.node(44018, 21.0, 9.325, 11.5)
    ...
    # Central joint node
    ops.node(4019, 0.0, 13.5, 11.5, '-mass', 6.4897107543323145, 6.4897107543323145, 6.4897107543323145, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34019, 0.25, 13.5, 11.5)
    ...
    # Central joint node
    ops.node(4020, 4.5, 13.5, 11.5, '-mass', 11.773063200815493, 11.773063200815493, 11.773063200815493, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54020, 4.225, 13.5, 11.5)
    ops.element('elasticBeamColumn', 54020, 54020, 4020, 99999, 88888)
    ops.node(34020, 4.775, 13.5, 11.5)
    ...
    ops.node(64020, 4.5, 13.225, 11.5)
    ...
    # Central joint node
    ops.node(4021, 9.0, 13.5, 11.5, '-mass', 10.427975280326198, 10.427975280326198, 10.427975280326198, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54021, 8.725, 13.5, 11.5)
    ops.element('elasticBeamColumn', 54021, 54021, 4021, 99999, 88888)
    ops.node(34021, 9.275, 13.5, 11.5)
    ...
    ops.node(64021, 9.0, 13.225, 11.5)
    ...
    # Central joint node
    ops.node(4022, 12.0, 13.5, 11.5, '-mass', 10.427975280326198, 10.427975280326198, 10.427975280326198, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54022, 11.725, 13.5, 11.5)
    ops.element('elasticBeamColumn', 54022, 54022, 4022, 99999, 88888)
    ops.node(34022, 12.275, 13.5, 11.5)
    ...
    ops.node(64022, 12.0, 13.225, 11.5)
    ...
    # Central joint node
    ops.node(4023, 16.5, 13.5, 11.5, '-mass', 11.773063200815493, 11.773063200815493, 11.773063200815493, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54023, 16.225, 13.5, 11.5)
    ops.element('elasticBeamColumn', 54023, 54023, 4023, 99999, 88888)
    ops.node(34023, 16.775, 13.5, 11.5)
    ...
    ops.node(64023, 16.5, 13.225, 11.5)
    ...
    # Central joint node
    ops.node(4024, 21.0, 13.5, 11.5, '-mass', 6.4897107543323145, 6.4897107543323145, 6.4897107543323145, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54024, 20.75, 13.5, 11.5)
    ...
    ops.node(64024, 21.0, 13.25, 11.5)
