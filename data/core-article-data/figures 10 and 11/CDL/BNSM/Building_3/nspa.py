...
def do_nspa_x(max_drift: float = 0.1, dincr: float = 1e-05) -> tuple[list[float], list[float]]:
    ...
    ops.load(91000, 0.09834089260112942, 0, 0, 0, 0, 0)
    ops.load(92000, 0.20827020416630176, 0, 0, 0, 0, 0)
    ops.load(93000, 0.35064600920387784, 0, 0, 0, 0, 0)
    ops.load(94000, 0.342742894028691, 0, 0, 0, 0, 0)
...
def do_nspa_y(max_drift: float = 0.1, dincr: float = 1e-05) -> tuple[list[float], list[float]]:
    ...
    ops.pattern('Plain', 2, 2)
    # Add lateral nspa loads to ops domain
    ops.load(91000, 0, 0.10624717940450817, 0, 0, 0, 0)
    ops.load(92000, 0, 0.2202432397097838, 0, 0, 0, 0)
    ops.load(93000, 0, 0.3504189755041164, 0, 0, 0, 0)
    ops.load(94000, 0, 0.3230906053815916, 0, 0, 0, 0)
