...
def add_joints() -> None:
    ...
    # Central joint node
    ops.node(4025, 9.0, 0.0, 1.55, '-mass', 4.3741590214067285, 4.3741590214067285, 4.3741590214067285, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34025, 9.225, 0.0, 1.55)
    ops.element('elasticBeamColumn', 34025, 4025, 34025, 99999, 88888)
    ops.node(24025, 9.0, 0.0, 1.225)
    ops.element('elasticBeamColumn', 24025, 24025, 4025, 99999, 99999)
    ops.node(74025, 9.0, 0.0, 1.875)
    ops.element('elasticBeamColumn', 74025, 4025, 74025, 99999, 99999)

    # Joint grid ids (x, y, z): (3, 0, 0.5)
    # Central joint node
    ops.node(4026, 12.0, 0.0, 1.55, '-mass', 4.3741590214067285, 4.3741590214067285, 4.3741590214067285, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54026, 11.775, 0.0, 1.55)
    ops.element('elasticBeamColumn', 54026, 54026, 4026, 99999, 88888)
    ops.node(24026, 12.0, 0.0, 1.225)
    ops.element('elasticBeamColumn', 24026, 24026, 4026, 99999, 99999)
    ops.node(74026, 12.0, 0.0, 1.875)
    ops.element('elasticBeamColumn', 74026, 4026, 74026, 99999, 99999)

    # Joint grid ids (x, y, z): (2, 0, 1.5)
    # Central joint node
    ops.node(4027, 9.0, 0.0, 4.5, '-mass', 4.180581039755352, 4.180581039755352, 4.180581039755352, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34027, 9.225, 0.0, 4.5)
    ...
    # Central joint node
    ops.node(4028, 12.0, 0.0, 4.5, '-mass', 4.180581039755352, 4.180581039755352, 4.180581039755352, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54028, 11.775, 0.0, 4.5)
    ...
    # Central joint node
    ops.node(4029, 9.0, 0.0, 7.3, '-mass', 3.7414373088685013, 3.7414373088685013, 3.7414373088685013, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34029, 9.175, 0.0, 7.3)
    ops.element('elasticBeamColumn', 34029, 4029, 34029, 99999, 88888)
    ops.node(24029, 9.0, 0.0, 7.05)
    ops.element('elasticBeamColumn', 24029, 24029, 4029, 99999, 99999)
    ops.node(74029, 9.0, 0.0, 7.55)
    ops.element('elasticBeamColumn', 74029, 4029, 74029, 99999, 99999)

    # Joint grid ids (x, y, z): (3, 0, 2.5)
    # Central joint node
    ops.node(4030, 12.0, 0.0, 7.3, '-mass', 3.7414373088685013, 3.7414373088685013, 3.7414373088685013, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54030, 11.825, 0.0, 7.3)
    ops.element('elasticBeamColumn', 54030, 54030, 4030, 99999, 88888)
    ops.node(24030, 12.0, 0.0, 7.05)
    ops.element('elasticBeamColumn', 24030, 24030, 4030, 99999, 99999)
    ops.node(74030, 12.0, 0.0, 7.55)
    ops.element('elasticBeamColumn', 74030, 4030, 74030, 99999, 99999)

    # Joint grid ids (x, y, z): (2, 0, 3.5)
    # Central joint node
    ops.node(4031, 9.0, 0.0, 10.1, '-mass', 3.4845565749235474, 3.4845565749235474, 3.4845565749235474, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34031, 9.175, 0.0, 10.1)
    ops.element('elasticBeamColumn', 34031, 4031, 34031, 99999, 88888)
    ops.node(24031, 9.0, 0.0, 9.9)
    ops.element('elasticBeamColumn', 24031, 24031, 4031, 99999, 99999)
    ops.node(74031, 9.0, 0.0, 10.3)
    ops.element('elasticBeamColumn', 74031, 4031, 74031, 99999, 99999)

    # Joint grid ids (x, y, z): (3, 0, 3.5)
    # Central joint node
    ops.node(4032, 12.0, 0.0, 10.1, '-mass', 3.4845565749235474, 3.4845565749235474, 3.4845565749235474, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54032, 11.825, 0.0, 10.1)
    ops.element('elasticBeamColumn', 54032, 54032, 4032, 99999, 88888)
    ops.node(24032, 12.0, 0.0, 9.9)
    ops.element('elasticBeamColumn', 24032, 24032, 4032, 99999, 99999)
    ops.node(74032, 12.0, 0.0, 10.3)
    ...
    # Central joint node
    ops.node(1001, 0.0, 0.0, 3.1, '-mass', 10.710932721712538, 10.710932721712538, 10.710932721712538, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31001, 0.175, 0.0, 3.1)
    ...
    ops.node(41001, 0.0, 0.175, 3.1)
    ops.element('elasticBeamColumn', 41001, 1001, 41001, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301001, 96180.9893)
    ops.uniaxialMaterial('Elastic', 401001, 96180.9893)
    ...
    # Central joint node
    ops.node(1002, 4.5, 0.0, 3.1, '-mass', 17.339908256880733, 17.339908256880733, 17.339908256880733, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51002, 4.275, 0.0, 3.1)
    ops.element('elasticBeamColumn', 51002, 51002, 1002, 99999, 88888)
    ops.node(31002, 4.725, 0.0, 3.1)
    ops.element('elasticBeamColumn', 31002, 1002, 31002, 99999, 88888)
    ops.node(21002, 4.5, 0.0, 2.775)
    ops.element('elasticBeamColumn', 21002, 21002, 1002, 99999, 99999)
    ops.node(71002, 4.5, 0.0, 3.425)
    ops.element('elasticBeamColumn', 71002, 1002, 71002, 99999, 99999)
    ops.node(41002, 4.5, 0.225, 3.1)
    ops.element('elasticBeamColumn', 41002, 1002, 41002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301002, 193811.5022)
    ops.uniaxialMaterial('Elastic', 401002, 223836.20245)
    ...
    # Central joint node
    ops.node(1003, 9.0, 0.0, 3.1, '-mass', 11.50711009174312, 11.50711009174312, 11.50711009174312, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51003, 8.775, 0.0, 3.1)
    ops.element('elasticBeamColumn', 51003, 51003, 1003, 99999, 88888)
    ops.node(31003, 9.225, 0.0, 3.1)
    ops.element('elasticBeamColumn', 31003, 1003, 31003, 99999, 88888)
    ops.node(21003, 9.0, 0.0, 2.775)
    ops.element('elasticBeamColumn', 21003, 21003, 1003, 99999, 99999)
    ops.node(71003, 9.0, 0.0, 3.425)
    ops.element('elasticBeamColumn', 71003, 1003, 71003, 99999, 99999)
    ops.node(41003, 9.0, 0.225, 3.1)
    ops.element('elasticBeamColumn', 41003, 1003, 41003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301003, 231178.63575)
    ops.uniaxialMaterial('Elastic', 401003, 251964.0548)
    ...
    # Central joint node
    ops.node(1004, 12.0, 0.0, 3.1, '-mass', 11.50711009174312, 11.50711009174312, 11.50711009174312, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51004, 11.775, 0.0, 3.1)
    ops.element('elasticBeamColumn', 51004, 51004, 1004, 99999, 88888)
    ops.node(31004, 12.225, 0.0, 3.1)
    ops.element('elasticBeamColumn', 31004, 1004, 31004, 99999, 88888)
    ops.node(21004, 12.0, 0.0, 2.775)
    ops.element('elasticBeamColumn', 21004, 21004, 1004, 99999, 99999)
    ops.node(71004, 12.0, 0.0, 3.425)
    ops.element('elasticBeamColumn', 71004, 1004, 71004, 99999, 99999)
    ops.node(41004, 12.0, 0.225, 3.1)
    ops.element('elasticBeamColumn', 41004, 1004, 41004, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301004, 231178.63575)
    ops.uniaxialMaterial('Elastic', 401004, 251964.0548)
    ...
    # Central joint node
    ops.node(1005, 16.5, 0.0, 3.1, '-mass', 17.339908256880733, 17.339908256880733, 17.339908256880733, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51005, 16.275, 0.0, 3.1)
    ops.element('elasticBeamColumn', 51005, 51005, 1005, 99999, 88888)
    ops.node(31005, 16.725, 0.0, 3.1)
    ops.element('elasticBeamColumn', 31005, 1005, 31005, 99999, 88888)
    ops.node(21005, 16.5, 0.0, 2.775)
    ops.element('elasticBeamColumn', 21005, 21005, 1005, 99999, 99999)
    ops.node(71005, 16.5, 0.0, 3.425)
    ops.element('elasticBeamColumn', 71005, 1005, 71005, 99999, 99999)
    ops.node(41005, 16.5, 0.225, 3.1)
    ops.element('elasticBeamColumn', 41005, 1005, 41005, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301005, 193811.5022)
    ops.uniaxialMaterial('Elastic', 401005, 223836.20245)
    ...
    # Central joint node
    ops.node(1006, 21.0, 0.0, 3.1, '-mass', 10.710932721712538, 10.710932721712538, 10.710932721712538, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51006, 20.825, 0.0, 3.1)
    ops.element('elasticBeamColumn', 51006, 51006, 1006, 99999, 88888)
    ops.node(21006, 21.0, 0.0, 2.825)
    ops.element('elasticBeamColumn', 21006, 21006, 1006, 99999, 99999)
    ops.node(71006, 21.0, 0.0, 3.375)
    ops.element('elasticBeamColumn', 71006, 1006, 71006, 99999, 99999)
    ops.node(41006, 21.0, 0.175, 3.1)
    ops.element('elasticBeamColumn', 41006, 1006, 41006, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301006, 96180.9893)
    ops.uniaxialMaterial('Elastic', 401006, 96180.9893)
    ...
    # Central joint node
    ops.node(1007, 0.0, 4.5, 3.1, '-mass', 17.339908256880737, 17.339908256880737, 17.339908256880737, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31007, 0.225, 4.5, 3.1)
    ops.element('elasticBeamColumn', 31007, 1007, 31007, 99999, 88888)
    ops.node(21007, 0.0, 4.5, 2.775)
    ops.element('elasticBeamColumn', 21007, 21007, 1007, 99999, 99999)
    ops.node(71007, 0.0, 4.5, 3.425)
    ops.element('elasticBeamColumn', 71007, 1007, 71007, 99999, 99999)
    ops.node(61007, 0.0, 4.275, 3.1)
    ops.element('elasticBeamColumn', 61007, 61007, 1007, 99999, 77777)
    ops.node(41007, 0.0, 4.725, 3.1)
    ops.element('elasticBeamColumn', 41007, 1007, 41007, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301007, 224195.3296)
    ops.uniaxialMaterial('Elastic', 401007, 194108.53195)
    ...
    # Central joint node
    ops.node(1008, 4.5, 4.5, 3.1, '-mass', 26.389602446483174, 26.389602446483174, 26.389602446483174, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51008, 4.225, 4.5, 3.1)
    ops.element('elasticBeamColumn', 51008, 51008, 1008, 99999, 88888)
    ops.node(31008, 4.775, 4.5, 3.1)
    ops.element('elasticBeamColumn', 31008, 1008, 31008, 99999, 88888)
    ops.node(21008, 4.5, 4.5, 2.775)
    ops.element('elasticBeamColumn', 21008, 21008, 1008, 99999, 99999)
    ops.node(71008, 4.5, 4.5, 3.425)
    ops.element('elasticBeamColumn', 71008, 1008, 71008, 99999, 99999)
    ops.node(61008, 4.5, 4.225, 3.1)
    ops.element('elasticBeamColumn', 61008, 61008, 1008, 99999, 77777)
    ops.node(41008, 4.5, 4.775, 3.1)
    ops.element('elasticBeamColumn', 41008, 1008, 41008, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301008, 394736.794)
    ops.uniaxialMaterial('Elastic', 401008, 394736.794)
    ...
    # Central joint node
    ops.node(1009, 9.0, 4.5, 3.1, '-mass', 23.770336391437308, 23.770336391437308, 23.770336391437308, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51009, 8.725, 4.5, 3.1)
    ops.element('elasticBeamColumn', 51009, 51009, 1009, 99999, 88888)
    ops.node(31009, 9.275, 4.5, 3.1)
    ops.element('elasticBeamColumn', 31009, 1009, 31009, 99999, 88888)
    ops.node(21009, 9.0, 4.5, 2.775)
    ops.element('elasticBeamColumn', 21009, 21009, 1009, 99999, 99999)
    ops.node(71009, 9.0, 4.5, 3.425)
    ops.element('elasticBeamColumn', 71009, 1009, 71009, 99999, 99999)
    ops.node(61009, 9.0, 4.225, 3.1)
    ops.element('elasticBeamColumn', 61009, 61009, 1009, 99999, 77777)
    ops.node(41009, 9.0, 4.775, 3.1)
    ops.element('elasticBeamColumn', 41009, 1009, 41009, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301009, 371774.2616)
    ops.uniaxialMaterial('Elastic', 401009, 371774.2616)
    ...
    # Central joint node
    ops.node(1010, 12.0, 4.5, 3.1, '-mass', 23.770336391437308, 23.770336391437308, 23.770336391437308, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51010, 11.725, 4.5, 3.1)
    ops.element('elasticBeamColumn', 51010, 51010, 1010, 99999, 88888)
    ops.node(31010, 12.275, 4.5, 3.1)
    ops.element('elasticBeamColumn', 31010, 1010, 31010, 99999, 88888)
    ops.node(21010, 12.0, 4.5, 2.775)
    ops.element('elasticBeamColumn', 21010, 21010, 1010, 99999, 99999)
    ops.node(71010, 12.0, 4.5, 3.425)
    ops.element('elasticBeamColumn', 71010, 1010, 71010, 99999, 99999)
    ops.node(61010, 12.0, 4.225, 3.1)
    ops.element('elasticBeamColumn', 61010, 61010, 1010, 99999, 77777)
    ops.node(41010, 12.0, 4.775, 3.1)
    ops.element('elasticBeamColumn', 41010, 1010, 41010, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301010, 371774.2616)
    ops.uniaxialMaterial('Elastic', 401010, 371774.2616)
    ...
    # Central joint node
    ops.node(1011, 16.5, 4.5, 3.1, '-mass', 26.389602446483174, 26.389602446483174, 26.389602446483174, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51011, 16.225, 4.5, 3.1)
    ops.element('elasticBeamColumn', 51011, 51011, 1011, 99999, 88888)
    ops.node(31011, 16.775, 4.5, 3.1)
    ops.element('elasticBeamColumn', 31011, 1011, 31011, 99999, 88888)
    ops.node(21011, 16.5, 4.5, 2.775)
    ops.element('elasticBeamColumn', 21011, 21011, 1011, 99999, 99999)
    ops.node(71011, 16.5, 4.5, 3.425)
    ops.element('elasticBeamColumn', 71011, 1011, 71011, 99999, 99999)
    ops.node(61011, 16.5, 4.225, 3.1)
    ops.element('elasticBeamColumn', 61011, 61011, 1011, 99999, 77777)
    ops.node(41011, 16.5, 4.775, 3.1)
    ops.element('elasticBeamColumn', 41011, 1011, 41011, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301011, 394736.794)
    ops.uniaxialMaterial('Elastic', 401011, 394736.794)
    ...
    # Central joint node
    ops.node(1012, 21.0, 4.5, 3.1, '-mass', 17.339908256880737, 17.339908256880737, 17.339908256880737, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51012, 20.775, 4.5, 3.1)
    ops.element('elasticBeamColumn', 51012, 51012, 1012, 99999, 88888)
    ops.node(21012, 21.0, 4.5, 2.775)
    ops.element('elasticBeamColumn', 21012, 21012, 1012, 99999, 99999)
    ops.node(71012, 21.0, 4.5, 3.425)
    ops.element('elasticBeamColumn', 71012, 1012, 71012, 99999, 99999)
    ops.node(61012, 21.0, 4.275, 3.1)
    ops.element('elasticBeamColumn', 61012, 61012, 1012, 99999, 77777)
    ops.node(41012, 21.0, 4.725, 3.1)
    ops.element('elasticBeamColumn', 41012, 1012, 41012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301012, 224195.3296)
    ops.uniaxialMaterial('Elastic', 401012, 194108.53195)
    ...
    # Central joint node
    ops.node(1013, 0.0, 9.0, 3.1, '-mass', 17.339908256880737, 17.339908256880737, 17.339908256880737, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31013, 0.225, 9.0, 3.1)
    ops.element('elasticBeamColumn', 31013, 1013, 31013, 99999, 88888)
    ops.node(21013, 0.0, 9.0, 2.775)
    ops.element('elasticBeamColumn', 21013, 21013, 1013, 99999, 99999)
    ops.node(71013, 0.0, 9.0, 3.425)
    ops.element('elasticBeamColumn', 71013, 1013, 71013, 99999, 99999)
    ops.node(61013, 0.0, 8.775, 3.1)
    ops.element('elasticBeamColumn', 61013, 61013, 1013, 99999, 77777)
    ops.node(41013, 0.0, 9.225, 3.1)
    ops.element('elasticBeamColumn', 41013, 1013, 41013, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301013, 223919.12905)
    ops.uniaxialMaterial('Elastic', 401013, 193880.08995)
    ...
    # Central joint node
    ops.node(1014, 4.5, 9.0, 3.1, '-mass', 26.389602446483174, 26.389602446483174, 26.389602446483174, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51014, 4.225, 9.0, 3.1)
    ops.element('elasticBeamColumn', 51014, 51014, 1014, 99999, 88888)
    ops.node(31014, 4.775, 9.0, 3.1)
    ops.element('elasticBeamColumn', 31014, 1014, 31014, 99999, 88888)
    ops.node(21014, 4.5, 9.0, 2.775)
    ops.element('elasticBeamColumn', 21014, 21014, 1014, 99999, 99999)
    ops.node(71014, 4.5, 9.0, 3.425)
    ops.element('elasticBeamColumn', 71014, 1014, 71014, 99999, 99999)
    ops.node(61014, 4.5, 8.725, 3.1)
    ops.element('elasticBeamColumn', 61014, 61014, 1014, 99999, 77777)
    ops.node(41014, 4.5, 9.275, 3.1)
    ops.element('elasticBeamColumn', 41014, 1014, 41014, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301014, 394128.2359)
    ops.uniaxialMaterial('Elastic', 401014, 394128.2359)
    ...
    # Central joint node
    ops.node(1015, 9.0, 9.0, 3.1, '-mass', 23.483639143730887, 23.483639143730887, 23.483639143730887, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51015, 8.725, 9.0, 3.1)
    ops.element('elasticBeamColumn', 51015, 51015, 1015, 99999, 88888)
    ops.node(31015, 9.275, 9.0, 3.1)
    ops.element('elasticBeamColumn', 31015, 1015, 31015, 99999, 88888)
    ops.node(21015, 9.0, 9.0, 2.775)
    ops.element('elasticBeamColumn', 21015, 21015, 1015, 99999, 99999)
    ops.node(71015, 9.0, 9.0, 3.425)
    ops.element('elasticBeamColumn', 71015, 1015, 71015, 99999, 99999)
    ops.node(61015, 9.0, 8.725, 3.1)
    ops.element('elasticBeamColumn', 61015, 61015, 1015, 99999, 77777)
    ops.node(41015, 9.0, 9.275, 3.1)
    ops.element('elasticBeamColumn', 41015, 1015, 41015, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301015, 371712.17495)
    ops.uniaxialMaterial('Elastic', 401015, 371712.17495)
    ...
    # Central joint node
    ops.node(1016, 12.0, 9.0, 3.1, '-mass', 23.483639143730887, 23.483639143730887, 23.483639143730887, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51016, 11.725, 9.0, 3.1)
    ops.element('elasticBeamColumn', 51016, 51016, 1016, 99999, 88888)
    ops.node(31016, 12.275, 9.0, 3.1)
    ops.element('elasticBeamColumn', 31016, 1016, 31016, 99999, 88888)
    ops.node(21016, 12.0, 9.0, 2.775)
    ops.element('elasticBeamColumn', 21016, 21016, 1016, 99999, 99999)
    ops.node(71016, 12.0, 9.0, 3.425)
    ops.element('elasticBeamColumn', 71016, 1016, 71016, 99999, 99999)
    ops.node(61016, 12.0, 8.725, 3.1)
    ops.element('elasticBeamColumn', 61016, 61016, 1016, 99999, 77777)
    ops.node(41016, 12.0, 9.275, 3.1)
    ops.element('elasticBeamColumn', 41016, 1016, 41016, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301016, 371712.17495)
    ops.uniaxialMaterial('Elastic', 401016, 371712.17495)
    ...
    # Central joint node
    ops.node(1017, 16.5, 9.0, 3.1, '-mass', 26.389602446483174, 26.389602446483174, 26.389602446483174, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51017, 16.225, 9.0, 3.1)
    ops.element('elasticBeamColumn', 51017, 51017, 1017, 99999, 88888)
    ops.node(31017, 16.775, 9.0, 3.1)
    ops.element('elasticBeamColumn', 31017, 1017, 31017, 99999, 88888)
    ops.node(21017, 16.5, 9.0, 2.775)
    ops.element('elasticBeamColumn', 21017, 21017, 1017, 99999, 99999)
    ops.node(71017, 16.5, 9.0, 3.425)
    ops.element('elasticBeamColumn', 71017, 1017, 71017, 99999, 99999)
    ops.node(61017, 16.5, 8.725, 3.1)
    ops.element('elasticBeamColumn', 61017, 61017, 1017, 99999, 77777)
    ops.node(41017, 16.5, 9.275, 3.1)
    ops.element('elasticBeamColumn', 41017, 1017, 41017, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301017, 394128.2359)
    ops.uniaxialMaterial('Elastic', 401017, 394128.2359)
    ...
    # Central joint node
    ops.node(1018, 21.0, 9.0, 3.1, '-mass', 17.339908256880737, 17.339908256880737, 17.339908256880737, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51018, 20.775, 9.0, 3.1)
    ops.element('elasticBeamColumn', 51018, 51018, 1018, 99999, 88888)
    ops.node(21018, 21.0, 9.0, 2.775)
    ops.element('elasticBeamColumn', 21018, 21018, 1018, 99999, 99999)
    ops.node(71018, 21.0, 9.0, 3.425)
    ops.element('elasticBeamColumn', 71018, 1018, 71018, 99999, 99999)
    ops.node(61018, 21.0, 8.775, 3.1)
    ops.element('elasticBeamColumn', 61018, 61018, 1018, 99999, 77777)
    ops.node(41018, 21.0, 9.225, 3.1)
    ops.element('elasticBeamColumn', 41018, 1018, 41018, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301018, 223919.12905)
    ops.uniaxialMaterial('Elastic', 401018, 193880.08995)
    ...
    # Central joint node
    ops.node(1019, 0.0, 13.5, 3.1, '-mass', 10.710932721712538, 10.710932721712538, 10.710932721712538, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31019, 0.175, 13.5, 3.1)
    ops.element('elasticBeamColumn', 31019, 1019, 31019, 99999, 88888)
    ops.node(21019, 0.0, 13.5, 2.825)
    ops.element('elasticBeamColumn', 21019, 21019, 1019, 99999, 99999)
    ops.node(71019, 0.0, 13.5, 3.375)
    ops.element('elasticBeamColumn', 71019, 1019, 71019, 99999, 99999)
    ops.node(61019, 0.0, 13.325, 3.1)
    ops.element('elasticBeamColumn', 61019, 61019, 1019, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301019, 96180.9893)
    ops.uniaxialMaterial('Elastic', 401019, 96180.9893)
    ...
    # Central joint node
    ops.node(1020, 4.5, 13.5, 3.1, '-mass', 17.682721712538225, 17.682721712538225, 17.682721712538225, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51020, 4.25, 13.5, 3.1)
    ops.element('elasticBeamColumn', 51020, 51020, 1020, 99999, 88888)
    ops.node(31020, 4.75, 13.5, 3.1)
    ops.element('elasticBeamColumn', 31020, 1020, 31020, 99999, 88888)
    ops.node(21020, 4.5, 13.5, 2.775)
    ops.element('elasticBeamColumn', 21020, 21020, 1020, 99999, 99999)
    ops.node(71020, 4.5, 13.5, 3.425)
    ops.element('elasticBeamColumn', 71020, 1020, 71020, 99999, 99999)
    ops.node(61020, 4.5, 13.25, 3.1)
    ops.element('elasticBeamColumn', 61020, 61020, 1020, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301020, 216932.9338)
    ops.uniaxialMaterial('Elastic', 401020, 250792.99295)
    ...
    # Central joint node
    ops.node(1021, 9.0, 13.5, 3.1, '-mass', 15.257721712538226, 15.257721712538226, 15.257721712538226, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51021, 8.775, 13.5, 3.1)
    ops.element('elasticBeamColumn', 51021, 51021, 1021, 99999, 88888)
    ops.node(31021, 9.225, 13.5, 3.1)
    ops.element('elasticBeamColumn', 31021, 1021, 31021, 99999, 88888)
    ops.node(21021, 9.0, 13.5, 2.775)
    ops.element('elasticBeamColumn', 21021, 21021, 1021, 99999, 99999)
    ops.node(71021, 9.0, 13.5, 3.425)
    ops.element('elasticBeamColumn', 71021, 1021, 71021, 99999, 99999)
    ops.node(61021, 9.0, 13.275, 3.1)
    ops.element('elasticBeamColumn', 61021, 61021, 1021, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301021, 182256.35375)
    ops.uniaxialMaterial('Elastic', 401021, 209866.88065)
    ...
    # Central joint node
    ops.node(1022, 12.0, 13.5, 3.1, '-mass', 15.257721712538226, 15.257721712538226, 15.257721712538226, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51022, 11.775, 13.5, 3.1)
    ops.element('elasticBeamColumn', 51022, 51022, 1022, 99999, 88888)
    ops.node(31022, 12.225, 13.5, 3.1)
    ops.element('elasticBeamColumn', 31022, 1022, 31022, 99999, 88888)
    ops.node(21022, 12.0, 13.5, 2.775)
    ops.element('elasticBeamColumn', 21022, 21022, 1022, 99999, 99999)
    ops.node(71022, 12.0, 13.5, 3.425)
    ops.element('elasticBeamColumn', 71022, 1022, 71022, 99999, 99999)
    ops.node(61022, 12.0, 13.275, 3.1)
    ops.element('elasticBeamColumn', 61022, 61022, 1022, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301022, 182256.35375)
    ops.uniaxialMaterial('Elastic', 401022, 209866.88065)
    ...
    # Central joint node
    ops.node(1023, 16.5, 13.5, 3.1, '-mass', 17.682721712538225, 17.682721712538225, 17.682721712538225, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51023, 16.25, 13.5, 3.1)
    ops.element('elasticBeamColumn', 51023, 51023, 1023, 99999, 88888)
    ops.node(31023, 16.75, 13.5, 3.1)
    ops.element('elasticBeamColumn', 31023, 1023, 31023, 99999, 88888)
    ops.node(21023, 16.5, 13.5, 2.775)
    ops.element('elasticBeamColumn', 21023, 21023, 1023, 99999, 99999)
    ops.node(71023, 16.5, 13.5, 3.425)
    ops.element('elasticBeamColumn', 71023, 1023, 71023, 99999, 99999)
    ops.node(61023, 16.5, 13.25, 3.1)
    ops.element('elasticBeamColumn', 61023, 61023, 1023, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301023, 216932.9338)
    ops.uniaxialMaterial('Elastic', 401023, 250792.99295)
    ...
    # Central joint node
    ops.node(1024, 21.0, 13.5, 3.1, '-mass', 10.710932721712538, 10.710932721712538, 10.710932721712538, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51024, 20.825, 13.5, 3.1)
    ops.element('elasticBeamColumn', 51024, 51024, 1024, 99999, 88888)
    ops.node(21024, 21.0, 13.5, 2.825)
    ops.element('elasticBeamColumn', 21024, 21024, 1024, 99999, 99999)
    ops.node(71024, 21.0, 13.5, 3.375)
    ops.element('elasticBeamColumn', 71024, 1024, 71024, 99999, 99999)
    ops.node(61024, 21.0, 13.325, 3.1)
    ops.element('elasticBeamColumn', 61024, 61024, 1024, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301024, 96180.9893)
    ops.uniaxialMaterial('Elastic', 401024, 96180.9893)
    ...
    # Central joint node
    ops.node(2001, 0.0, 0.0, 5.9, '-mass', 10.389525993883792, 10.389525993883792, 10.389525993883792, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32001, 0.175, 0.0, 5.9)
    ...
    ops.node(42001, 0.0, 0.175, 5.9)
    ops.element('elasticBeamColumn', 42001, 2001, 42001, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302001, 73562.78985)
    ops.uniaxialMaterial('Elastic', 402001, 73562.78985)
    ...
    # Central joint node
    ops.node(2002, 4.5, 0.0, 5.9, '-mass', 16.64755351681957, 16.64755351681957, 16.64755351681957, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52002, 4.275, 0.0, 5.9)
    ops.element('elasticBeamColumn', 52002, 52002, 2002, 99999, 88888)
    ops.node(32002, 4.725, 0.0, 5.9)
    ops.element('elasticBeamColumn', 32002, 2002, 32002, 99999, 88888)
    ops.node(22002, 4.5, 0.0, 5.575)
    ops.element('elasticBeamColumn', 22002, 22002, 2002, 99999, 99999)
    ops.node(72002, 4.5, 0.0, 6.225)
    ops.element('elasticBeamColumn', 72002, 2002, 72002, 99999, 99999)
    ops.node(42002, 4.5, 0.225, 5.9)
    ops.element('elasticBeamColumn', 42002, 2002, 42002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302002, 167345.71415)
    ops.uniaxialMaterial('Elastic', 402002, 171456.4621)
    ...
    # Central joint node
    ops.node(2003, 9.0, 0.0, 5.9, '-mass', 11.016437308868502, 11.016437308868502, 11.016437308868502, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52003, 8.775, 0.0, 5.9)
    ops.element('elasticBeamColumn', 52003, 52003, 2003, 99999, 88888)
    ops.node(32003, 9.225, 0.0, 5.9)
    ops.element('elasticBeamColumn', 32003, 2003, 32003, 99999, 88888)
    ops.node(22003, 9.0, 0.0, 5.575)
    ops.element('elasticBeamColumn', 22003, 22003, 2003, 99999, 99999)
    ops.node(72003, 9.0, 0.0, 6.225)
    ops.element('elasticBeamColumn', 72003, 2003, 72003, 99999, 99999)
    ops.node(42003, 9.0, 0.225, 5.9)
    ops.element('elasticBeamColumn', 42003, 2003, 42003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302003, 196887.44145)
    ops.uniaxialMaterial('Elastic', 402003, 185491.1094)
    ...
    # Central joint node
    ops.node(2004, 12.0, 0.0, 5.9, '-mass', 11.016437308868502, 11.016437308868502, 11.016437308868502, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52004, 11.775, 0.0, 5.9)
    ops.element('elasticBeamColumn', 52004, 52004, 2004, 99999, 88888)
    ops.node(32004, 12.225, 0.0, 5.9)
    ops.element('elasticBeamColumn', 32004, 2004, 32004, 99999, 88888)
    ops.node(22004, 12.0, 0.0, 5.575)
    ops.element('elasticBeamColumn', 22004, 22004, 2004, 99999, 99999)
    ops.node(72004, 12.0, 0.0, 6.225)
    ops.element('elasticBeamColumn', 72004, 2004, 72004, 99999, 99999)
    ops.node(42004, 12.0, 0.225, 5.9)
    ops.element('elasticBeamColumn', 42004, 2004, 42004, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302004, 196887.44145)
    ops.uniaxialMaterial('Elastic', 402004, 185491.1094)
    ...
    # Central joint node
    ops.node(2005, 16.5, 0.0, 5.9, '-mass', 16.64755351681957, 16.64755351681957, 16.64755351681957, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52005, 16.275, 0.0, 5.9)
    ops.element('elasticBeamColumn', 52005, 52005, 2005, 99999, 88888)
    ops.node(32005, 16.725, 0.0, 5.9)
    ops.element('elasticBeamColumn', 32005, 2005, 32005, 99999, 88888)
    ops.node(22005, 16.5, 0.0, 5.575)
    ops.element('elasticBeamColumn', 22005, 22005, 2005, 99999, 99999)
    ops.node(72005, 16.5, 0.0, 6.225)
    ops.element('elasticBeamColumn', 72005, 2005, 72005, 99999, 99999)
    ops.node(42005, 16.5, 0.225, 5.9)
    ops.element('elasticBeamColumn', 42005, 2005, 42005, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302005, 167345.71415)
    ops.uniaxialMaterial('Elastic', 402005, 171456.4621)
    ...
    # Central joint node
    ops.node(2006, 21.0, 0.0, 5.9, '-mass', 10.389525993883792, 10.389525993883792, 10.389525993883792, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52006, 20.825, 0.0, 5.9)
    ops.element('elasticBeamColumn', 52006, 52006, 2006, 99999, 88888)
    ops.node(22006, 21.0, 0.0, 5.65)
    ops.element('elasticBeamColumn', 22006, 22006, 2006, 99999, 99999)
    ops.node(72006, 21.0, 0.0, 6.15)
    ops.element('elasticBeamColumn', 72006, 2006, 72006, 99999, 99999)
    ops.node(42006, 21.0, 0.175, 5.9)
    ops.element('elasticBeamColumn', 42006, 2006, 42006, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302006, 73562.78985)
    ops.uniaxialMaterial('Elastic', 402006, 73562.78985)
    ...
    # Central joint node
    ops.node(2007, 0.0, 4.5, 5.9, '-mass', 16.64755351681957, 16.64755351681957, 16.64755351681957, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32007, 0.225, 4.5, 5.9)
    ...
    ops.node(62007, 0.0, 4.275, 5.9)
    ops.element('elasticBeamColumn', 62007, 62007, 2007, 99999, 77777)
    ops.node(42007, 0.0, 4.725, 5.9)
    ops.element('elasticBeamColumn', 42007, 2007, 42007, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302007, 171830.83125)
    ops.uniaxialMaterial('Elastic', 402007, 167692.3772)
    ...
    # Central joint node
    ops.node(2008, 4.5, 4.5, 5.9, '-mass', 25.38318042813456, 25.38318042813456, 25.38318042813456, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52008, 4.225, 4.5, 5.9)
    ops.element('elasticBeamColumn', 52008, 52008, 2008, 99999, 88888)
    ops.node(32008, 4.775, 4.5, 5.9)
    ops.element('elasticBeamColumn', 32008, 2008, 32008, 99999, 88888)
    ops.node(22008, 4.5, 4.5, 5.575)
    ops.element('elasticBeamColumn', 22008, 22008, 2008, 99999, 99999)
    ops.node(72008, 4.5, 4.5, 6.225)
    ops.element('elasticBeamColumn', 72008, 2008, 72008, 99999, 99999)
    ops.node(62008, 4.5, 4.225, 5.9)
    ops.element('elasticBeamColumn', 62008, 62008, 2008, 99999, 77777)
    ops.node(42008, 4.5, 4.775, 5.9)
    ops.element('elasticBeamColumn', 42008, 2008, 42008, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302008, 342070.8825)
    ops.uniaxialMaterial('Elastic', 402008, 342070.8825)
    ...
    # Central joint node
    ops.node(2009, 9.0, 4.5, 5.9, '-mass', 22.82354740061162, 22.82354740061162, 22.82354740061162, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52009, 8.725, 4.5, 5.9)
    ops.element('elasticBeamColumn', 52009, 52009, 2009, 99999, 88888)
    ops.node(32009, 9.275, 4.5, 5.9)
    ops.element('elasticBeamColumn', 32009, 2009, 32009, 99999, 88888)
    ops.node(22009, 9.0, 4.5, 5.575)
    ops.element('elasticBeamColumn', 22009, 22009, 2009, 99999, 99999)
    ops.node(72009, 9.0, 4.5, 6.225)
    ops.element('elasticBeamColumn', 72009, 2009, 72009, 99999, 99999)
    ops.node(62009, 9.0, 4.225, 5.9)
    ops.element('elasticBeamColumn', 62009, 62009, 2009, 99999, 77777)
    ops.node(42009, 9.0, 4.775, 5.9)
    ops.element('elasticBeamColumn', 42009, 2009, 42009, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302009, 321367.77945)
    ops.uniaxialMaterial('Elastic', 402009, 321367.77945)
    ...
    # Central joint node
    ops.node(2010, 12.0, 4.5, 5.9, '-mass', 22.82354740061162, 22.82354740061162, 22.82354740061162, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52010, 11.725, 4.5, 5.9)
    ops.element('elasticBeamColumn', 52010, 52010, 2010, 99999, 88888)
    ops.node(32010, 12.275, 4.5, 5.9)
    ops.element('elasticBeamColumn', 32010, 2010, 32010, 99999, 88888)
    ops.node(22010, 12.0, 4.5, 5.575)
    ops.element('elasticBeamColumn', 22010, 22010, 2010, 99999, 99999)
    ops.node(72010, 12.0, 4.5, 6.225)
    ops.element('elasticBeamColumn', 72010, 2010, 72010, 99999, 99999)
    ops.node(62010, 12.0, 4.225, 5.9)
    ops.element('elasticBeamColumn', 62010, 62010, 2010, 99999, 77777)
    ops.node(42010, 12.0, 4.775, 5.9)
    ops.element('elasticBeamColumn', 42010, 2010, 42010, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302010, 321367.77945)
    ops.uniaxialMaterial('Elastic', 402010, 321367.77945)
    ...
    # Central joint node
    ops.node(2011, 16.5, 4.5, 5.9, '-mass', 25.38318042813456, 25.38318042813456, 25.38318042813456, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52011, 16.225, 4.5, 5.9)
    ops.element('elasticBeamColumn', 52011, 52011, 2011, 99999, 88888)
    ops.node(32011, 16.775, 4.5, 5.9)
    ops.element('elasticBeamColumn', 32011, 2011, 32011, 99999, 88888)
    ops.node(22011, 16.5, 4.5, 5.575)
    ops.element('elasticBeamColumn', 22011, 22011, 2011, 99999, 99999)
    ops.node(72011, 16.5, 4.5, 6.225)
    ops.element('elasticBeamColumn', 72011, 2011, 72011, 99999, 99999)
    ops.node(62011, 16.5, 4.225, 5.9)
    ops.element('elasticBeamColumn', 62011, 62011, 2011, 99999, 77777)
    ops.node(42011, 16.5, 4.775, 5.9)
    ops.element('elasticBeamColumn', 42011, 2011, 42011, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302011, 342070.8825)
    ops.uniaxialMaterial('Elastic', 402011, 342070.8825)
    ...
    # Central joint node
    ops.node(2012, 21.0, 4.5, 5.9, '-mass', 16.64755351681957, 16.64755351681957, 16.64755351681957, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52012, 20.775, 4.5, 5.9)
    ...
    ops.node(62012, 21.0, 4.275, 5.9)
    ops.element('elasticBeamColumn', 62012, 62012, 2012, 99999, 77777)
    ops.node(42012, 21.0, 4.725, 5.9)
    ops.element('elasticBeamColumn', 42012, 2012, 42012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302012, 171830.83125)
    ops.uniaxialMaterial('Elastic', 402012, 167692.3772)
    ...
    # Central joint node
    ops.node(2013, 0.0, 9.0, 5.9, '-mass', 16.64755351681957, 16.64755351681957, 16.64755351681957, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32013, 0.225, 9.0, 5.9)
    ...
    ops.node(62013, 0.0, 8.775, 5.9)
    ops.element('elasticBeamColumn', 62013, 62013, 2013, 99999, 77777)
    ops.node(42013, 0.0, 9.225, 5.9)
    ops.element('elasticBeamColumn', 42013, 2013, 42013, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302013, 171542.9275)
    ops.uniaxialMaterial('Elastic', 402013, 167425.78075)
    ...
    # Central joint node
    ops.node(2014, 4.5, 9.0, 5.9, '-mass', 25.38318042813456, 25.38318042813456, 25.38318042813456, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52014, 4.225, 9.0, 5.9)
    ops.element('elasticBeamColumn', 52014, 52014, 2014, 99999, 88888)
    ops.node(32014, 4.775, 9.0, 5.9)
    ops.element('elasticBeamColumn', 32014, 2014, 32014, 99999, 88888)
    ops.node(22014, 4.5, 9.0, 5.575)
    ops.element('elasticBeamColumn', 22014, 22014, 2014, 99999, 99999)
    ops.node(72014, 4.5, 9.0, 6.225)
    ops.element('elasticBeamColumn', 72014, 2014, 72014, 99999, 99999)
    ops.node(62014, 4.5, 8.725, 5.9)
    ops.element('elasticBeamColumn', 62014, 62014, 2014, 99999, 77777)
    ops.node(42014, 4.5, 9.275, 5.9)
    ops.element('elasticBeamColumn', 42014, 2014, 42014, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302014, 341368.4497)
    ops.uniaxialMaterial('Elastic', 402014, 341368.4497)
    ...
    # Central joint node
    ops.node(2015, 9.0, 9.0, 5.9, '-mass', 22.536850152905195, 22.536850152905195, 22.536850152905195, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52015, 8.725, 9.0, 5.9)
    ops.element('elasticBeamColumn', 52015, 52015, 2015, 99999, 88888)
    ops.node(32015, 9.275, 9.0, 5.9)
    ops.element('elasticBeamColumn', 32015, 2015, 32015, 99999, 88888)
    ops.node(22015, 9.0, 9.0, 5.575)
    ops.element('elasticBeamColumn', 22015, 22015, 2015, 99999, 99999)
    ops.node(72015, 9.0, 9.0, 6.225)
    ops.element('elasticBeamColumn', 72015, 2015, 72015, 99999, 99999)
    ops.node(62015, 9.0, 8.725, 5.9)
    ops.element('elasticBeamColumn', 62015, 62015, 2015, 99999, 77777)
    ops.node(42015, 9.0, 9.275, 5.9)
    ops.element('elasticBeamColumn', 42015, 2015, 42015, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302015, 321953.76665)
    ops.uniaxialMaterial('Elastic', 402015, 321953.76665)
    ...
    # Central joint node
    ops.node(2016, 12.0, 9.0, 5.9, '-mass', 22.536850152905195, 22.536850152905195, 22.536850152905195, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52016, 11.725, 9.0, 5.9)
    ops.element('elasticBeamColumn', 52016, 52016, 2016, 99999, 88888)
    ops.node(32016, 12.275, 9.0, 5.9)
    ops.element('elasticBeamColumn', 32016, 2016, 32016, 99999, 88888)
    ops.node(22016, 12.0, 9.0, 5.575)
    ops.element('elasticBeamColumn', 22016, 22016, 2016, 99999, 99999)
    ops.node(72016, 12.0, 9.0, 6.225)
    ops.element('elasticBeamColumn', 72016, 2016, 72016, 99999, 99999)
    ops.node(62016, 12.0, 8.725, 5.9)
    ops.element('elasticBeamColumn', 62016, 62016, 2016, 99999, 77777)
    ops.node(42016, 12.0, 9.275, 5.9)
    ops.element('elasticBeamColumn', 42016, 2016, 42016, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302016, 321953.76665)
    ops.uniaxialMaterial('Elastic', 402016, 321953.76665)
    ...
    # Central joint node
    ops.node(2017, 16.5, 9.0, 5.9, '-mass', 25.38318042813456, 25.38318042813456, 25.38318042813456, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52017, 16.225, 9.0, 5.9)
    ops.element('elasticBeamColumn', 52017, 52017, 2017, 99999, 88888)
    ops.node(32017, 16.775, 9.0, 5.9)
    ops.element('elasticBeamColumn', 32017, 2017, 32017, 99999, 88888)
    ops.node(22017, 16.5, 9.0, 5.575)
    ops.element('elasticBeamColumn', 22017, 22017, 2017, 99999, 99999)
    ops.node(72017, 16.5, 9.0, 6.225)
    ops.element('elasticBeamColumn', 72017, 2017, 72017, 99999, 99999)
    ops.node(62017, 16.5, 8.725, 5.9)
    ops.element('elasticBeamColumn', 62017, 62017, 2017, 99999, 77777)
    ops.node(42017, 16.5, 9.275, 5.9)
    ops.element('elasticBeamColumn', 42017, 2017, 42017, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302017, 341368.4497)
    ops.uniaxialMaterial('Elastic', 402017, 341368.4497)
    ...
    # Central joint node
    ops.node(2018, 21.0, 9.0, 5.9, '-mass', 16.64755351681957, 16.64755351681957, 16.64755351681957, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52018, 20.775, 9.0, 5.9)
    ...
    ops.node(62018, 21.0, 8.775, 5.9)
    ops.element('elasticBeamColumn', 62018, 62018, 2018, 99999, 77777)
    ops.node(42018, 21.0, 9.225, 5.9)
    ops.element('elasticBeamColumn', 42018, 2018, 42018, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302018, 171542.9275)
    ops.uniaxialMaterial('Elastic', 402018, 167425.78075)
    ...
    # Central joint node
    ops.node(2019, 0.0, 13.5, 5.9, '-mass', 10.389525993883792, 10.389525993883792, 10.389525993883792, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32019, 0.175, 13.5, 5.9)
    ops.element('elasticBeamColumn', 32019, 2019, 32019, 99999, 88888)
    ops.node(22019, 0.0, 13.5, 5.65)
    ops.element('elasticBeamColumn', 22019, 22019, 2019, 99999, 99999)
    ops.node(72019, 0.0, 13.5, 6.15)
    ops.element('elasticBeamColumn', 72019, 2019, 72019, 99999, 99999)
    ops.node(62019, 0.0, 13.325, 5.9)
    ops.element('elasticBeamColumn', 62019, 62019, 2019, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302019, 73562.78985)
    ops.uniaxialMaterial('Elastic', 402019, 73562.78985)
    ...
    # Central joint node
    ops.node(2020, 4.5, 13.5, 5.9, '-mass', 16.93868501529052, 16.93868501529052, 16.93868501529052, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52020, 4.25, 13.5, 5.9)
    ops.element('elasticBeamColumn', 52020, 52020, 2020, 99999, 88888)
    ops.node(32020, 4.75, 13.5, 5.9)
    ops.element('elasticBeamColumn', 32020, 2020, 32020, 99999, 88888)
    ops.node(22020, 4.5, 13.5, 5.575)
    ops.element('elasticBeamColumn', 22020, 22020, 2020, 99999, 99999)
    ops.node(72020, 4.5, 13.5, 6.225)
    ops.element('elasticBeamColumn', 72020, 2020, 72020, 99999, 99999)
    ops.node(62020, 4.5, 13.25, 5.9)
    ops.element('elasticBeamColumn', 62020, 62020, 2020, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302020, 187276.62465)
    ops.uniaxialMaterial('Elastic', 402020, 192125.6733)
    ...
    # Central joint node
    ops.node(2021, 9.0, 13.5, 5.9, '-mass', 14.592889908256879, 14.592889908256879, 14.592889908256879, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52021, 8.775, 13.5, 5.9)
    ops.element('elasticBeamColumn', 52021, 52021, 2021, 99999, 88888)
    ops.node(32021, 9.225, 13.5, 5.9)
    ops.element('elasticBeamColumn', 32021, 2021, 32021, 99999, 88888)
    ops.node(22021, 9.0, 13.5, 5.575)
    ops.element('elasticBeamColumn', 22021, 22021, 2021, 99999, 99999)
    ops.node(72021, 9.0, 13.5, 6.225)
    ops.element('elasticBeamColumn', 72021, 2021, 72021, 99999, 99999)
    ops.node(62021, 9.0, 13.275, 5.9)
    ops.element('elasticBeamColumn', 62021, 62021, 2021, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302021, 157470.29145)
    ops.uniaxialMaterial('Elastic', 402021, 160793.40445)
    ...
    # Central joint node
    ops.node(2022, 12.0, 13.5, 5.9, '-mass', 14.592889908256879, 14.592889908256879, 14.592889908256879, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52022, 11.775, 13.5, 5.9)
    ops.element('elasticBeamColumn', 52022, 52022, 2022, 99999, 88888)
    ops.node(32022, 12.225, 13.5, 5.9)
    ops.element('elasticBeamColumn', 32022, 2022, 32022, 99999, 88888)
    ops.node(22022, 12.0, 13.5, 5.575)
    ops.element('elasticBeamColumn', 22022, 22022, 2022, 99999, 99999)
    ops.node(72022, 12.0, 13.5, 6.225)
    ops.element('elasticBeamColumn', 72022, 2022, 72022, 99999, 99999)
    ops.node(62022, 12.0, 13.275, 5.9)
    ops.element('elasticBeamColumn', 62022, 62022, 2022, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302022, 157470.29145)
    ops.uniaxialMaterial('Elastic', 402022, 160793.40445)
    ...
    # Central joint node
    ops.node(2023, 16.5, 13.5, 5.9, '-mass', 16.93868501529052, 16.93868501529052, 16.93868501529052, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52023, 16.25, 13.5, 5.9)
    ops.element('elasticBeamColumn', 52023, 52023, 2023, 99999, 88888)
    ops.node(32023, 16.75, 13.5, 5.9)
    ops.element('elasticBeamColumn', 32023, 2023, 32023, 99999, 88888)
    ops.node(22023, 16.5, 13.5, 5.575)
    ops.element('elasticBeamColumn', 22023, 22023, 2023, 99999, 99999)
    ops.node(72023, 16.5, 13.5, 6.225)
    ops.element('elasticBeamColumn', 72023, 2023, 72023, 99999, 99999)
    ops.node(62023, 16.5, 13.25, 5.9)
    ops.element('elasticBeamColumn', 62023, 62023, 2023, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302023, 187276.62465)
    ops.uniaxialMaterial('Elastic', 402023, 192125.6733)
    ...
    # Central joint node
    ops.node(2024, 21.0, 13.5, 5.9, '-mass', 10.389525993883792, 10.389525993883792, 10.389525993883792, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52024, 20.825, 13.5, 5.9)
    ops.element('elasticBeamColumn', 52024, 52024, 2024, 99999, 88888)
    ops.node(22024, 21.0, 13.5, 5.65)
    ops.element('elasticBeamColumn', 22024, 22024, 2024, 99999, 99999)
    ops.node(72024, 21.0, 13.5, 6.15)
    ops.element('elasticBeamColumn', 72024, 2024, 72024, 99999, 99999)
    ops.node(62024, 21.0, 13.325, 5.9)
    ops.element('elasticBeamColumn', 62024, 62024, 2024, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302024, 73562.78985)
    ops.uniaxialMaterial('Elastic', 402024, 73562.78985)
    ...
    # Central joint node
    ops.node(3001, 0.0, 0.0, 8.7, '-mass', 9.934174311926604, 9.934174311926604, 9.934174311926604, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33001, 0.15, 0.0, 8.7)
    ...
    ops.node(43001, 0.0, 0.15, 8.7)
    ops.element('elasticBeamColumn', 43001, 3001, 43001, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303001, 50857.87075)
    ops.uniaxialMaterial('Elastic', 403001, 44681.81885)
    ...
    # Central joint node
    ops.node(3002, 4.5, 0.0, 8.7, '-mass', 15.712996941896023, 15.712996941896023, 15.712996941896023, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53002, 4.325, 0.0, 8.7)
    ops.element('elasticBeamColumn', 53002, 53002, 3002, 99999, 88888)
    ops.node(33002, 4.675, 0.0, 8.7)
    ops.element('elasticBeamColumn', 33002, 3002, 33002, 99999, 88888)
    ops.node(23002, 4.5, 0.0, 8.45)
    ops.element('elasticBeamColumn', 23002, 23002, 3002, 99999, 99999)
    ops.node(73002, 4.5, 0.0, 8.95)
    ops.element('elasticBeamColumn', 73002, 3002, 73002, 99999, 99999)
    ops.node(43002, 4.5, 0.175, 8.7)
    ops.element('elasticBeamColumn', 43002, 3002, 43002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303002, 76029.28415)
    ops.uniaxialMaterial('Elastic', 403002, 94617.3843)
    ...
    # Central joint node
    ops.node(3003, 9.0, 0.0, 8.7, '-mass', 10.287691131498473, 10.287691131498473, 10.287691131498473, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53003, 8.825, 0.0, 8.7)
    ops.element('elasticBeamColumn', 53003, 53003, 3003, 99999, 88888)
    ops.node(33003, 9.175, 0.0, 8.7)
    ...
    ops.node(43003, 9.0, 0.175, 8.7)
    ops.element('elasticBeamColumn', 43003, 3003, 43003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303003, 79802.9037)
    ops.uniaxialMaterial('Elastic', 403003, 96310.24785)
    ...
    # Central joint node
    ops.node(3004, 12.0, 0.0, 8.7, '-mass', 10.287691131498473, 10.287691131498473, 10.287691131498473, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53004, 11.825, 0.0, 8.7)
    ops.element('elasticBeamColumn', 53004, 53004, 3004, 99999, 88888)
    ops.node(33004, 12.175, 0.0, 8.7)
    ...
    ops.node(43004, 12.0, 0.175, 8.7)
    ops.element('elasticBeamColumn', 43004, 3004, 43004, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303004, 79802.9037)
    ops.uniaxialMaterial('Elastic', 403004, 96310.24785)
    ...
    # Central joint node
    ops.node(3005, 16.5, 0.0, 8.7, '-mass', 15.712996941896023, 15.712996941896023, 15.712996941896023, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53005, 16.325, 0.0, 8.7)
    ops.element('elasticBeamColumn', 53005, 53005, 3005, 99999, 88888)
    ops.node(33005, 16.675, 0.0, 8.7)
    ops.element('elasticBeamColumn', 33005, 3005, 33005, 99999, 88888)
    ops.node(23005, 16.5, 0.0, 8.45)
    ops.element('elasticBeamColumn', 23005, 23005, 3005, 99999, 99999)
    ops.node(73005, 16.5, 0.0, 8.95)
    ops.element('elasticBeamColumn', 73005, 3005, 73005, 99999, 99999)
    ops.node(43005, 16.5, 0.175, 8.7)
    ops.element('elasticBeamColumn', 43005, 3005, 43005, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303005, 76029.28415)
    ops.uniaxialMaterial('Elastic', 403005, 94617.3843)
    ...
    # Central joint node
    ops.node(3006, 21.0, 0.0, 8.7, '-mass', 9.934174311926604, 9.934174311926604, 9.934174311926604, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53006, 20.85, 0.0, 8.7)
    ...
    ops.node(43006, 21.0, 0.15, 8.7)
    ops.element('elasticBeamColumn', 43006, 3006, 43006, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303006, 50857.87075)
    ops.uniaxialMaterial('Elastic', 403006, 44681.81885)
    ...
    # Central joint node
    ops.node(3007, 0.0, 4.5, 8.7, '-mass', 15.850611620795107, 15.850611620795107, 15.850611620795107, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33007, 0.175, 4.5, 8.7)
    ops.element('elasticBeamColumn', 33007, 3007, 33007, 99999, 88888)
    ops.node(23007, 0.0, 4.5, 8.45)
    ops.element('elasticBeamColumn', 23007, 23007, 3007, 99999, 99999)
    ops.node(73007, 0.0, 4.5, 8.95)
    ops.element('elasticBeamColumn', 73007, 3007, 73007, 99999, 99999)
    ops.node(63007, 0.0, 4.325, 8.7)
    ops.element('elasticBeamColumn', 63007, 63007, 3007, 99999, 77777)
    ops.node(43007, 0.0, 4.675, 8.7)
    ops.element('elasticBeamColumn', 43007, 3007, 43007, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303007, 107271.1938)
    ops.uniaxialMaterial('Elastic', 403007, 76274.69975)
    ...
    # Central joint node
    ops.node(3008, 4.5, 4.5, 8.7, '-mass', 24.212538226299692, 24.212538226299692, 24.212538226299692, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53008, 4.25, 4.5, 8.7)
    ops.element('elasticBeamColumn', 53008, 53008, 3008, 99999, 88888)
    ops.node(33008, 4.75, 4.5, 8.7)
    ops.element('elasticBeamColumn', 33008, 3008, 33008, 99999, 88888)
    ops.node(23008, 4.5, 4.5, 8.45)
    ops.element('elasticBeamColumn', 23008, 23008, 3008, 99999, 99999)
    ops.node(73008, 4.5, 4.5, 8.95)
    ops.element('elasticBeamColumn', 73008, 3008, 73008, 99999, 99999)
    ops.node(63008, 4.5, 4.25, 8.7)
    ops.element('elasticBeamColumn', 63008, 63008, 3008, 99999, 77777)
    ops.node(43008, 4.5, 4.75, 8.7)
    ops.element('elasticBeamColumn', 43008, 3008, 43008, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303008, 186879.3513)
    ops.uniaxialMaterial('Elastic', 403008, 186879.3513)
    ...
    # Central joint node
    ops.node(3009, 9.0, 4.5, 8.7, '-mass', 21.735474006116203, 21.735474006116203, 21.735474006116203, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53009, 8.75, 4.5, 8.7)
    ops.element('elasticBeamColumn', 53009, 53009, 3009, 99999, 88888)
    ops.node(33009, 9.25, 4.5, 8.7)
    ...
    ops.node(63009, 9.0, 4.25, 8.7)
    ops.element('elasticBeamColumn', 63009, 63009, 3009, 99999, 77777)
    ops.node(43009, 9.0, 4.75, 8.7)
    ops.element('elasticBeamColumn', 43009, 3009, 43009, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303009, 174745.5503)
    ops.uniaxialMaterial('Elastic', 403009, 174745.5503)
    ...
    # Central joint node
    ops.node(3010, 12.0, 4.5, 8.7, '-mass', 21.735474006116203, 21.735474006116203, 21.735474006116203, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53010, 11.75, 4.5, 8.7)
    ops.element('elasticBeamColumn', 53010, 53010, 3010, 99999, 88888)
    ops.node(33010, 12.25, 4.5, 8.7)
    ...
    ops.node(63010, 12.0, 4.25, 8.7)
    ops.element('elasticBeamColumn', 63010, 63010, 3010, 99999, 77777)
    ops.node(43010, 12.0, 4.75, 8.7)
    ops.element('elasticBeamColumn', 43010, 3010, 43010, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303010, 174745.5503)
    ops.uniaxialMaterial('Elastic', 403010, 174745.5503)
    ...
    # Central joint node
    ops.node(3011, 16.5, 4.5, 8.7, '-mass', 24.212538226299692, 24.212538226299692, 24.212538226299692, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53011, 16.25, 4.5, 8.7)
    ops.element('elasticBeamColumn', 53011, 53011, 3011, 99999, 88888)
    ops.node(33011, 16.75, 4.5, 8.7)
    ops.element('elasticBeamColumn', 33011, 3011, 33011, 99999, 88888)
    ops.node(23011, 16.5, 4.5, 8.45)
    ops.element('elasticBeamColumn', 23011, 23011, 3011, 99999, 99999)
    ops.node(73011, 16.5, 4.5, 8.95)
    ops.element('elasticBeamColumn', 73011, 3011, 73011, 99999, 99999)
    ops.node(63011, 16.5, 4.25, 8.7)
    ops.element('elasticBeamColumn', 63011, 63011, 3011, 99999, 77777)
    ops.node(43011, 16.5, 4.75, 8.7)
    ops.element('elasticBeamColumn', 43011, 3011, 43011, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303011, 186879.3513)
    ops.uniaxialMaterial('Elastic', 403011, 186879.3513)
    ...
    # Central joint node
    ops.node(3012, 21.0, 4.5, 8.7, '-mass', 15.850611620795107, 15.850611620795107, 15.850611620795107, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53012, 20.825, 4.5, 8.7)
    ops.element('elasticBeamColumn', 53012, 53012, 3012, 99999, 88888)
    ops.node(23012, 21.0, 4.5, 8.45)
    ops.element('elasticBeamColumn', 23012, 23012, 3012, 99999, 99999)
    ops.node(73012, 21.0, 4.5, 8.95)
    ops.element('elasticBeamColumn', 73012, 3012, 73012, 99999, 99999)
    ops.node(63012, 21.0, 4.325, 8.7)
    ops.element('elasticBeamColumn', 63012, 63012, 3012, 99999, 77777)
    ops.node(43012, 21.0, 4.675, 8.7)
    ops.element('elasticBeamColumn', 43012, 3012, 43012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303012, 107271.1938)
    ops.uniaxialMaterial('Elastic', 403012, 76274.69975)
    ...
    # Central joint node
    ops.node(3013, 0.0, 9.0, 8.7, '-mass', 15.712996941896023, 15.712996941896023, 15.712996941896023, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33013, 0.175, 9.0, 8.7)
    ops.element('elasticBeamColumn', 33013, 3013, 33013, 99999, 88888)
    ops.node(23013, 0.0, 9.0, 8.45)
    ops.element('elasticBeamColumn', 23013, 23013, 3013, 99999, 99999)
    ops.node(73013, 0.0, 9.0, 8.95)
    ops.element('elasticBeamColumn', 73013, 3013, 73013, 99999, 99999)
    ops.node(63013, 0.0, 8.825, 8.7)
    ops.element('elasticBeamColumn', 63013, 63013, 3013, 99999, 77777)
    ops.node(43013, 0.0, 9.175, 8.7)
    ops.element('elasticBeamColumn', 43013, 3013, 43013, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303013, 106992.08225)
    ops.uniaxialMaterial('Elastic', 403013, 76085.9927)
    ...
    # Central joint node
    ops.node(3014, 4.5, 9.0, 8.7, '-mass', 23.937308868501525, 23.937308868501525, 23.937308868501525, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53014, 4.25, 9.0, 8.7)
    ops.element('elasticBeamColumn', 53014, 53014, 3014, 99999, 88888)
    ops.node(33014, 4.75, 9.0, 8.7)
    ops.element('elasticBeamColumn', 33014, 3014, 33014, 99999, 88888)
    ops.node(23014, 4.5, 9.0, 8.45)
    ops.element('elasticBeamColumn', 23014, 23014, 3014, 99999, 99999)
    ops.node(73014, 4.5, 9.0, 8.95)
    ops.element('elasticBeamColumn', 73014, 3014, 73014, 99999, 99999)
    ops.node(63014, 4.5, 8.75, 8.7)
    ops.element('elasticBeamColumn', 63014, 63014, 3014, 99999, 77777)
    ops.node(43014, 4.5, 9.25, 8.7)
    ops.element('elasticBeamColumn', 43014, 3014, 43014, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303014, 186312.4866)
    ops.uniaxialMaterial('Elastic', 403014, 186312.4866)
    ...
    # Central joint node
    ops.node(3015, 9.0, 9.0, 8.7, '-mass', 21.219418960244646, 21.219418960244646, 21.219418960244646, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53015, 8.75, 9.0, 8.7)
    ops.element('elasticBeamColumn', 53015, 53015, 3015, 99999, 88888)
    ops.node(33015, 9.25, 9.0, 8.7)
    ...
    ops.node(63015, 9.0, 8.75, 8.7)
    ops.element('elasticBeamColumn', 63015, 63015, 3015, 99999, 77777)
    ops.node(43015, 9.0, 9.25, 8.7)
    ops.element('elasticBeamColumn', 43015, 3015, 43015, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303015, 175751.49925)
    ops.uniaxialMaterial('Elastic', 403015, 175751.49925)
    ...
    # Central joint node
    ops.node(3016, 12.0, 9.0, 8.7, '-mass', 21.219418960244646, 21.219418960244646, 21.219418960244646, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53016, 11.75, 9.0, 8.7)
    ops.element('elasticBeamColumn', 53016, 53016, 3016, 99999, 88888)
    ops.node(33016, 12.25, 9.0, 8.7)
    ...
    ops.node(63016, 12.0, 8.75, 8.7)
    ops.element('elasticBeamColumn', 63016, 63016, 3016, 99999, 77777)
    ops.node(43016, 12.0, 9.25, 8.7)
    ops.element('elasticBeamColumn', 43016, 3016, 43016, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303016, 175751.49925)
    ops.uniaxialMaterial('Elastic', 403016, 175751.49925)
    ...
    # Central joint node
    ops.node(3017, 16.5, 9.0, 8.7, '-mass', 23.937308868501525, 23.937308868501525, 23.937308868501525, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53017, 16.25, 9.0, 8.7)
    ops.element('elasticBeamColumn', 53017, 53017, 3017, 99999, 88888)
    ops.node(33017, 16.75, 9.0, 8.7)
    ops.element('elasticBeamColumn', 33017, 3017, 33017, 99999, 88888)
    ops.node(23017, 16.5, 9.0, 8.45)
    ops.element('elasticBeamColumn', 23017, 23017, 3017, 99999, 99999)
    ops.node(73017, 16.5, 9.0, 8.95)
    ops.element('elasticBeamColumn', 73017, 3017, 73017, 99999, 99999)
    ops.node(63017, 16.5, 8.75, 8.7)
    ops.element('elasticBeamColumn', 63017, 63017, 3017, 99999, 77777)
    ops.node(43017, 16.5, 9.25, 8.7)
    ops.element('elasticBeamColumn', 43017, 3017, 43017, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303017, 186312.4866)
    ops.uniaxialMaterial('Elastic', 403017, 186312.4866)
    ...
    # Central joint node
    ops.node(3018, 21.0, 9.0, 8.7, '-mass', 15.712996941896023, 15.712996941896023, 15.712996941896023, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53018, 20.825, 9.0, 8.7)
    ops.element('elasticBeamColumn', 53018, 53018, 3018, 99999, 88888)
    ops.node(23018, 21.0, 9.0, 8.45)
    ops.element('elasticBeamColumn', 23018, 23018, 3018, 99999, 99999)
    ops.node(73018, 21.0, 9.0, 8.95)
    ops.element('elasticBeamColumn', 73018, 3018, 73018, 99999, 99999)
    ops.node(63018, 21.0, 8.825, 8.7)
    ops.element('elasticBeamColumn', 63018, 63018, 3018, 99999, 77777)
    ops.node(43018, 21.0, 9.175, 8.7)
    ops.element('elasticBeamColumn', 43018, 3018, 43018, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303018, 106992.08225)
    ops.uniaxialMaterial('Elastic', 403018, 76085.9927)
    ...
    # Central joint node
    ops.node(3019, 0.0, 13.5, 8.7, '-mass', 9.934174311926604, 9.934174311926604, 9.934174311926604, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33019, 0.15, 13.5, 8.7)
    ...
    ops.node(63019, 0.0, 13.35, 8.7)
    ops.element('elasticBeamColumn', 63019, 63019, 3019, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303019, 50857.87075)
    ops.uniaxialMaterial('Elastic', 403019, 44681.81885)
    ...
    # Central joint node
    ops.node(3020, 4.5, 13.5, 8.7, '-mass', 15.969877675840976, 15.969877675840976, 15.969877675840976, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53020, 4.3, 13.5, 8.7)
    ops.element('elasticBeamColumn', 53020, 53020, 3020, 99999, 88888)
    ops.node(33020, 4.7, 13.5, 8.7)
    ops.element('elasticBeamColumn', 33020, 3020, 33020, 99999, 88888)
    ops.node(23020, 4.5, 13.5, 8.45)
    ops.element('elasticBeamColumn', 23020, 23020, 3020, 99999, 99999)
    ops.node(73020, 4.5, 13.5, 8.95)
    ops.element('elasticBeamColumn', 73020, 3020, 73020, 99999, 99999)
    ops.node(63020, 4.5, 13.3, 8.7)
    ops.element('elasticBeamColumn', 63020, 63020, 3020, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303020, 87504.57015)
    ops.uniaxialMaterial('Elastic', 403020, 109059.65215)
    ...
    # Central joint node
    ops.node(3021, 9.0, 13.5, 8.7, '-mass', 13.727140672782872, 13.727140672782872, 13.727140672782872, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53021, 8.825, 13.5, 8.7)
    ops.element('elasticBeamColumn', 53021, 53021, 3021, 99999, 88888)
    ops.node(33021, 9.175, 13.5, 8.7)
    ...
    ops.node(63021, 9.0, 13.325, 8.7)
    ops.element('elasticBeamColumn', 63021, 63021, 3021, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303021, 71560.6246)
    ops.uniaxialMaterial('Elastic', 403021, 88768.6504)
    ...
    # Central joint node
    ops.node(3022, 12.0, 13.5, 8.7, '-mass', 13.727140672782872, 13.727140672782872, 13.727140672782872, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53022, 11.825, 13.5, 8.7)
    ops.element('elasticBeamColumn', 53022, 53022, 3022, 99999, 88888)
    ops.node(33022, 12.175, 13.5, 8.7)
    ...
    ops.node(63022, 12.0, 13.325, 8.7)
    ops.element('elasticBeamColumn', 63022, 63022, 3022, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303022, 71560.6246)
    ops.uniaxialMaterial('Elastic', 403022, 88768.6504)
    ...
    # Central joint node
    ops.node(3023, 16.5, 13.5, 8.7, '-mass', 15.969877675840976, 15.969877675840976, 15.969877675840976, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53023, 16.3, 13.5, 8.7)
    ops.element('elasticBeamColumn', 53023, 53023, 3023, 99999, 88888)
    ops.node(33023, 16.7, 13.5, 8.7)
    ops.element('elasticBeamColumn', 33023, 3023, 33023, 99999, 88888)
    ops.node(23023, 16.5, 13.5, 8.45)
    ops.element('elasticBeamColumn', 23023, 23023, 3023, 99999, 99999)
    ops.node(73023, 16.5, 13.5, 8.95)
    ops.element('elasticBeamColumn', 73023, 3023, 73023, 99999, 99999)
    ops.node(63023, 16.5, 13.3, 8.7)
    ops.element('elasticBeamColumn', 63023, 63023, 3023, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303023, 87504.57015)
    ops.uniaxialMaterial('Elastic', 403023, 109059.65215)
    ...
    # Central joint node
    ops.node(3024, 21.0, 13.5, 8.7, '-mass', 9.934174311926604, 9.934174311926604, 9.934174311926604, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53024, 20.85, 13.5, 8.7)
    ...
    ops.node(63024, 21.0, 13.35, 8.7)
    ops.element('elasticBeamColumn', 63024, 63024, 3024, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303024, 50857.87075)
    ops.uniaxialMaterial('Elastic', 403024, 44681.81885)
    ...
    # Central joint node
    ops.node(4001, 0.0, 0.0, 11.5, '-mass', 5.413761467889908, 5.413761467889908, 5.413761467889908, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34001, 0.15, 0.0, 11.5)
    ...
    ops.node(44001, 0.0, 0.15, 11.5)
    ops.element('elasticBeamColumn', 44001, 4001, 44001, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304001, 43158.89265)
    ops.uniaxialMaterial('Elastic', 404001, 31595.0672)
    ...
    # Central joint node
    ops.node(4002, 4.5, 0.0, 11.5, '-mass', 10.369113149847093, 10.369113149847093, 10.369113149847093, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54002, 4.325, 0.0, 11.5)
    ops.element('elasticBeamColumn', 54002, 54002, 4002, 99999, 88888)
    ops.node(34002, 4.675, 0.0, 11.5)
    ...
    ops.node(44002, 4.5, 0.175, 11.5)
    ops.element('elasticBeamColumn', 44002, 4002, 44002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304002, 76582.1028)
    ops.uniaxialMaterial('Elastic', 404002, 49723.36025)
    ...
    # Central joint node
    ops.node(4003, 9.0, 0.0, 11.5, '-mass', 5.783180428134556, 5.783180428134556, 5.783180428134556, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54003, 8.825, 0.0, 11.5)
    ops.element('elasticBeamColumn', 54003, 54003, 4003, 99999, 88888)
    ops.node(34003, 9.175, 0.0, 11.5)
    ...
    ops.node(44003, 9.0, 0.175, 11.5)
    ops.element('elasticBeamColumn', 44003, 4003, 44003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304003, 66358.45255)
    ops.uniaxialMaterial('Elastic', 404003, 37994.00915)
    ...
    # Central joint node
    ops.node(4004, 12.0, 0.0, 11.5, '-mass', 5.783180428134556, 5.783180428134556, 5.783180428134556, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54004, 11.825, 0.0, 11.5)
    ops.element('elasticBeamColumn', 54004, 54004, 4004, 99999, 88888)
    ops.node(34004, 12.175, 0.0, 11.5)
    ...
    ops.node(44004, 12.0, 0.175, 11.5)
    ops.element('elasticBeamColumn', 44004, 4004, 44004, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304004, 66358.45255)
    ops.uniaxialMaterial('Elastic', 404004, 37994.00915)
    ...
    # Central joint node
    ops.node(4005, 16.5, 0.0, 11.5, '-mass', 10.369113149847093, 10.369113149847093, 10.369113149847093, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54005, 16.325, 0.0, 11.5)
    ops.element('elasticBeamColumn', 54005, 54005, 4005, 99999, 88888)
    ops.node(34005, 16.675, 0.0, 11.5)
    ...
    ops.node(44005, 16.5, 0.175, 11.5)
    ops.element('elasticBeamColumn', 44005, 4005, 44005, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304005, 76582.1028)
    ops.uniaxialMaterial('Elastic', 404005, 49723.36025)
    ...
    # Central joint node
    ops.node(4006, 21.0, 0.0, 11.5, '-mass', 5.413761467889908, 5.413761467889908, 5.413761467889908, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54006, 20.85, 0.0, 11.5)
    ...
    ops.node(44006, 21.0, 0.15, 11.5)
    ops.element('elasticBeamColumn', 44006, 4006, 44006, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304006, 43158.89265)
    ops.uniaxialMaterial('Elastic', 404006, 31595.0672)
    ...
    # Central joint node
    ops.node(4007, 0.0, 4.5, 11.5, '-mass', 10.410397553516818, 10.410397553516818, 10.410397553516818, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34007, 0.175, 4.5, 11.5)
    ...
    ops.node(64007, 0.0, 4.325, 11.5)
    ops.element('elasticBeamColumn', 64007, 64007, 4007, 99999, 77777)
    ops.node(44007, 0.0, 4.675, 11.5)
    ops.element('elasticBeamColumn', 44007, 4007, 44007, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304007, 67597.5975)
    ops.uniaxialMaterial('Elastic', 404007, 67597.5975)
    ...
    # Central joint node
    ops.node(4008, 4.5, 4.5, 11.5, '-mass', 20.314984709480118, 20.314984709480118, 20.314984709480118, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54008, 4.25, 4.5, 11.5)
    ops.element('elasticBeamColumn', 54008, 54008, 4008, 99999, 88888)
    ops.node(34008, 4.75, 4.5, 11.5)
    ...
    ops.node(64008, 4.5, 4.25, 11.5)
    ops.element('elasticBeamColumn', 64008, 64008, 4008, 99999, 77777)
    ops.node(44008, 4.5, 4.75, 11.5)
    ops.element('elasticBeamColumn', 44008, 4008, 44008, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304008, 132992.95935)
    ops.uniaxialMaterial('Elastic', 404008, 124266.7869)
    ...
    # Central joint node
    ops.node(4009, 9.0, 4.5, 11.5, '-mass', 17.083333333333332, 17.083333333333332, 17.083333333333332, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54009, 8.75, 4.5, 11.5)
    ops.element('elasticBeamColumn', 54009, 54009, 4009, 99999, 88888)
    ops.node(34009, 9.25, 4.5, 11.5)
    ...
    ops.node(64009, 9.0, 4.25, 11.5)
    ops.element('elasticBeamColumn', 64009, 64009, 4009, 99999, 77777)
    ops.node(44009, 9.0, 4.75, 11.5)
    ops.element('elasticBeamColumn', 44009, 4009, 44009, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304009, 137625.11025)
    ops.uniaxialMaterial('Elastic', 404009, 114917.25865)
    ...
    # Central joint node
    ops.node(4010, 12.0, 4.5, 11.5, '-mass', 17.083333333333332, 17.083333333333332, 17.083333333333332, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54010, 11.75, 4.5, 11.5)
    ops.element('elasticBeamColumn', 54010, 54010, 4010, 99999, 88888)
    ops.node(34010, 12.25, 4.5, 11.5)
    ...
    ops.node(64010, 12.0, 4.25, 11.5)
    ops.element('elasticBeamColumn', 64010, 64010, 4010, 99999, 77777)
    ops.node(44010, 12.0, 4.75, 11.5)
    ops.element('elasticBeamColumn', 44010, 4010, 44010, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304010, 137625.11025)
    ops.uniaxialMaterial('Elastic', 404010, 114917.25865)
    ...
    # Central joint node
    ops.node(4011, 16.5, 4.5, 11.5, '-mass', 20.314984709480118, 20.314984709480118, 20.314984709480118, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54011, 16.25, 4.5, 11.5)
    ops.element('elasticBeamColumn', 54011, 54011, 4011, 99999, 88888)
    ops.node(34011, 16.75, 4.5, 11.5)
    ...
    ops.node(64011, 16.5, 4.25, 11.5)
    ops.element('elasticBeamColumn', 64011, 64011, 4011, 99999, 77777)
    ops.node(44011, 16.5, 4.75, 11.5)
    ops.element('elasticBeamColumn', 44011, 4011, 44011, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304011, 132992.95935)
    ops.uniaxialMaterial('Elastic', 404011, 124266.7869)
    ...
    # Central joint node
    ops.node(4012, 21.0, 4.5, 11.5, '-mass', 10.410397553516818, 10.410397553516818, 10.410397553516818, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54012, 20.825, 4.5, 11.5)
    ...
    ops.node(64012, 21.0, 4.325, 11.5)
    ops.element('elasticBeamColumn', 64012, 64012, 4012, 99999, 77777)
    ops.node(44012, 21.0, 4.675, 11.5)
    ops.element('elasticBeamColumn', 44012, 4012, 44012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304012, 67597.5975)
    ops.uniaxialMaterial('Elastic', 404012, 67597.5975)
    ...
    # Central joint node
    ops.node(4013, 0.0, 9.0, 11.5, '-mass', 10.410397553516818, 10.410397553516818, 10.410397553516818, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34013, 0.175, 9.0, 11.5)
    ...
    ops.node(64013, 0.0, 8.825, 11.5)
    ops.element('elasticBeamColumn', 64013, 64013, 4013, 99999, 77777)
    ops.node(44013, 0.0, 9.175, 11.5)
    ops.element('elasticBeamColumn', 44013, 4013, 44013, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304013, 67597.5975)
    ops.uniaxialMaterial('Elastic', 404013, 67597.5975)
    ...
    # Central joint node
    ops.node(4014, 4.5, 9.0, 11.5, '-mass', 20.314984709480118, 20.314984709480118, 20.314984709480118, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54014, 4.25, 9.0, 11.5)
    ops.element('elasticBeamColumn', 54014, 54014, 4014, 99999, 88888)
    ops.node(34014, 4.75, 9.0, 11.5)
    ...
    ops.node(64014, 4.5, 8.75, 11.5)
    ops.element('elasticBeamColumn', 64014, 64014, 4014, 99999, 77777)
    ops.node(44014, 4.5, 9.25, 11.5)
    ops.element('elasticBeamColumn', 44014, 4014, 44014, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304014, 132992.95935)
    ops.uniaxialMaterial('Elastic', 404014, 124266.7869)
    ...
    # Central joint node
    ops.node(4015, 9.0, 9.0, 11.5, '-mass', 18.058103975535165, 18.058103975535165, 18.058103975535165, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54015, 8.75, 9.0, 11.5)
    ops.element('elasticBeamColumn', 54015, 54015, 4015, 99999, 88888)
    ops.node(34015, 9.25, 9.0, 11.5)
    ...
    ops.node(64015, 9.0, 8.75, 11.5)
    ops.element('elasticBeamColumn', 64015, 64015, 4015, 99999, 77777)
    ops.node(44015, 9.0, 9.25, 11.5)
    ops.element('elasticBeamColumn', 44015, 4015, 44015, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304015, 141068.59015)
    ops.uniaxialMaterial('Elastic', 404015, 117819.9997)
    ...
    # Central joint node
    ops.node(4016, 12.0, 9.0, 11.5, '-mass', 18.058103975535165, 18.058103975535165, 18.058103975535165, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54016, 11.75, 9.0, 11.5)
    ops.element('elasticBeamColumn', 54016, 54016, 4016, 99999, 88888)
    ops.node(34016, 12.25, 9.0, 11.5)
    ...
    ops.node(64016, 12.0, 8.75, 11.5)
    ops.element('elasticBeamColumn', 64016, 64016, 4016, 99999, 77777)
    ops.node(44016, 12.0, 9.25, 11.5)
    ops.element('elasticBeamColumn', 44016, 4016, 44016, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304016, 141068.59015)
    ops.uniaxialMaterial('Elastic', 404016, 117819.9997)
    ...
    # Central joint node
    ops.node(4017, 16.5, 9.0, 11.5, '-mass', 20.314984709480118, 20.314984709480118, 20.314984709480118, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54017, 16.25, 9.0, 11.5)
    ops.element('elasticBeamColumn', 54017, 54017, 4017, 99999, 88888)
    ops.node(34017, 16.75, 9.0, 11.5)
    ...
    ops.node(64017, 16.5, 8.75, 11.5)
    ops.element('elasticBeamColumn', 64017, 64017, 4017, 99999, 77777)
    ops.node(44017, 16.5, 9.25, 11.5)
    ops.element('elasticBeamColumn', 44017, 4017, 44017, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304017, 132992.95935)
    ops.uniaxialMaterial('Elastic', 404017, 124266.7869)
    ...
    # Central joint node
    ops.node(4018, 21.0, 9.0, 11.5, '-mass', 10.410397553516818, 10.410397553516818, 10.410397553516818, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54018, 20.825, 9.0, 11.5)
    ...
    ops.node(64018, 21.0, 8.825, 11.5)
    ops.element('elasticBeamColumn', 64018, 64018, 4018, 99999, 77777)
    ops.node(44018, 21.0, 9.175, 11.5)
    ops.element('elasticBeamColumn', 44018, 4018, 44018, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304018, 67597.5975)
    ops.uniaxialMaterial('Elastic', 404018, 67597.5975)
    ...
    # Central joint node
    ops.node(4019, 0.0, 13.5, 11.5, '-mass', 5.413761467889908, 5.413761467889908, 5.413761467889908, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34019, 0.15, 13.5, 11.5)
    ...
    ops.node(64019, 0.0, 13.35, 11.5)
    ops.element('elasticBeamColumn', 64019, 64019, 4019, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304019, 43158.89265)
    ops.uniaxialMaterial('Elastic', 404019, 31595.0672)
    ...
    # Central joint node
    ops.node(4020, 4.5, 13.5, 11.5, '-mass', 10.49755351681957, 10.49755351681957, 10.49755351681957, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54020, 4.3, 13.5, 11.5)
    ops.element('elasticBeamColumn', 54020, 54020, 4020, 99999, 88888)
    ops.node(34020, 4.7, 13.5, 11.5)
    ...
    ops.node(64020, 4.5, 13.3, 11.5)
    ops.element('elasticBeamColumn', 64020, 64020, 4020, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304020, 88353.1672)
    ops.uniaxialMaterial('Elastic', 404020, 57381.49775)
    ...
    # Central joint node
    ops.node(4021, 9.0, 13.5, 11.5, '-mass', 9.203975535168194, 9.203975535168194, 9.203975535168194, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54021, 8.825, 13.5, 11.5)
    ops.element('elasticBeamColumn', 54021, 54021, 4021, 99999, 88888)
    ops.node(34021, 9.175, 13.5, 11.5)
    ...
    ops.node(64021, 9.0, 13.325, 11.5)
    ops.element('elasticBeamColumn', 64021, 64021, 4021, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304021, 81446.53425)
    ops.uniaxialMaterial('Elastic', 404021, 47078.5251)
    ...
    # Central joint node
    ops.node(4022, 12.0, 13.5, 11.5, '-mass', 9.203975535168194, 9.203975535168194, 9.203975535168194, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54022, 11.825, 13.5, 11.5)
    ops.element('elasticBeamColumn', 54022, 54022, 4022, 99999, 88888)
    ops.node(34022, 12.175, 13.5, 11.5)
    ...
    ops.node(64022, 12.0, 13.325, 11.5)
    ops.element('elasticBeamColumn', 64022, 64022, 4022, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304022, 81446.53425)
    ops.uniaxialMaterial('Elastic', 404022, 47078.5251)
    ...
    # Central joint node
    ops.node(4023, 16.5, 13.5, 11.5, '-mass', 10.49755351681957, 10.49755351681957, 10.49755351681957, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54023, 16.3, 13.5, 11.5)
    ops.element('elasticBeamColumn', 54023, 54023, 4023, 99999, 88888)
    ops.node(34023, 16.7, 13.5, 11.5)
    ...
    ops.node(64023, 16.5, 13.3, 11.5)
    ops.element('elasticBeamColumn', 64023, 64023, 4023, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304023, 88353.1672)
    ops.uniaxialMaterial('Elastic', 404023, 57381.49775)
    ...
    # Central joint node
    ops.node(4024, 21.0, 13.5, 11.5, '-mass', 5.413761467889908, 5.413761467889908, 5.413761467889908, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54024, 20.85, 13.5, 11.5)
    ...
    ops.node(64024, 21.0, 13.35, 11.5)
    ops.element('elasticBeamColumn', 64024, 64024, 4024, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304024, 43158.89265)
    ops.uniaxialMaterial('Elastic', 404024, 31595.0672)
