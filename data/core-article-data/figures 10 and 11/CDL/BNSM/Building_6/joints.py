...
def add_joints() -> None:
    ...
    # Central joint node
    ops.node(4025, 9.0, 0.0, 1.55, '-mass', 4.55428134556575, 4.55428134556575, 4.55428134556575, 0.0, 0.0, 0.0)
    ...
    # Central joint node
    ops.node(4026, 12.0, 0.0, 1.55, '-mass', 4.55428134556575, 4.55428134556575, 4.55428134556575, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4027, 9.0, 0.0, 4.5, '-mass', 4.3432721712538225, 4.3432721712538225, 4.3432721712538225, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4028, 12.0, 0.0, 4.5, '-mass', 4.3432721712538225, 4.3432721712538225, 4.3432721712538225, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.uniaxialMaterial('Elastic', 301001, 138405.49025)
    ops.uniaxialMaterial('Elastic', 401001, 138405.49025)
    ...
    # Central joint node
    ops.node(1002, 4.5, 0.0, 3.1, '-mass', 18.20565749235474, 18.20565749235474, 18.20565749235474, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301002, 263338.0789)
    ops.uniaxialMaterial('Elastic', 401002, 309155.8746)
    ...
    # Central joint node
    ops.node(1003, 9.0, 0.0, 3.1, '-mass', 12.146406727828746, 12.146406727828746, 12.146406727828746, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301003, 334625.20845)
    ops.uniaxialMaterial('Elastic', 401003, 367846.17035)
    ...
    # Central joint node
    ops.node(1004, 12.0, 0.0, 3.1, '-mass', 12.146406727828746, 12.146406727828746, 12.146406727828746, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301004, 334625.20845)
    ops.uniaxialMaterial('Elastic', 401004, 367846.17035)
    ...
    # Central joint node
    ops.node(1005, 16.5, 0.0, 3.1, '-mass', 18.20565749235474, 18.20565749235474, 18.20565749235474, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301005, 263338.0789)
    ops.uniaxialMaterial('Elastic', 401005, 309155.8746)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301006, 138405.49025)
    ops.uniaxialMaterial('Elastic', 401006, 138405.49025)
    ...
    # Central joint node
    ops.node(1007, 0.0, 4.5, 3.1, '-mass', 18.20565749235474, 18.20565749235474, 18.20565749235474, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301007, 310421.81535)
    ops.uniaxialMaterial('Elastic', 401007, 264361.84405)
    ...
    # Central joint node
    ops.node(1008, 4.5, 4.5, 3.1, '-mass', 28.026299694189596, 28.026299694189596, 28.026299694189596, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301008, 569224.3796)
    ops.uniaxialMaterial('Elastic', 401008, 569224.3796)
    ...
    # Central joint node
    ops.node(1009, 9.0, 4.5, 3.1, '-mass', 25.342813455657488, 25.342813455657488, 25.342813455657488, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301009, 536457.6632)
    ops.uniaxialMaterial('Elastic', 401009, 536457.6632)
    ...
    # Central joint node
    ops.node(1010, 12.0, 4.5, 3.1, '-mass', 25.342813455657488, 25.342813455657488, 25.342813455657488, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301010, 536457.6632)
    ops.uniaxialMaterial('Elastic', 401010, 536457.6632)
    ...
    # Central joint node
    ops.node(1011, 16.5, 4.5, 3.1, '-mass', 28.026299694189596, 28.026299694189596, 28.026299694189596, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301011, 569224.3796)
    ops.uniaxialMaterial('Elastic', 401011, 569224.3796)
    ...
    # Central joint node
    ops.node(1012, 21.0, 4.5, 3.1, '-mass', 18.20565749235474, 18.20565749235474, 18.20565749235474, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301012, 310421.81535)
    ops.uniaxialMaterial('Elastic', 401012, 264361.84405)
    ...
    # Central joint node
    ops.node(1013, 0.0, 9.0, 3.1, '-mass', 18.20565749235474, 18.20565749235474, 18.20565749235474, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301013, 309784.56575)
    ops.uniaxialMaterial('Elastic', 401013, 263846.5028)
    ...
    # Central joint node
    ops.node(1014, 4.5, 9.0, 3.1, '-mass', 28.026299694189596, 28.026299694189596, 28.026299694189596, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301014, 567789.23435)
    ops.uniaxialMaterial('Elastic', 401014, 567789.23435)
    ...
    # Central joint node
    ops.node(1015, 9.0, 9.0, 3.1, '-mass', 25.056116207951064, 25.056116207951064, 25.056116207951064, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301015, 535849.4236)
    ops.uniaxialMaterial('Elastic', 401015, 535849.4236)
    ...
    # Central joint node
    ops.node(1016, 12.0, 9.0, 3.1, '-mass', 25.056116207951064, 25.056116207951064, 25.056116207951064, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301016, 535849.4236)
    ops.uniaxialMaterial('Elastic', 401016, 535849.4236)
    ...
    # Central joint node
    ops.node(1017, 16.5, 9.0, 3.1, '-mass', 28.026299694189596, 28.026299694189596, 28.026299694189596, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301017, 567789.23435)
    ops.uniaxialMaterial('Elastic', 401017, 567789.23435)
    ...
    # Central joint node
    ops.node(1018, 21.0, 9.0, 3.1, '-mass', 18.20565749235474, 18.20565749235474, 18.20565749235474, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301018, 309784.56575)
    ops.uniaxialMaterial('Elastic', 401018, 263846.5028)
    ...
    # Central joint node
    ops.node(1019, 0.0, 13.5, 3.1, '-mass', 11.311850152905198, 11.311850152905198, 11.311850152905198, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301019, 138405.49025)
    ops.uniaxialMaterial('Elastic', 401019, 138405.49025)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301020, 292994.965)
    ops.uniaxialMaterial('Elastic', 401020, 344425.0606)
    ...
    # Central joint node
    ops.node(1021, 9.0, 13.5, 3.1, '-mass', 16.0684250764526, 16.0684250764526, 16.0684250764526, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301021, 247814.5613)
    ops.uniaxialMaterial('Elastic', 401021, 289962.69555)
    ...
    # Central joint node
    ops.node(1022, 12.0, 13.5, 3.1, '-mass', 16.0684250764526, 16.0684250764526, 16.0684250764526, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301022, 247814.5613)
    ops.uniaxialMaterial('Elastic', 401022, 289962.69555)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301023, 292994.965)
    ops.uniaxialMaterial('Elastic', 401023, 344425.0606)
    ...
    # Central joint node
    ops.node(1024, 21.0, 13.5, 3.1, '-mass', 11.311850152905198, 11.311850152905198, 11.311850152905198, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301024, 138405.49025)
    ops.uniaxialMaterial('Elastic', 401024, 138405.49025)
    ...
    # Central joint node
    ops.node(2001, 0.0, 0.0, 5.9, '-mass', 10.794418960244649, 10.794418960244649, 10.794418960244649, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302001, 96184.2918)
    ops.uniaxialMaterial('Elastic', 402001, 96184.2918)
    ...
    # Central joint node
    ops.node(2002, 4.5, 0.0, 5.9, '-mass', 17.10382262996942, 17.10382262996942, 17.10382262996942, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302002, 188052.08145)
    ops.uniaxialMaterial('Elastic', 402002, 215909.7008)
    ...
    # Central joint node
    ops.node(2003, 9.0, 0.0, 5.9, '-mass', 11.299617737003059, 11.299617737003059, 11.299617737003059, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302003, 221623.8241)
    ops.uniaxialMaterial('Elastic', 402003, 239870.99775)
    ...
    # Central joint node
    ops.node(2004, 12.0, 0.0, 5.9, '-mass', 11.299617737003059, 11.299617737003059, 11.299617737003059, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302004, 221623.8241)
    ops.uniaxialMaterial('Elastic', 402004, 239870.99775)
    ...
    # Central joint node
    ops.node(2005, 16.5, 0.0, 5.9, '-mass', 17.10382262996942, 17.10382262996942, 17.10382262996942, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302005, 188052.08145)
    ops.uniaxialMaterial('Elastic', 402005, 215909.7008)
    ...
    # Central joint node
    ops.node(2006, 21.0, 0.0, 5.9, '-mass', 10.794418960244649, 10.794418960244649, 10.794418960244649, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302006, 96184.2918)
    ops.uniaxialMaterial('Elastic', 402006, 96184.2918)
    ...
    # Central joint node
    ops.node(2007, 0.0, 4.5, 5.9, '-mass', 17.28272171253823, 17.28272171253823, 17.28272171253823, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302007, 217118.86085)
    ops.uniaxialMaterial('Elastic', 402007, 189053.5913)
    ...
    # Central joint node
    ops.node(2008, 4.5, 4.5, 5.9, '-mass', 26.331804281345562, 26.331804281345562, 26.331804281345562, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302008, 410910.24165)
    ops.uniaxialMaterial('Elastic', 402008, 402771.2917)
    ...
    # Central joint node
    ops.node(2009, 9.0, 4.5, 5.9, '-mass', 23.71253822629969, 23.71253822629969, 23.71253822629969, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302009, 386097.1548)
    ops.uniaxialMaterial('Elastic', 402009, 378429.8129)
    ...
    # Central joint node
    ops.node(2010, 12.0, 4.5, 5.9, '-mass', 23.71253822629969, 23.71253822629969, 23.71253822629969, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302010, 386097.1548)
    ops.uniaxialMaterial('Elastic', 402010, 378429.8129)
    ...
    # Central joint node
    ops.node(2011, 16.5, 4.5, 5.9, '-mass', 26.331804281345562, 26.331804281345562, 26.331804281345562, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302011, 410910.24165)
    ops.uniaxialMaterial('Elastic', 402011, 402771.2917)
    ...
    # Central joint node
    ops.node(2012, 21.0, 4.5, 5.9, '-mass', 17.28272171253823, 17.28272171253823, 17.28272171253823, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302012, 217118.86085)
    ops.uniaxialMaterial('Elastic', 402012, 189053.5913)
    ...
    # Central joint node
    ops.node(2013, 0.0, 9.0, 5.9, '-mass', 17.10382262996942, 17.10382262996942, 17.10382262996942, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302013, 216510.42)
    ops.uniaxialMaterial('Elastic', 402013, 188549.64285)
    ...
    # Central joint node
    ops.node(2014, 4.5, 9.0, 5.9, '-mass', 25.974006116207953, 25.974006116207953, 25.974006116207953, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302014, 401408.37735)
    ops.uniaxialMaterial('Elastic', 402014, 401408.37735)
    ...
    # Central joint node
    ops.node(2015, 9.0, 9.0, 5.9, '-mass', 23.12767584097859, 23.12767584097859, 23.12767584097859, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302015, 378601.77975)
    ops.uniaxialMaterial('Elastic', 402015, 378601.77975)
    ...
    # Central joint node
    ops.node(2016, 12.0, 9.0, 5.9, '-mass', 23.12767584097859, 23.12767584097859, 23.12767584097859, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302016, 378601.77975)
    ops.uniaxialMaterial('Elastic', 402016, 378601.77975)
    ...
    # Central joint node
    ops.node(2017, 16.5, 9.0, 5.9, '-mass', 25.974006116207953, 25.974006116207953, 25.974006116207953, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302017, 401408.37735)
    ops.uniaxialMaterial('Elastic', 402017, 401408.37735)
    ...
    # Central joint node
    ops.node(2018, 21.0, 9.0, 5.9, '-mass', 17.10382262996942, 17.10382262996942, 17.10382262996942, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302018, 216510.42)
    ops.uniaxialMaterial('Elastic', 402018, 188549.64285)
    ...
    # Central joint node
    ops.node(2019, 0.0, 13.5, 5.9, '-mass', 10.794418960244649, 10.794418960244649, 10.794418960244649, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302019, 96184.2918)
    ops.uniaxialMaterial('Elastic', 402019, 96184.2918)
    ...
    # Central joint node
    ops.node(2020, 4.5, 13.5, 5.9, '-mass', 17.591896024464834, 17.591896024464834, 17.591896024464834, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302020, 209490.71625)
    ops.uniaxialMaterial('Elastic', 402020, 240913.43735)
    ...
    # Central joint node
    ops.node(2021, 9.0, 13.5, 5.9, '-mass', 15.02163608562691, 15.02163608562691, 15.02163608562691, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302021, 176924.67355)
    ops.uniaxialMaterial('Elastic', 402021, 202478.15045)
    ...
    # Central joint node
    ops.node(2022, 12.0, 13.5, 5.9, '-mass', 15.02163608562691, 15.02163608562691, 15.02163608562691, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302022, 176924.67355)
    ops.uniaxialMaterial('Elastic', 402022, 202478.15045)
    ...
    # Central joint node
    ops.node(2023, 16.5, 13.5, 5.9, '-mass', 17.591896024464834, 17.591896024464834, 17.591896024464834, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302023, 209490.71625)
    ops.uniaxialMaterial('Elastic', 402023, 240913.43735)
    ...
    # Central joint node
    ops.node(2024, 21.0, 13.5, 5.9, '-mass', 10.794418960244649, 10.794418960244649, 10.794418960244649, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302024, 96184.2918)
    ops.uniaxialMaterial('Elastic', 402024, 96184.2918)
    ...
    # Central joint node
    ops.node(3002, 4.5, 0.0, 8.7, '-mass', 16.19006116207951, 16.19006116207951, 16.19006116207951, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303002, 98842.93605)
    ops.uniaxialMaterial('Elastic', 403002, 123732.5915)
    ...
    # Central joint node
    ops.node(3003, 9.0, 0.0, 8.7, '-mass', 10.530810397553518, 10.530810397553518, 10.530810397553518, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303003, 92376.8712)
    ops.uniaxialMaterial('Elastic', 403003, 129201.45175)
    ...
    # Central joint node
    ops.node(3004, 12.0, 0.0, 8.7, '-mass', 10.530810397553518, 10.530810397553518, 10.530810397553518, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303004, 92376.8712)
    ops.uniaxialMaterial('Elastic', 403004, 129201.45175)
    ...
    # Central joint node
    ops.node(3005, 16.5, 0.0, 8.7, '-mass', 16.19006116207951, 16.19006116207951, 16.19006116207951, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303005, 98842.93605)
    ops.uniaxialMaterial('Elastic', 403005, 123732.5915)
    ...
    # Central joint node
    ops.node(3007, 0.0, 4.5, 8.7, '-mass', 16.465290519877676, 16.465290519877676, 16.465290519877676, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303007, 124456.45165)
    ops.uniaxialMaterial('Elastic', 403007, 99390.9351)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303008, 232682.72715)
    ops.uniaxialMaterial('Elastic', 403008, 232682.72715)
    ...
    # Central joint node
    ops.node(3009, 9.0, 4.5, 8.7, '-mass', 22.232721712538225, 22.232721712538225, 22.232721712538225, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303009, 194308.5626)
    ops.uniaxialMaterial('Elastic', 403009, 217415.9729)
    ...
    # Central joint node
    ops.node(3010, 12.0, 4.5, 8.7, '-mass', 22.232721712538225, 22.232721712538225, 22.232721712538225, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303010, 194308.5626)
    ops.uniaxialMaterial('Elastic', 403010, 217415.9729)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303011, 232682.72715)
    ops.uniaxialMaterial('Elastic', 403011, 232682.72715)
    ...
    # Central joint node
    ops.node(3012, 21.0, 4.5, 8.7, '-mass', 16.465290519877676, 16.465290519877676, 16.465290519877676, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303012, 124456.45165)
    ops.uniaxialMaterial('Elastic', 403012, 99390.9351)
    ...
    # Central joint node
    ops.node(3013, 0.0, 9.0, 8.7, '-mass', 16.382721712538224, 16.382721712538224, 16.382721712538224, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303013, 124268.0251)
    ops.uniaxialMaterial('Elastic', 403013, 88209.47705)
    ...
    # Central joint node
    ops.node(3014, 4.5, 9.0, 8.7, '-mass', 24.73730886850153, 24.73730886850153, 24.73730886850153, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303014, 232269.16655)
    ops.uniaxialMaterial('Elastic', 403014, 207583.1287)
    ...
    # Central joint node
    ops.node(3015, 9.0, 9.0, 8.7, '-mass', 21.80840978593272, 21.80840978593272, 21.80840978593272, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303015, 195621.4885)
    ops.uniaxialMaterial('Elastic', 403015, 195621.4885)
    ...
    # Central joint node
    ops.node(3016, 12.0, 9.0, 8.7, '-mass', 21.80840978593272, 21.80840978593272, 21.80840978593272, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303016, 195621.4885)
    ops.uniaxialMaterial('Elastic', 403016, 195621.4885)
    ...
    # Central joint node
    ops.node(3017, 16.5, 9.0, 8.7, '-mass', 24.73730886850153, 24.73730886850153, 24.73730886850153, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303017, 232269.16655)
    ops.uniaxialMaterial('Elastic', 403017, 207583.1287)
    ...
    # Central joint node
    ops.node(3018, 21.0, 9.0, 8.7, '-mass', 16.382721712538224, 16.382721712538224, 16.382721712538224, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303018, 124268.0251)
    ops.uniaxialMaterial('Elastic', 403018, 88209.47705)
    ...
    # Central joint node
    ops.node(3021, 9.0, 13.5, 8.7, '-mass', 14.098700305810395, 14.098700305810395, 14.098700305810395, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303021, 82628.01505)
    ops.uniaxialMaterial('Elastic', 403021, 116023.0837)
    ...
    # Central joint node
    ops.node(3022, 12.0, 13.5, 8.7, '-mass', 14.098700305810395, 14.098700305810395, 14.098700305810395, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303022, 82628.01505)
    ops.uniaxialMaterial('Elastic', 403022, 116023.0837)
    ...
    # Central joint node
    ops.node(4002, 4.5, 0.0, 11.5, '-mass', 10.49755351681957, 10.49755351681957, 10.49755351681957, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304002, 88353.1672)
    ops.uniaxialMaterial('Elastic', 404002, 57381.49775)
    ...
    # Central joint node
    ops.node(4005, 16.5, 0.0, 11.5, '-mass', 10.49755351681957, 10.49755351681957, 10.49755351681957, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304005, 88353.1672)
    ops.uniaxialMaterial('Elastic', 404005, 57381.49775)
    ...
    # Central joint node
    ops.node(4007, 0.0, 4.5, 11.5, '-mass', 10.538837920489295, 10.538837920489295, 10.538837920489295, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304007, 77991.9319)
    ops.uniaxialMaterial('Elastic', 404007, 77991.9319)
    ...
    # Central joint node
    ops.node(4008, 4.5, 4.5, 11.5, '-mass', 20.494801223241588, 20.494801223241588, 20.494801223241588, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304008, 144196.88575)
    ops.uniaxialMaterial('Elastic', 404008, 134385.3954)
    ...
    # Central joint node
    ops.node(4009, 9.0, 4.5, 11.5, '-mass', 17.263149847094798, 17.263149847094798, 17.263149847094798, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304009, 149364.1666)
    ops.uniaxialMaterial('Elastic', 404009, 124421.9989)
    ...
    # Central joint node
    ops.node(4010, 12.0, 4.5, 11.5, '-mass', 17.263149847094798, 17.263149847094798, 17.263149847094798, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304010, 149364.1666)
    ops.uniaxialMaterial('Elastic', 404010, 124421.9989)
    ...
    # Central joint node
    ops.node(4011, 16.5, 4.5, 11.5, '-mass', 20.494801223241588, 20.494801223241588, 20.494801223241588, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304011, 144196.88575)
    ops.uniaxialMaterial('Elastic', 404011, 134385.3954)
    ...
    # Central joint node
    ops.node(4012, 21.0, 4.5, 11.5, '-mass', 10.538837920489295, 10.538837920489295, 10.538837920489295, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304012, 77991.9319)
    ops.uniaxialMaterial('Elastic', 404012, 77991.9319)
    ...
    # Central joint node
    ops.node(4013, 0.0, 9.0, 11.5, '-mass', 10.538837920489295, 10.538837920489295, 10.538837920489295, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304013, 77991.9319)
    ops.uniaxialMaterial('Elastic', 404013, 77991.9319)
    ...
    # Central joint node
    ops.node(4018, 21.0, 9.0, 11.5, '-mass', 10.538837920489295, 10.538837920489295, 10.538837920489295, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304018, 77991.9319)
    ops.uniaxialMaterial('Elastic', 404018, 77991.9319)
