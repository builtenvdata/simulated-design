...
def do_nspa_x(max_drift: float = 0.1, dincr: float = 1e-05) -> tuple[list[float], list[float]]:
    ...
    ops.load(91000, 0.11064004938642946, 0, 0, 0, 0, 0)
    ops.load(92000, 0.2136519069763881, 0, 0, 0, 0, 0)
    ops.load(93000, 0.3353766682676308, 0, 0, 0, 0, 0)
    ops.load(94000, 0.3403313753695517, 0, 0, 0, 0, 0)
...
def do_nspa_y(max_drift: float = 0.1, dincr: float = 1e-05) -> tuple[list[float], list[float]]:
    ...
    ops.pattern('Plain', 2, 2)
    # Add lateral nspa loads to ops domain
    ops.load(91000, 0, 0.11082884373288489, 0, 0, 0, 0)
    ops.load(92000, 0, 0.21529786522183755, 0, 0, 0, 0)
    ops.load(93000, 0, 0.33672263035946215, 0, 0, 0, 0)
    ops.load(94000, 0, 0.3371506606858153, 0, 0, 0, 0)
