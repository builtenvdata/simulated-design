...
def add_columns() -> None:
    ...
    # Create materials describing flexural behaviour of plastic hinge
    ops.uniaxialMaterial('Hysteretic', 24063, 93.74337238, 0.00073171, 110.08606612, 0.01415046, 11.00860661, 0.03609521, -93.74337238, -0.00073171, -110.08606612, -0.01415046, -11.00860661, -0.03609521, 1.0, 1.0, 0.0, 0.0, 0.0)
    ops.uniaxialMaterial('Hysteretic', 14063, 93.74337238, 0.00073171, 110.08606612, 0.01415046, 11.00860661, 0.03609521, -93.74337238, -0.00073171, -110.08606612, -0.01415046, -11.00860661, -0.03609521, 1.0, 1.0, 0.0, 0.0, 0.0)
    # Create new materials describing shear behaviour of plastic hinge
    ops.limitCurve('ThreePoint', 24063, 4063, 0.0, 182.50170013, 0.01463419, 182.50170013, 0.04390258, 127.75119009, -5024.18595753, 0.05, 2, 0, 70003, 24025, 2, 3)
    ops.uniaxialMaterial('LimitState', 44063, 45.62542503, 8.349e-05, 136.8762751, 0.00025048, 456.25425032, 0.00083495, -45.62542503, -8.349e-05, -136.8762751, -0.00025048, -456.25425032, -0.00083495, 0.4, 0.3, 0.003, 0.0, 0.0, 24063, 2)
    ops.limitCurve('ThreePoint', 14063, 4063, 0.0, 182.50170013, 0.01463419, 182.50170013, 0.04390258, 127.75119009, -5024.18595753, 0.05, 2, 0, 70003, 24025, 1, 3)
    ops.uniaxialMaterial('LimitState', 34063, 45.62542503, 8.349e-05, 136.8762751, 0.00025048, 456.25425032, 0.00083495, -45.62542503, -8.349e-05, -136.8762751, -0.00025048, -456.25425032, -0.00083495, 0.4, 0.3, 0.003, 0.0, 0.0, 14063, 2)
    # Create plastic hinge sections at both ends
    ...
    # Create materials describing flexural behaviour of plastic hinge
    ops.uniaxialMaterial('Hysteretic', 24064, 84.90254643, 0.00067758, 99.66236902, 0.01368371, 9.9662369, 0.03395315, -84.90254643, -0.00067758, -99.66236902, -0.01368371, -9.9662369, -0.03395315, 1.0, 1.0, 0.0, 0.0, 0.0)
    ops.uniaxialMaterial('Hysteretic', 14064, 84.90254643, 0.00067758, 99.66236902, 0.01368371, 9.9662369, 0.03395315, -84.90254643, -0.00067758, -99.66236902, -0.01368371, -9.9662369, -0.03395315, 1.0, 1.0, 0.0, 0.0, 0.0)
    # Create new materials describing shear behaviour of plastic hinge
    ops.limitCurve('ThreePoint', 24064, 4064, 0.0, 174.51717064, 0.01355151, 174.51717064, 0.04065452, 122.16201945, -4874.50134598, 0.05, 2, 0, 74025, 21003, 2, 3)
    ops.uniaxialMaterial('LimitState', 44064, 43.62929266, 8.293e-05, 130.88787798, 0.00024879, 436.29292661, 0.0008293, -43.62929266, -8.293e-05, -130.88787798, -0.00024879, -436.29292661, -0.0008293, 0.4, 0.3, 0.003, 0.0, 0.0, 24064, 2)
    ops.limitCurve('ThreePoint', 14064, 4064, 0.0, 174.51717064, 0.01355151, 174.51717064, 0.04065452, 122.16201945, -4874.50134598, 0.05, 2, 0, 74025, 21003, 1, 3)
    ops.uniaxialMaterial('LimitState', 34064, 43.62929266, 8.293e-05, 130.88787798, 0.00024879, 436.29292661, 0.0008293, -43.62929266, -8.293e-05, -130.88787798, -0.00024879, -436.29292661, -0.0008293, 0.4, 0.3, 0.003, 0.0, 0.0, 14064, 2)
    # Create plastic hinge sections at both ends
    ...
    # Create materials describing flexural behaviour of plastic hinge
    ops.uniaxialMaterial('Hysteretic', 24065, 119.95888144, 0.0010121, 141.15641434, 0.01480879, 14.11564143, 0.0394254, -119.95888144, -0.0010121, -141.15641434, -0.01480879, -14.11564143, -0.0394254, 1.0, 1.0, 0.0, 0.0, 0.0)
    ops.uniaxialMaterial('Hysteretic', 14065, 119.95888144, 0.0010121, 141.15641434, 0.01480879, 14.11564143, 0.0394254, -119.95888144, -0.0010121, -141.15641434, -0.01480879, -14.11564143, -0.0394254, 1.0, 1.0, 0.0, 0.0, 0.0)
    # Create new materials describing shear behaviour of plastic hinge
    ops.limitCurve('ThreePoint', 24065, 4065, 0.0, 183.64035376, 0.0202421, 183.64035376, 0.0607263, 128.54824763, -4934.05458119, 0.05, 2, 0, 70004, 24026, 2, 3)
    ops.uniaxialMaterial('LimitState', 44065, 45.91008844, 8.171e-05, 137.73026532, 0.00024513, 459.1008844, 0.00081711, -45.91008844, -8.171e-05, -137.73026532, -0.00024513, -459.1008844, -0.00081711, 0.4, 0.3, 0.003, 0.0, 0.0, 24065, 2)
    ops.limitCurve('ThreePoint', 14065, 4065, 0.0, 183.64035376, 0.0202421, 183.64035376, 0.0607263, 128.54824763, -4934.05458119, 0.05, 2, 0, 70004, 24026, 1, 3)
    ops.uniaxialMaterial('LimitState', 34065, 45.91008844, 8.171e-05, 137.73026532, 0.00024513, 459.1008844, 0.00081711, -45.91008844, -8.171e-05, -137.73026532, -0.00024513, -459.1008844, -0.00081711, 0.4, 0.3, 0.003, 0.0, 0.0, 14065, 2)
    # Create plastic hinge sections at both ends
    ...
    # Create materials describing flexural behaviour of plastic hinge
    ops.uniaxialMaterial('Hysteretic', 24066, 114.76032074, 0.00101381, 135.23759794, 0.01470973, 13.52375979, 0.0395022, -114.76032074, -0.00101381, -135.23759794, -0.01470973, -13.52375979, -0.0395022, 1.0, 1.0, 0.0, 0.0, 0.0)
    ops.uniaxialMaterial('Hysteretic', 14066, 114.76032074, 0.00101381, 135.23759794, 0.01470973, 13.52375979, 0.0395022, -114.76032074, -0.00101381, -135.23759794, -0.01470973, -13.52375979, -0.0395022, 1.0, 1.0, 0.0, 0.0, 0.0)
    # Create new materials describing shear behaviour of plastic hinge
    ops.limitCurve('ThreePoint', 24066, 4066, 0.0, 177.00101187, 0.02027612, 177.00101187, 0.06082837, 123.90070831, -4757.14363585, 0.05, 2, 0, 74026, 21004, 2, 3)
    ops.uniaxialMaterial('LimitState', 44066, 44.25025297, 8.021e-05, 132.7507589, 0.00024064, 442.50252966, 0.00080214, -44.25025297, -8.021e-05, -132.7507589, -0.00024064, -442.50252966, -0.00080214, 0.4, 0.3, 0.003, 0.0, 0.0, 24066, 2)
    ops.limitCurve('ThreePoint', 14066, 4066, 0.0, 177.00101187, 0.02027612, 177.00101187, 0.06082837, 123.90070831, -4757.14363585, 0.05, 2, 0, 74026, 21004, 1, 3)
    ops.uniaxialMaterial('LimitState', 34066, 44.25025297, 8.021e-05, 132.7507589, 0.00024064, 442.50252966, 0.00080214, -44.25025297, -8.021e-05, -132.7507589, -0.00024064, -442.50252966, -0.00080214, 0.4, 0.3, 0.003, 0.0, 0.0, 14066, 2)
    # Create plastic hinge sections at both ends
    ...
    # Create materials describing flexural behaviour of plastic hinge
    ops.uniaxialMaterial('Hysteretic', 24068, 101.16327963, 0.00094183, 120.17932381, 0.01684088, 12.01793238, 0.04849337, -101.16327963, -0.00094183, -120.17932381, -0.01684088, -12.01793238, -0.04849337, 1.0, 1.0, 0.0, 0.0, 0.0)
    ops.uniaxialMaterial('Hysteretic', 14068, 101.16327963, 0.00094183, 120.17932381, 0.01684088, 12.01793238, 0.04849337, -101.16327963, -0.00094183, -120.17932381, -0.01684088, -12.01793238, -0.04849337, 1.0, 1.0, 0.0, 0.0, 0.0)
    # Create new materials describing shear behaviour of plastic hinge
    ops.limitCurve('ThreePoint', 24068, 4068, 0.0, 180.3076845, 0.0188365, 180.3076845, 0.05650951, 126.21537915, -5115.92862614, 0.05, 2, 0, 71003, 24027, 2, 3)
    ops.uniaxialMaterial('LimitState', 44068, 45.07692113, 7.365e-05, 135.23076338, 0.00022096, 450.76921126, 0.00073654, -45.07692113, -7.365e-05, -135.23076338, -0.00022096, -450.76921126, -0.00073654, 0.4, 0.3, 0.003, 0.0, 0.0, 24068, 2)
    ops.limitCurve('ThreePoint', 14068, 4068, 0.0, 180.3076845, 0.0188365, 180.3076845, 0.05650951, 126.21537915, -5115.92862614, 0.05, 2, 0, 71003, 24027, 1, 3)
    ops.uniaxialMaterial('LimitState', 34068, 45.07692113, 7.365e-05, 135.23076338, 0.00022096, 450.76921126, 0.00073654, -45.07692113, -7.365e-05, -135.23076338, -0.00022096, -450.76921126, -0.00073654, 0.4, 0.3, 0.003, 0.0, 0.0, 14068, 2)
    # Create plastic hinge sections at both ends
    ...
    # Create materials describing flexural behaviour of plastic hinge
    ops.uniaxialMaterial('Hysteretic', 24069, 97.46709397, 0.00093533, 116.17205626, 0.01807843, 11.61720563, 0.05500445, -97.46709397, -0.00093533, -116.17205626, -0.01807843, -11.61720563, -0.05500445, 1.0, 1.0, 0.0, 0.0, 0.0)
    ops.uniaxialMaterial('Hysteretic', 14069, 97.46709397, 0.00093533, 116.17205626, 0.01807843, 11.61720563, 0.05500445, -97.46709397, -0.00093533, -116.17205626, -0.01807843, -11.61720563, -0.05500445, 1.0, 1.0, 0.0, 0.0, 0.0)
    # Create new materials describing shear behaviour of plastic hinge
    ops.limitCurve('ThreePoint', 24069, 4069, 0.0, 181.60613026, 0.01870661, 181.60613026, 0.05611983, 127.12429118, -5161.89020653, 0.05, 2, 0, 74027, 22003, 2, 3)
    ops.uniaxialMaterial('LimitState', 44069, 45.40153257, 7.22e-05, 136.2045977, 0.00021659, 454.01532565, 0.00072198, -45.40153257, -7.22e-05, -136.2045977, -0.00021659, -454.01532565, -0.00072198, 0.4, 0.3, 0.003, 0.0, 0.0, 24069, 2)
    ops.limitCurve('ThreePoint', 14069, 4069, 0.0, 181.60613026, 0.01870661, 181.60613026, 0.05611983, 127.12429118, -5161.89020653, 0.05, 2, 0, 74027, 22003, 1, 3)
    ops.uniaxialMaterial('LimitState', 34069, 45.40153257, 7.22e-05, 136.2045977, 0.00021659, 454.01532565, 0.00072198, -45.40153257, -7.22e-05, -136.2045977, -0.00021659, -454.01532565, -0.00072198, 0.4, 0.3, 0.003, 0.0, 0.0, 14069, 2)
    # Create plastic hinge sections at both ends
    ...
    # Create materials describing flexural behaviour of plastic hinge
    ops.uniaxialMaterial('Hysteretic', 24070, 101.03391756, 0.00094113, 120.00226953, 0.01708533, 12.00022695, 0.04825966, -101.03391756, -0.00094113, -120.00226953, -0.01708533, -12.00022695, -0.04825966, 1.0, 1.0, 0.0, 0.0, 0.0)
    ops.uniaxialMaterial('Hysteretic', 14070, 101.03391756, 0.00094113, 120.00226953, 0.01708533, 12.00022695, 0.04825966, -101.03391756, -0.00094113, -120.00226953, -0.01708533, -12.00022695, -0.04825966, 1.0, 1.0, 0.0, 0.0, 0.0)
    # Create new materials describing shear behaviour of plastic hinge
    ops.limitCurve('ThreePoint', 24070, 4070, 0.0, 182.2764141, 0.01882258, 182.2764141, 0.05646774, 127.59348987, -5265.81100969, 0.05, 2, 0, 71004, 24028, 2, 3)
    ops.uniaxialMaterial('LimitState', 44070, 45.56910352, 7.482e-05, 136.70731057, 0.00022446, 455.69103525, 0.00074822, -45.56910352, -7.482e-05, -136.70731057, -0.00022446, -455.69103525, -0.00074822, 0.4, 0.3, 0.003, 0.0, 0.0, 24070, 2)
    ops.limitCurve('ThreePoint', 14070, 4070, 0.0, 182.2764141, 0.01882258, 182.2764141, 0.05646774, 127.59348987, -5265.81100969, 0.05, 2, 0, 71004, 24028, 1, 3)
    ops.uniaxialMaterial('LimitState', 34070, 45.56910352, 7.482e-05, 136.70731057, 0.00022446, 455.69103525, 0.00074822, -45.56910352, -7.482e-05, -136.70731057, -0.00022446, -455.69103525, -0.00074822, 0.4, 0.3, 0.003, 0.0, 0.0, 14070, 2)
    # Create plastic hinge sections at both ends
    ...
    # Create materials describing flexural behaviour of plastic hinge
    ops.uniaxialMaterial('Hysteretic', 24071, 96.83344047, 0.0009322, 115.42859881, 0.01850489, 11.54285988, 0.05617011, -96.83344047, -0.0009322, -115.42859881, -0.01850489, -11.54285988, -0.05617011, 1.0, 1.0, 0.0, 0.0, 0.0)
    ops.uniaxialMaterial('Hysteretic', 14071, 96.83344047, 0.0009322, 115.42859881, 0.01850489, 11.54285988, 0.05617011, -96.83344047, -0.0009322, -115.42859881, -0.01850489, -11.54285988, -0.05617011, 1.0, 1.0, 0.0, 0.0, 0.0)
    # Create new materials describing shear behaviour of plastic hinge
    ops.limitCurve('ThreePoint', 24071, 4071, 0.0, 184.07665529, 0.01864394, 184.07665529, 0.05593183, 128.85365871, -5260.44615845, 0.05, 2, 0, 74028, 22004, 2, 3)
    ops.uniaxialMaterial('LimitState', 44071, 46.01916382, 7.261e-05, 138.05749147, 0.00021784, 460.19163823, 0.00072615, -46.01916382, -7.261e-05, -138.05749147, -0.00021784, -460.19163823, -0.00072615, 0.4, 0.3, 0.003, 0.0, 0.0, 24071, 2)
    ops.limitCurve('ThreePoint', 14071, 4071, 0.0, 184.07665529, 0.01864394, 184.07665529, 0.05593183, 128.85365871, -5260.44615845, 0.05, 2, 0, 74028, 22004, 1, 3)
    ops.uniaxialMaterial('LimitState', 34071, 46.01916382, 7.261e-05, 138.05749147, 0.00021784, 460.19163823, 0.00072615, -46.01916382, -7.261e-05, -138.05749147, -0.00021784, -460.19163823, -0.00072615, 0.4, 0.3, 0.003, 0.0, 0.0, 14071, 2)
    # Create plastic hinge sections at both ends
    ...
    # Create materials describing flexural behaviour of plastic hinge
    ops.uniaxialMaterial('Hysteretic', 24073, 66.1431262, 0.00111765, 78.71194358, 0.01896012, 7.87119436, 0.05834873, -66.1431262, -0.00111765, -78.71194358, -0.01896012, -7.87119436, -0.05834873, 1.0, 1.0, 0.0, 0.0, 0.0)
    ops.uniaxialMaterial('Hysteretic', 14073, 66.1431262, 0.00111765, 78.71194358, 0.01896012, 7.87119436, 0.05834873, -66.1431262, -0.00111765, -78.71194358, -0.01896012, -7.87119436, -0.05834873, 1.0, 1.0, 0.0, 0.0, 0.0)
    # Create new materials describing shear behaviour of plastic hinge
    ops.limitCurve('ThreePoint', 24073, 4073, 0.0, 122.58273091, 0.02235307, 122.58273091, 0.06705922, 85.80791164, -4172.03616359, 0.05, 2, 0, 72003, 24029, 2, 3)
    ops.uniaxialMaterial('LimitState', 44073, 30.64568273, 7.165e-05, 91.93704818, 0.00021495, 306.45682728, 0.0007165, -30.64568273, -7.165e-05, -91.93704818, -0.00021495, -306.45682728, -0.0007165, 0.4, 0.3, 0.003, 0.0, 0.0, 24073, 2)
    ops.limitCurve('ThreePoint', 14073, 4073, 0.0, 122.58273091, 0.02235307, 122.58273091, 0.06705922, 85.80791164, -4172.03616359, 0.05, 2, 0, 72003, 24029, 1, 3)
    ops.uniaxialMaterial('LimitState', 34073, 30.64568273, 7.165e-05, 91.93704818, 0.00021495, 306.45682728, 0.0007165, -30.64568273, -7.165e-05, -91.93704818, -0.00021495, -306.45682728, -0.0007165, 0.4, 0.3, 0.003, 0.0, 0.0, 14073, 2)
    # Create plastic hinge sections at both ends
    ...
    # Create materials describing flexural behaviour of plastic hinge
    ops.uniaxialMaterial('Hysteretic', 24075, 65.21338107, 0.00112905, 77.62933585, 0.01975816, 7.76293358, 0.06043588, -65.21338107, -0.00112905, -77.62933585, -0.01975816, -7.76293358, -0.06043588, 1.0, 1.0, 0.0, 0.0, 0.0)
    ops.uniaxialMaterial('Hysteretic', 14075, 65.21338107, 0.00112905, 77.62933585, 0.01975816, 7.76293358, 0.06043588, -65.21338107, -0.00112905, -77.62933585, -0.01975816, -7.76293358, -0.06043588, 1.0, 1.0, 0.0, 0.0, 0.0)
    # Create new materials describing shear behaviour of plastic hinge
    ops.limitCurve('ThreePoint', 24075, 4075, 0.0, 124.82093797, 0.02258101, 124.82093797, 0.06774302, 87.37465658, -4270.92350845, 0.05, 2, 0, 72004, 24030, 2, 3)
    ops.uniaxialMaterial('LimitState', 44075, 31.20523449, 7.214e-05, 93.61570347, 0.00021641, 312.05234492, 0.00072135, -31.20523449, -7.214e-05, -93.61570347, -0.00021641, -312.05234492, -0.00072135, 0.4, 0.3, 0.003, 0.0, 0.0, 24075, 2)
    ops.limitCurve('ThreePoint', 14075, 4075, 0.0, 124.82093797, 0.02258101, 124.82093797, 0.06774302, 87.37465658, -4270.92350845, 0.05, 2, 0, 72004, 24030, 1, 3)
    ops.uniaxialMaterial('LimitState', 34075, 31.20523449, 7.214e-05, 93.61570347, 0.00021641, 312.05234492, 0.00072135, -31.20523449, -7.214e-05, -93.61570347, -0.00021641, -312.05234492, -0.00072135, 0.4, 0.3, 0.003, 0.0, 0.0, 14075, 2)
    # Create plastic hinge sections at both ends
