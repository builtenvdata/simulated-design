...
def add_floors() -> None:
    ...
    # Retained floor node
    ops.node(91000, 10.49347538, 6.88225871, 3.1)
    ...
    # Retained floor node
    ops.node(92000, 10.49633372, 6.8575921, 5.9)
    # Rigid floor diaphragm - multi-point constraints
    ...
    # Retained floor node
    ops.node(93000, 10.49902739, 6.87117287, 8.7)
    # Rigid floor diaphragm - multi-point constraints
    ...
    # Retained floor node
    ops.node(94000, 10.4993337, 6.92064823, 11.5)
    # Rigid floor diaphragm - multi-point constraints
