...
def add_foundations() -> None:
    ...
    # Foundation node
    ops.node(70019, 0.0, 13.5, 0.0, '-mass', 0.6320081549439349, 0.6320081549439349, 0.6320081549439349, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70008, 4.5, 4.5, 0.0, '-mass', 1.668896534148828, 1.668896534148828, 1.668896534148828, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70014, 4.5, 9.0, 0.0, '-mass', 1.668896534148828, 1.668896534148828, 1.668896534148828, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70011, 16.5, 4.5, 0.0, '-mass', 1.668896534148828, 1.668896534148828, 1.668896534148828, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70017, 16.5, 9.0, 0.0, '-mass', 1.668896534148828, 1.668896534148828, 1.668896534148828, 0.0, 0.0, 0.0)
