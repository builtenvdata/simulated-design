...
def add_floors() -> None:
    ...
    # Retained floor node
    ops.node(91000, 10.49289977, 6.85862266, 3.1)
    ...
    # Retained floor node
    ops.node(92000, 10.47235007, 6.86229033, 5.9)
    # Rigid floor diaphragm - multi-point constraints
    ...
    # Retained floor node
    ops.node(93000, 10.49947075, 6.86888031, 8.7)
    # Rigid floor diaphragm - multi-point constraints
    ...
    # Retained floor node
    ops.node(94000, 10.49962935, 6.92664565, 11.5)
    # Rigid floor diaphragm - multi-point constraints
