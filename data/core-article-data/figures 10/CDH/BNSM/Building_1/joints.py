...
def add_joints() -> None:
    ...
    # Central joint node
    ops.node(4025, 9.0, 0.0, 1.55, '-mass', 3.5935907237512743, 3.5935907237512743, 3.5935907237512743, 0.0, 0.0, 0.0)
    ...
    # Central joint node
    ops.node(4026, 12.0, 0.0, 1.55, '-mass', 3.5935907237512743, 3.5935907237512743, 3.5935907237512743, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4027, 9.0, 0.0, 4.5, '-mass', 3.5467635066258922, 3.5467635066258922, 3.5467635066258922, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4028, 12.0, 0.0, 4.5, '-mass', 3.5467635066258922, 3.5467635066258922, 3.5467635066258922, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4029, 9.0, 0.0, 7.3, '-mass', 3.5467635066258913, 3.5467635066258913, 3.5467635066258913, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4030, 12.0, 0.0, 7.3, '-mass', 3.5467635066258913, 3.5467635066258913, 3.5467635066258913, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4031, 9.0, 0.0, 10.1, '-mass', 3.5467635066258922, 3.5467635066258922, 3.5467635066258922, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4032, 12.0, 0.0, 10.1, '-mass', 3.5467635066258922, 3.5467635066258922, 3.5467635066258922, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1001, 0.0, 0.0, 3.1, '-mass', 9.949827981651374, 9.949827981651374, 9.949827981651374, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1002, 4.5, 0.0, 3.1, '-mass', 15.682976554536186, 15.682976554536186, 15.682976554536186, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1003, 9.0, 0.0, 3.1, '-mass', 10.115953109072374, 10.115953109072374, 10.115953109072374, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1004, 12.0, 0.0, 3.1, '-mass', 10.115953109072374, 10.115953109072374, 10.115953109072374, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1005, 16.5, 0.0, 3.1, '-mass', 15.682976554536186, 15.682976554536186, 15.682976554536186, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1006, 21.0, 0.0, 3.1, '-mass', 9.949827981651374, 9.949827981651374, 9.949827981651374, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1007, 0.0, 4.5, 3.1, '-mass', 15.682976554536186, 15.682976554536186, 15.682976554536186, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1009, 9.0, 4.5, 3.1, '-mass', 20.990061162079506, 20.990061162079506, 20.990061162079506, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1010, 12.0, 4.5, 3.1, '-mass', 20.990061162079506, 20.990061162079506, 20.990061162079506, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1012, 21.0, 4.5, 3.1, '-mass', 15.682976554536186, 15.682976554536186, 15.682976554536186, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1013, 0.0, 9.0, 3.1, '-mass', 15.682976554536186, 15.682976554536186, 15.682976554536186, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1015, 9.0, 9.0, 3.1, '-mass', 20.737767584097856, 20.737767584097856, 20.737767584097856, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1016, 12.0, 9.0, 3.1, '-mass', 20.737767584097856, 20.737767584097856, 20.737767584097856, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1018, 21.0, 9.0, 3.1, '-mass', 15.682976554536186, 15.682976554536186, 15.682976554536186, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1019, 0.0, 13.5, 3.1, '-mass', 9.949827981651374, 9.949827981651374, 9.949827981651374, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1020, 4.5, 13.5, 3.1, '-mass', 15.682976554536186, 15.682976554536186, 15.682976554536186, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1021, 9.0, 13.5, 3.1, '-mass', 13.682307594291538, 13.682307594291538, 13.682307594291538, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1022, 12.0, 13.5, 3.1, '-mass', 13.682307594291538, 13.682307594291538, 13.682307594291538, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1023, 16.5, 13.5, 3.1, '-mass', 15.682976554536186, 15.682976554536186, 15.682976554536186, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1024, 21.0, 13.5, 3.1, '-mass', 9.949827981651374, 9.949827981651374, 9.949827981651374, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2001, 0.0, 0.0, 5.9, '-mass', 9.915424311926603, 9.915424311926603, 9.915424311926603, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2002, 4.5, 0.0, 5.9, '-mass', 15.636149337410803, 15.636149337410803, 15.636149337410803, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2003, 9.0, 0.0, 5.9, '-mass', 10.092539500509682, 10.092539500509682, 10.092539500509682, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2004, 12.0, 0.0, 5.9, '-mass', 10.092539500509682, 10.092539500509682, 10.092539500509682, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2005, 16.5, 0.0, 5.9, '-mass', 15.636149337410803, 15.636149337410803, 15.636149337410803, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(
 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54008, 4.275, 4.5, 11.5)
    ops.element('elasticBeamColumn', 54008, 54008, 4008, 99999, 88888)
    ops.node(34008, 4.725, 4.5, 11.5)
    ...
    ops.node(64008, 4.5, 4.275, 11.5)
    ops.element('elasticBeamColumn', 64008, 64008, 4008, 99999, 77777)
    ops.node(44008, 4.5, 4.725, 11.5)
    ...
    # Central joint node
    ops.node(4009, 9.0, 4.5, 11.5, '-mass', 17.311735474006113, 17.311735474006113, 17.311735474006113, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54009, 8.775, 4.5, 11.5)
    ops.element('elasticBeamColumn', 54009, 54009, 4009, 99999, 88888)
    ops.node(34009, 9.225, 4.5, 11.5)
    ...
    ops.node(64009, 9.0, 4.275, 11.5)
    ops.element('elasticBeamColumn', 64009, 64009, 4009, 99999, 77777)
    ops.node(44009, 9.0, 4.725, 11.5)
    ...
    # Central joint node
    ops.node(4010, 12.0, 4.5, 11.5, '-mass', 17.311735474006113, 17.311735474006113, 17.311735474006113, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54010, 11.775, 4.5, 11.5)
    ops.element('elasticBeamColumn', 54010, 54010, 4010, 99999, 88888)
    ops.node(34010, 12.225, 4.5, 11.5)
    ...
    ops.node(64010, 12.0, 4.275, 11.5)
    ops.element('elasticBeamColumn', 64010, 64010, 4010, 99999, 77777)
    ops.node(44010, 12.0, 4.725, 11.5)
    ...
    # Central joint node
    ops.node(4011, 16.5, 4.5, 11.5, '-mass', 20.819954128440365, 20.819954128440365, 20.819954128440365, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54011, 16.275, 4.5, 11.5)
    ops.element('elasticBeamColumn', 54011, 54011, 4011, 99999, 88888)
    ops.node(34011, 16.725, 4.5, 11.5)
    ...
    ops.node(64011, 16.5, 4.275, 11.5)
    ops.element('elasticBeamColumn', 64011, 64011, 4011, 99999, 77777)
    ops.node(44011, 16.5, 4.725, 11.5)
    ...
    # Central joint node
    ops.node(4014, 4.5, 9.0, 11.5, '-mass', 20.819954128440365, 20.819954128440365, 20.819954128440365, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54014, 4.275, 9.0, 11.5)
    ops.element('elasticBeamColumn', 54014, 54014, 4014, 99999, 88888)
    ops.node(34014, 4.725, 9.0, 11.5)
    ...
    ops.node(64014, 4.5, 8.775, 11.5)
    ops.element('elasticBeamColumn', 64014, 64014, 4014, 99999, 77777)
    ops.node(44014, 4.5, 9.225, 11.5)
    ...
    # Central joint node
    ops.node(4015, 9.0, 9.0, 11.5, '-mass', 18.32090978593272, 18.32090978593272, 18.32090978593272, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54015, 8.775, 9.0, 11.5)
    ops.element('elasticBeamColumn', 54015, 54015, 4015, 99999, 88888)
    ops.node(34015, 9.225, 9.0, 11.5)
    ...
    ops.node(64015, 9.0, 8.775, 11.5)
    ops.element('elasticBeamColumn', 64015, 64015, 4015, 99999, 77777)
    ops.node(44015, 9.0, 9.225, 11.5)
    ...
    # Central joint node
    ops.node(4016, 12.0, 9.0, 11.5, '-mass', 18.32090978593272, 18.32090978593272, 18.32090978593272, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54016, 11.775, 9.0, 11.5)
    ops.element('elasticBeamColumn', 54016, 54016, 4016, 99999, 88888)
    ops.node(34016, 12.225, 9.0, 11.5)
    ...
    ops.node(64016, 12.0, 8.775, 11.5)
    ops.element('elasticBeamColumn', 64016, 64016, 4016, 99999, 77777)
    ops.node(44016, 12.0, 9.225, 11.5)
    ...
    # Central joint node
    ops.node(4017, 16.5, 9.0, 11.5, '-mass', 20.819954128440365, 20.819954128440365, 20.819954128440365, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54017, 16.275, 9.0, 11.5)
    ops.element('elasticBeamColumn', 54017, 54017, 4017, 99999, 88888)
    ops.node(34017, 16.725, 9.0, 11.5)
    ...
    ops.node(64017, 16.5, 8.775, 11.5)
    ops.element('elasticBeamColumn', 64017, 64017, 4017, 99999, 77777)
    ops.node(44017, 16.5, 9.225, 11.5)
