...
def add_floors() -> None:
    ...
    # Retained floor node
    ops.node(91000, 10.50105662, 6.85419199, 3.1)
    ...
    # Retained floor node
    ops.node(92000, 10.50101215, 6.85484384, 5.9)
    # Rigid floor diaphragm - multi-point constraints
    ...
    # Retained floor node
    ops.node(93000, 10.50102274, 6.85977694, 8.7)
    # Rigid floor diaphragm - multi-point constraints
    ...
    # Retained floor node
    ops.node(94000, 10.50066836, 6.91716741, 11.5)
    # Rigid floor diaphragm - multi-point constraints
