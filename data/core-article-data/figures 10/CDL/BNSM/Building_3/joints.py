...
def add_joints() -> None:
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301003, 115809.0563)
    ops.uniaxialMaterial('Elastic', 401003, 142374.9246)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301004, 115809.0563)
    ops.uniaxialMaterial('Elastic', 401004, 142374.9246)
    ...
    # Central joint node
    ops.node(1007, 0.0, 4.5, 3.1, '-mass', 16.028593272171253, 16.028593272171253, 16.028593272171253, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301007, 174382.69505)
    ops.uniaxialMaterial('Elastic', 401007, 122096.35145)
    ...
    # Central joint node
    ops.node(1008, 4.5, 4.5, 3.1, '-mass', 24.02905198776758, 24.02905198776758, 24.02905198776758, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301008, 254410.80305)
    ops.uniaxialMaterial('Elastic', 401008, 254410.80305)
    ...
    # Central joint node
    ops.node(1009, 9.0, 4.5, 3.1, '-mass', 21.25504587155963, 21.25504587155963, 21.25504587155963, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301009, 213790.6961)
    ops.uniaxialMaterial('Elastic', 401009, 213790.6961)
    ...
    # Central joint node
    ops.node(1010, 12.0, 4.5, 3.1, '-mass', 21.25504587155963, 21.25504587155963, 21.25504587155963, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301010, 213790.6961)
    ops.uniaxialMaterial('Elastic', 401010, 213790.6961)
    ...
    # Central joint node
    ops.node(1011, 16.5, 4.5, 3.1, '-mass', 24.02905198776758, 24.02905198776758, 24.02905198776758, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301011, 254410.80305)
    ops.uniaxialMaterial('Elastic', 401011, 254410.80305)
    ...
    # Central joint node
    ops.node(1012, 21.0, 4.5, 3.1, '-mass', 16.028593272171253, 16.028593272171253, 16.028593272171253, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301012, 174382.69505)
    ops.uniaxialMaterial('Elastic', 401012, 122096.35145)
    ...
    # Central joint node
    ops.node(1013, 0.0, 9.0, 3.1, '-mass', 16.028593272171253, 16.028593272171253, 16.028593272171253, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301013, 174382.69505)
    ops.uniaxialMaterial('Elastic', 401013, 122096.35145)
    ...
    # Central joint node
    ops.node(1014, 4.5, 9.0, 3.1, '-mass', 24.02905198776758, 24.02905198776758, 24.02905198776758, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301014, 254410.80305)
    ops.uniaxialMaterial('Elastic', 401014, 254410.80305)
    ...
    # Central joint node
    ops.node(1015, 9.0, 9.0, 3.1, '-mass', 20.96834862385321, 20.96834862385321, 20.96834862385321, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301015, 214085.91985)
    ops.uniaxialMaterial('Elastic', 401015, 214085.91985)
    ...
    # Central joint node
    ops.node(1016, 12.0, 9.0, 3.1, '-mass', 20.96834862385321, 20.96834862385321, 20.96834862385321, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301016, 214085.91985)
    ops.uniaxialMaterial('Elastic', 401016, 214085.91985)
    ...
    # Central joint node
    ops.node(1017, 16.5, 9.0, 3.1, '-mass', 24.02905198776758, 24.02905198776758, 24.02905198776758, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301017, 254410.80305)
    ops.uniaxialMaterial('Elastic', 401017, 254410.80305)
    ...
    # Central joint node
    ops.node(1018, 21.0, 9.0, 3.1, '-mass', 16.028593272171253, 16.028593272171253, 16.028593272171253, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301018, 174382.69505)
    ops.uniaxialMaterial('Elastic', 401018, 122096.35145)
    ...
    # Central joint node
    ops.node(2013, 0.0, 9.0, 5.9, '-mass', 15.772629969418958, 15.772629969418958, 15.772629969418958, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302013, 150443.89645)
    ops.uniaxialMaterial('Elastic', 402013, 93310.8437)
    ...
    # Central joint node
    ops.node(2014, 4.5, 9.0, 5.9, '-mass', 23.4914373088685, 23.4914373088685, 23.4914373088685, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302014, 221696.4482)
    ops.uniaxialMaterial('Elastic', 402014, 196208.8664)
    ...
    # Central joint node
    ops.node(2015, 9.0, 9.0, 5.9, '-mass', 20.505351681957183, 20.505351681957183, 20.505351681957183, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302015, 186603.6471)
    ops.uniaxialMaterial('Elastic', 402015, 165150.5487)
    ...
    # Central joint node
    ops.node(2016, 12.0, 9.0, 5.9, '-mass', 20.505351681957183, 20.505351681957183, 20.505351681957183, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302016, 186603.6471)
    ops.uniaxialMaterial('Elastic', 402016, 165150.5487)
    ...
    # Central joint node
    ops.node(2017, 16.5, 9.0, 5.9, '-mass', 23.4914373088685, 23.4914373088685, 23.4914373088685, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302017, 221696.4482)
    ops.uniaxialMaterial('Elastic', 402017, 196208.8664)
    ...
    # Central joint node
    ops.node(2018, 21.0, 9.0, 5.9, '-mass', 15.772629969418958, 15.772629969418958, 15.772629969418958, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302018, 150443.89645)
    ops.uniaxialMaterial('Elastic', 402018, 93310.8437)
