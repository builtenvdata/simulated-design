...
def add_joints() -> None:
    ...
    # Central joint node
    ops.node(4025, 9.0, 0.0, 1.55, '-mass', 3.5129969418960245, 3.5129969418960245, 3.5129969418960245, 0.0, 0.0, 0.0)
    ...
    # Central joint node
    ops.node(4026, 12.0, 0.0, 1.55, '-mass', 3.5129969418960245, 3.5129969418960245, 3.5129969418960245, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4027, 9.0, 0.0, 4.5, '-mass', 3.4785932721712536, 3.4785932721712536, 3.4785932721712536, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4028, 12.0, 0.0, 4.5, '-mass', 3.4785932721712536, 3.4785932721712536, 3.4785932721712536, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4029, 9.0, 0.0, 7.3, '-mass', 3.3804791029561665, 3.3804791029561665, 3.3804791029561665, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4030, 12.0, 0.0, 7.3, '-mass', 3.3804791029561665, 3.3804791029561665, 3.3804791029561665, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
