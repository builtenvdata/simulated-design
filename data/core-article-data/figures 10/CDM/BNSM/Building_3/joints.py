...
def add_joints() -> None:
    ...
    # Central joint node
    ops.node(4025, 9.0, 0.0, 1.55, '-mass', 3.880287971457696, 3.880287971457696, 3.880287971457696, 0.0, 0.0, 0.0)
    ...
    # Central joint node
    ops.node(4026, 12.0, 0.0, 1.55, '-mass', 3.880287971457696, 3.880287971457696, 3.880287971457696, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4027, 9.0, 0.0, 4.5, '-mass', 3.833460754332314, 3.833460754332314, 3.833460754332314, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4028, 12.0, 0.0, 4.5, '-mass', 3.833460754332314, 3.833460754332314, 3.833460754332314, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4029, 9.0, 0.0, 7.3, '-mass', 3.574159021406728, 3.574159021406728, 3.574159021406728, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34029, 9.15, 0.0, 7.3)
    ops.element('elasticBeamColumn', 34029, 4029, 34029, 99999, 88888)
    ops.node(24029, 9.0, 0.0, 7.075)
    ops.element('elasticBeamColumn', 24029, 24029, 4029, 99999, 99999)
    ops.node(74029, 9.0, 0.0, 7.525)
    ops.element('elasticBeamColumn', 74029, 4029, 74029, 99999, 99999)

    # Joint grid ids (x, y, z): (3, 0, 2.5)
    # Central joint node
    ops.node(4030, 12.0, 0.0, 7.3, '-mass', 3.574159021406728, 3.574159021406728, 3.574159021406728, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54030, 11.85, 0.0, 7.3)
    ops.element('elasticBeamColumn', 54030, 54030, 4030, 99999, 88888)
    ops.node(24030, 12.0, 0.0, 7.075)
    ops.element('elasticBeamColumn', 24030, 24030, 4030, 99999, 99999)
    ops.node(74030, 12.0, 0.0, 7.525)
    ops.element('elasticBeamColumn', 74030, 4030, 74030, 99999, 99999)

    # Joint grid ids (x, y, z): (2, 0, 3.5)
    # Central joint node
    ops.node(4031, 9.0, 0.0, 10.1, '-mass', 3.4785932721712536, 3.4785932721712536, 3.4785932721712536, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34031, 9.15, 0.0, 10.1)
    ...
    # Central joint node
    ops.node(4032, 12.0, 0.0, 10.1, '-mass', 3.4785932721712536, 3.4785932721712536, 3.4785932721712536, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54032, 11.85, 0.0, 10.1)
    ...
    # Central joint node
    ops.node(1001, 0.0, 0.0, 3.1, '-mass', 10.093176605504587, 10.093176605504587, 10.093176605504587, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1002, 4.5, 0.0, 3.1, '-mass', 16.199031600407746, 16.199031600407746, 16.199031600407746, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1003, 9.0, 0.0, 3.1, '-mass', 10.52210754332314, 10.52210754332314, 10.52210754332314, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1004, 12.0, 0.0, 3.1, '-mass', 10.52210754332314, 10.52210754332314, 10.52210754332314, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1005, 16.5, 0.0, 3.1, '-mass', 16.199031600407746, 16.199031600407746, 16.199031600407746, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1006, 21.0, 0.0, 3.1, '-mass', 10.093176605504587, 10.093176605504587, 10.093176605504587, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1007, 0.0, 4.5, 3.1, '-mass', 16.11302242609582, 16.11302242609582, 16.11302242609582, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1008, 4.5, 4.5, 3.1, '-mass', 24.79644495412844, 24.79644495412844, 24.79644495412844, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1009, 9.0, 4.5, 3.1, '-mass', 21.72177624872579, 21.72177624872579, 21.72177624872579, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(
 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2017, 16.5, 9.0, 5.9, '-mass', 24.108690112130475, 24.108690112130475, 24.108690112130475, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2018, 21.0, 9.0, 5.9, '-mass', 15.806893476044852, 15.806893476044852, 15.806893476044852, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2019, 0.0, 13.5, 5.9, '-mass', 10.058772935779816, 10.058772935779816, 10.058772935779816, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2020, 4.5, 13.5, 5.9, '-mass', 15.950242099898063, 15.950242099898063, 15.950242099898063, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2021, 9.0, 13.5, 5.9, '-mass', 13.925681702344546, 13.925681702344546, 13.925681702344546, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2022, 12.0, 13.5, 5.9, '-mass', 13.925681702344546, 13.925681702344546, 13.925681702344546, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2023, 16.5, 13.5, 5.9, '-mass', 15.950242099898063, 15.950242099898063, 15.950242099898063, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2024, 21.0, 13.5, 5.9, '-mass', 10.058772935779816, 10.058772935779816, 10.058772935779816, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3002, 4.5, 0.0, 8.7, '-mass', 15.547591743119266, 15.547591743119266, 15.547591743119266, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53002, 4.35, 0.0, 8.7)
    ops.element('elasticBeamColumn', 53002, 53002, 3002, 99999, 88888)
    ops.node(33002, 4.65, 0.0, 8.7)
    ...
    # Central joint node
    ops.node(3003, 9.0, 0.0, 8.7, '-mass', 10.048260703363914, 10.048260703363914, 10.048260703363914, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53003, 8.85, 0.0, 8.7)
    ops.element('elasticBeamColumn', 53003, 53003, 3003, 99999, 88888)
    ops.node(33003, 9.15, 0.0, 8.7)
    ...
    # Central joint node
    ops.node(3004, 12.0, 0.0, 8.7, '-mass', 10.048260703363914, 10.048260703363914, 10.048260703363914, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53004, 11.85, 0.0, 8.7)
    ops.element('elasticBeamColumn', 53004, 53004, 3004, 99999, 88888)
    ops.node(33004, 12.15, 0.0, 8.7)
    ...
    # Central joint node
    ops.node(3005, 16.5, 0.0, 8.7, '-mass', 15.547591743119266, 15.547591743119266, 15.547591743119266, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53005, 16.35, 0.0, 8.7)
    ops.element('elasticBeamColumn', 53005, 53005, 3005, 99999, 88888)
    ops.node(33005, 16.65, 0.0, 8.7)
    ...
    # Central joint node
    ops.node(3007, 0.0, 4.5, 8.7, '-mass', 15.47591743119266, 15.47591743119266, 15.47591743119266, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33007, 0.15, 4.5, 8.7)
    ...
    # Central joint node
    ops.node(3008, 4.5, 4.5, 8.7, '-mass', 23.52701325178389, 23.52701325178389, 23.52701325178389, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3009, 9.0, 4.5, 8.7, '-mass', 20.604612640163097, 20.604612640163097, 20.604612640163097, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3010, 12.0, 4.5, 8.7, '-mass', 20.604612640163097, 20.604612640163097, 20.604612640163097, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3011, 16.5, 4.5, 8.7, '-mass', 23.52701325178389, 23.52701325178389, 23.52701325178389, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3012, 21.0, 4.5, 8.7, '-mass', 15.47591743119266, 15.47591743119266, 15.47591743119266, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53012, 20.85, 4.5, 8.7)
    ...
    # Central joint node
    ops.node(3013, 0.0, 9.0, 8.7, '-mass', 15.47591743119266, 15.47591743119266, 15.47591743119266, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33013, 0.15, 9.0, 8.7)
    ...
    # Central joint node
    ops.node(3014, 4.5, 9.0, 8.7, '-mass', 23.52701325178389, 23.52701325178389, 23.52701325178389, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3015, 9.0, 9.0, 8.7, '-mass', 20.352319062181447, 20.352319062181447, 20.352319062181447, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3016, 12.0, 9.0, 8.7, '-mass', 20.352319062181447, 20.352319062181447, 20.352319062181447, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3017, 16.5, 9.0, 8.7, '-mass', 23.52701325178389, 23.52701325178389, 23.52701325178389, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3018, 21.0, 9.0, 8.7, '-mass', 15.47591743119266, 15.47591743119266, 15.47591743119266, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53018, 20.85, 9.0, 8.7)
    ...
    # Central joint node
    ops.node(3020, 4.5, 13.5, 8.7, '-mass', 15.547591743119266, 15.547591743119266, 15.547591743119266, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53020, 4.35, 13.5, 8.7)
    ops.element('elasticBeamColumn', 53020, 53020, 3020, 99999, 88888)
    ops.node(33020, 4.65, 13.5, 8.7)
    ...
    # Central joint node
    ops.node(3021, 9.0, 13.5, 8.7, '-mass', 13.475248470948012, 13.475248470948012, 13.475248470948012, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53021, 8.85, 13.5, 8.7)
    ops.element('elasticBeamColumn', 53021, 53021, 3021, 99999, 88888)
    ops.node(33021, 9.15, 13.5, 8.7)
    ...
    # Central joint node
    ops.node(3022, 12.0, 13.5, 8.7, '-mass', 13.475248470948012, 13.475248470948012, 13.475248470948012, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53022, 11.85, 13.5, 8.7)
    ops.element('elasticBeamColumn', 53022, 53022, 3022, 99999, 88888)
    ops.node(33022, 12.15, 13.5, 8.7)
    ...
    # Central joint node
    ops.node(3023, 16.5, 13.5, 8.7, '-mass', 15.547591743119266, 15.547591743119266, 15.547591743119266, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53023, 16.35, 13.5, 8.7)
    ops.element('elasticBeamColumn', 53023, 53023, 3023, 99999, 88888)
    ops.node(33023, 16.65, 13.5, 8.7)
    ...
    # Central joint node
    ops.node(4002, 4.5, 0.0, 11.5, '-mass', 10.943233944954127, 10.943233944954127, 10.943233944954127, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54002, 4.35, 0.0, 11.5)
    ops.element('elasticBeamColumn', 54002, 54002, 4002, 99999, 88888)
    ops.node(34002, 4.65, 0.0, 11.5)
    ...
    # Central joint node
    ops.node(4003, 9.0, 0.0, 11.5, '-mass', 6.140577217125381, 6.140577217125381, 6.140577217125381, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54003, 8.85, 0.0, 11.5)
    ops.element('elasticBeamColumn', 54003, 54003, 4003, 99999, 88888)
    ops.node(34003, 9.15, 0.0, 11.5)
    ...
    # Central joint node
    ops.node(4004, 12.0, 0.0, 11.5, '-mass', 6.140577217125381, 6.140577217125381, 6.140577217125381, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54004, 11.85, 0.0, 11.5)
    ops.element('elasticBeamColumn', 54004, 54004, 4004, 99999, 88888)
    ops.node(34004, 12.15, 0.0, 11.5)
    ...
    # Central joint node
    ops.node(4005, 16.5, 0.0, 11.5, '-mass', 10.943233944954127, 10.943233944954127, 10.943233944954127, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54005, 16.35, 0.0, 11.5)
    ops.element('elasticBeamColumn', 54005, 54005, 4005, 99999, 88888)
    ops.node(34005, 16.65, 0.0, 11.5)
    ...
    # Central joint node
    ops.node(4007, 0.0, 4.5, 11.5, '-mass', 10.943233944954127, 10.943233944954127, 10.943233944954127, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34007, 0.15, 4.5, 11.5)
    ...
    # Central joint node
    ops.node(4008, 4.5, 4.5, 11.5, '-mass', 20.668323139653413, 20.668323139653413, 20.668323139653413, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4011, 16.5, 4.5, 11.5, '-mass', 20.668323139653413, 20.668323139653413, 20.668323139653413, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4012, 21.0, 4.5, 11.5, '-mass', 10.943233944954127, 10.943233944954127, 10.943233944954127, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54012, 20.85, 4.5, 11.5)
    ...
    ops.node(64012, 21.0, 4.35, 11.5)
    ops.element('elasticBeamColumn', 64012, 64012, 4012, 99999, 77777)
    ops.node(44012, 21.0, 4.65, 11.5)
    ...
    # Central joint node
    ops.node(4013, 0.0, 9.0, 11.5, '-mass', 10.943233944954127, 10.943233944954127, 10.943233944954127, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34013, 0.15, 9.0, 11.5)
    ...
    # Central joint node
    ops.node(4014, 4.5, 9.0, 11.5, '-mass', 20.668323139653413, 20.668323139653413, 20.668323139653413, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4017, 16.5, 9.0, 11.5, '-mass', 20.668323139653413, 20.668323139653413, 20.668323139653413, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4018, 21.0, 9.0, 11.5, '-mass', 10.943233944954127, 10.943233944954127, 10.943233944954127, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54018, 20.85, 9.0, 11.5)
    ...
    ops.node(64018, 21.0, 8.85, 11.5)
    ops.element('elasticBeamColumn', 64018, 64018, 4018, 99999, 77777)
    ops.node(44018, 21.0, 9.15, 11.5)
    ...
    # Central joint node
    ops.node(4020, 4.5, 13.5, 11.5, '-mass', 10.943233944954127, 10.943233944954127, 10.943233944954127, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54020, 4.35, 13.5, 11.5)
    ops.element('elasticBeamColumn', 54020, 54020, 4020, 99999, 88888)
    ops.node(34020, 4.65, 13.5, 11.5)
    ...
    # Central joint node
    ops.node(4021, 9.0, 13.5, 11.5, '-mass', 9.598146024464832, 9.598146024464832, 9.598146024464832, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54021, 8.85, 13.5, 11.5)
    ops.element('elasticBeamColumn', 54021, 54021, 4021, 99999, 88888)
    ops.node(34021, 9.15, 13.5, 11.5)
    ...
    # Central joint node
    ops.node(4022, 12.0, 13.5, 11.5, '-mass', 9.598146024464832, 9.598146024464832, 9.598146024464832, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54022, 11.85, 13.5, 11.5)
    ops.element('elasticBeamColumn', 54022, 54022, 4022, 99999, 88888)
    ops.node(34022, 12.15, 13.5, 11.5)
    ...
    ops.node(64022, 12.0, 13.35, 11.5)
    ...
    # Central joint node
    ops.node(4023, 16.5, 13.5, 11.5, '-mass', 10.943233944954127, 10.943233944954127, 10.943233944954127, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54023, 16.35, 13.5, 11.5)
    ops.element('elasticBeamColumn', 54023, 54023, 4023, 99999, 88888)
    ops.node(34023, 16.65, 13.5, 11.5)
    ...
    ops.node(64023, 16.5, 13.35, 11.5)
