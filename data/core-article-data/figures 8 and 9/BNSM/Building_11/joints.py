...
def add_joints() -> None:
    ...
    # Central joint node
    ops.node(4022, 3.05, 0.0, 1.575, '-mass', 3.454708205912334, 3.454708205912334, 3.454708205912334, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54022, 2.85, 0.0, 1.575)
    ...
    # Central joint node
    ops.node(4024, 3.05, 0.0, 4.725, '-mass', 3.454708205912334, 3.454708205912334, 3.454708205912334, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54024, 2.85, 0.0, 4.725)
    ...
    ops.uniaxialMaterial('Elastic', 301001, 53594.8218)
    ops.uniaxialMaterial('Elastic', 401001, 67699.88515)
    ...
    # Central joint node
    ops.node(1002, 3.05, 0.0, 3.15, '-mass', 12.900036952089703, 12.900036952089703, 12.900036952089703, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51002, 2.85, 0.0, 3.15)
    ops.element('elasticBeamColumn', 51002, 51002, 1002, 99999, 88888)
    ops.node(31002, 3.25, 0.0, 3.15)
    ...
    ops.node(41002, 3.05, 0.2, 3.15)
    ops.element('elasticBeamColumn', 41002, 1002, 41002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301002, 137485.54555)
    ops.uniaxialMaterial('Elastic', 401002, 252954.9874)
    ...
    # Central joint node
    ops.node(1003, 9.0, 0.0, 3.15, '-mass', 21.01730122324159, 21.01730122324159, 21.01730122324159, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51003, 8.775, 0.0, 3.15)
    ops.element('elasticBeamColumn', 51003, 51003, 1003, 99999, 88888)
    ops.node(31003, 9.225, 0.0, 3.15)
    ...
    ops.node(41003, 9.0, 0.225, 3.15)
    ops.element('elasticBeamColumn', 41003, 1003, 41003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301003, 152524.55555)
    ops.uniaxialMaterial('Elastic', 401003, 270625.9065)
    ...
    # Central joint node
    ops.node(1004, 14.95, 0.0, 3.15, '-mass', 12.012422273190621, 12.012422273190621, 12.012422273190621, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51004, 14.8, 0.0, 3.15)
    ...
    ops.node(41004, 14.95, 0.15, 3.15)
    ops.element('elasticBeamColumn', 41004, 1004, 41004, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301004, 73948.16485)
    ops.uniaxialMaterial('Elastic', 401004, 96433.21935)
    ...
    # Central joint node
    ops.node(1005, 0.0, 3.95, 3.15, '-mass', 9.986531600407748, 9.986531600407748, 9.986531600407748, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31005, 0.15, 3.95, 3.15)
    ...
    ops.node(61005, 0.0, 3.8, 3.15)
    ops.element('elasticBeamColumn', 61005, 61005, 1005, 99999, 77777)
    ops.node(41005, 0.0, 4.1, 3.15)
    ops.element('elasticBeamColumn', 41005, 1005, 41005, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301005, 95914.7619)
    ops.uniaxialMaterial('Elastic', 401005, 107569.73445)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301006, 243680.0214)
    ops.uniaxialMaterial('Elastic', 401006, 362548.3245)
    ...
    # Central joint node
    ops.node(1007, 9.0, 3.95, 3.15, '-mass', 30.205958205912324, 30.205958205912324, 30.205958205912324, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301007, 308529.0503)
    ops.uniaxialMaterial('Elastic', 401007, 459031.026)
    ...
    # Central joint node
    ops.node(1008, 14.95, 3.95, 3.15, '-mass', 18.351348114169213, 18.351348114169213, 18.351348114169213, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51008, 14.75, 3.95, 3.15)
    ...
    ops.node(61008, 14.95, 3.75, 3.15)
    ops.element('elasticBeamColumn', 61008, 61008, 1008, 99999, 77777)
    ops.node(41008, 14.95, 4.15, 3.15)
    ops.element('elasticBeamColumn', 41008, 1008, 41008, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301008, 163808.82615)
    ops.uniaxialMaterial('Elastic', 401008, 194731.47715)
    ...
    # Central joint node
    ops.node(1009, 0.0, 7.9, 3.15, '-mass', 10.468437818552497, 10.468437818552497, 10.468437818552497, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31009, 0.15, 7.9, 3.15)
    ...
    ops.node(61009, 0.0, 7.75, 3.15)
    ops.element('elasticBeamColumn', 61009, 61009, 1009, 99999, 77777)
    ops.node(41009, 0.0, 8.05, 3.15)
    ops.element('elasticBeamColumn', 41009, 1009, 41009, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301009, 98099.95345)
    ops.uniaxialMaterial('Elastic', 401009, 109860.212)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301010, 240141.0087)
    ops.uniaxialMaterial('Elastic', 401010, 357282.96415)
    ...
    # Central joint node
    ops.node(1011, 9.0, 7.9, 3.15, '-mass', 30.205958205912324, 30.205958205912324, 30.205958205912324, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301011, 308529.0503)
    ops.uniaxialMaterial('Elastic', 401011, 459031.026)
    ...
    # Central joint node
    ops.node(1012, 14.95, 7.9, 3.15, '-mass', 18.351348114169213, 18.351348114169213, 18.351348114169213, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51012, 14.75, 7.9, 3.15)
    ...
    ops.node(61012, 14.95, 7.7, 3.15)
    ops.element('elasticBeamColumn', 61012, 61012, 1012, 99999, 77777)
    ops.node(41012, 14.95, 8.1, 3.15)
    ops.element('elasticBeamColumn', 41012, 1012, 41012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301012, 163808.82615)
    ops.uniaxialMaterial('Elastic', 401012, 194731.47715)
    ...
    # Central joint node
    ops.node(1013, 0.0, 11.85, 3.15, '-mass', 10.468437818552498, 10.468437818552498, 10.468437818552498, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31013, 0.15, 11.85, 3.15)
    ...
    ops.node(61013, 0.0, 11.7, 3.15)
    ops.element('elasticBeamColumn', 61013, 61013, 1013, 99999, 77777)
    ops.node(41013, 0.0, 12.0, 3.15)
    ops.element('elasticBeamColumn', 41013, 1013, 41013, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301013, 98099.95345)
    ops.uniaxialMaterial('Elastic', 401013, 109860.212)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301014, 240141.0087)
    ops.uniaxialMaterial('Elastic', 401014, 357282.96415)
    ...
    # Central joint node
    ops.node(1015, 9.0, 11.85, 3.15, '-mass', 30.205958205912328, 30.205958205912328, 30.205958205912328, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301015, 308529.0503)
    ops.uniaxialMaterial('Elastic', 401015, 459031.026)
    ...
    # Central joint node
    ops.node(1016, 14.95, 11.85, 3.15, '-mass', 18.351348114169213, 18.351348114169213, 18.351348114169213, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51016, 14.75, 11.85, 3.15)
    ...
    ops.node(61016, 14.95, 11.65, 3.15)
    ops.element('elasticBeamColumn', 61016, 61016, 1016, 99999, 77777)
    ops.node(41016, 14.95, 12.05, 3.15)
    ops.element('elasticBeamColumn', 41016, 1016, 41016, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301016, 163808.82615)
    ops.uniaxialMaterial('Elastic', 401016, 194731.47715)
    ...
    # Central joint node
    ops.node(1017, 0.0, 15.8, 3.15, '-mass', 6.783709225280327, 6.783709225280327, 6.783709225280327, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31017, 0.125, 15.8, 3.15)
    ...
    ops.node(61017, 0.0, 15.675, 3.15)
    ops.element('elasticBeamColumn', 61017, 61017, 1017, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301017, 51208.514)
    ops.uniaxialMaterial('Elastic', 401017, 60802.0575)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301018, 117586.1106)
    ops.uniaxialMaterial('Elastic', 401018, 207512.79995)
    ...
    # Central joint node
    ops.node(1019, 9.0, 15.8, 3.15, '-mass', 21.01730122324159, 21.01730122324159, 21.01730122324159, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51019, 8.775, 15.8, 3.15)
    ops.element('elasticBeamColumn', 51019, 51019, 1019, 99999, 88888)
    ops.node(31019, 9.225, 15.8, 3.15)
    ...
    ops.node(61019, 9.0, 15.575, 3.15)
    ops.element('elasticBeamColumn', 61019, 61019, 1019, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301019, 152524.55555)
    ops.uniaxialMaterial('Elastic', 401019, 270625.9065)
    ...
    # Central joint node
    ops.node(1020, 14.95, 15.8, 3.15, '-mass', 12.012422273190621, 12.012422273190621, 12.012422273190621, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51020, 14.8, 15.8, 3.15)
    ...
    ops.node(61020, 14.95, 15.65, 3.15)
    ops.element('elasticBeamColumn', 61020, 61020, 1020, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301020, 73948.16485)
    ops.uniaxialMaterial('Elastic', 401020, 96433.21935)
    ...
    # Central joint node
    ops.node(2001, 0.0, 0.0, 6.3, '-mass', 2.9167686034658513, 2.9167686034658513, 2.9167686034658513, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302001, 38886.4244)
    ops.uniaxialMaterial('Elastic', 402001, 57746.2651)
    ...
    # Central joint node
    ops.node(2002, 3.05, 0.0, 6.3, '-mass', 12.706994138634046, 12.706994138634046, 12.706994138634046, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52002, 2.85, 0.0, 6.3)
    ops.element('elasticBeamColumn', 52002, 52002, 2002, 99999, 88888)
    ops.node(32002, 3.25, 0.0, 6.3)
    ...
    ops.node(42002, 3.05, 0.2, 6.3)
    ops.element('elasticBeamColumn', 42002, 2002, 42002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302002, 117998.3314)
    ops.uniaxialMaterial('Elastic', 402002, 215789.04735)
    ...
    # Central joint node
    ops.node(2003, 9.0, 0.0, 6.3, '-mass', 20.709044342507642, 20.709044342507642, 20.709044342507642, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52003, 8.775, 0.0, 6.3)
    ops.element('elasticBeamColumn', 52003, 52003, 2003, 99999, 88888)
    ops.node(32003, 9.225, 0.0, 6.3)
    ...
    ops.node(42003, 9.0, 0.225, 6.3)
    ops.element('elasticBeamColumn', 42003, 2003, 42003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302003, 131959.1038)
    ops.uniaxialMaterial('Elastic', 402003, 233010.5023)
    ...
    # Central joint node
    ops.node(2004, 14.95, 0.0, 6.3, '-mass', 11.906458970438328, 11.906458970438328, 11.906458970438328, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52004, 14.8, 0.0, 6.3)
    ...
    ops.node(42004, 14.95, 0.15, 6.3)
    ops.element('elasticBeamColumn', 42004, 2004, 42004, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302004, 63911.18795)
    ops.uniaxialMaterial('Elastic', 402004, 83482.33)
    ...
    # Central joint node
    ops.node(2005, 0.0, 3.95, 6.3, '-mass', 9.759773190621814, 9.759773190621814, 9.759773190621814, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32005, 0.15, 3.95, 6.3)
    ...
    ops.node(62005, 0.0, 3.8, 6.3)
    ops.element('elasticBeamColumn', 62005, 62005, 2005, 99999, 77777)
    ops.node(42005, 0.0, 4.1, 6.3)
    ops.element('elasticBeamColumn', 42005, 2005, 42005, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302005, 72225.3147)
    ops.uniaxialMaterial('Elastic', 402005, 93439.38555)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302006, 211745.7069)
    ops.uniaxialMaterial('Elastic', 402006, 315036.29565)
    ...
    # Central joint node
    ops.node(2007, 9.0, 3.95, 6.3, '-mass', 30.003664627930675, 30.003664627930675, 30.003664627930675, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302007, 269163.05005)
    ops.uniaxialMaterial('Elastic', 402007, 400462.09885)
    ...
    # Central joint node
    ops.node(2008, 14.95, 3.95, 6.3, '-mass', 18.206852701325175, 18.206852701325175, 18.206852701325175, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52008, 14.75, 3.95, 6.3)
    ...
    ops.node(62008, 14.95, 3.75, 6.3)
    ops.element('elasticBeamColumn', 62008, 62008, 2008, 99999, 77777)
    ops.node(42008, 14.95, 4.15, 6.3)
    ops.element('elasticBeamColumn', 42008, 2008, 42008, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302008, 141766.65615)
    ops.uniaxialMaterial('Elastic', 402008, 169763.90715)
    ...
    # Central joint node
    ops.node(2009, 0.0, 7.9, 6.3, '-mass', 10.241679408766563, 10.241679408766563, 10.241679408766563, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32009, 0.15, 7.9, 6.3)
    ...
    ops.node(62009, 0.0, 7.75, 6.3)
    ops.element('elasticBeamColumn', 62009, 62009, 2009, 99999, 77777)
    ops.node(42009, 0.0, 8.05, 6.3)
    ops.element('elasticBeamColumn', 42009, 2009, 42009, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302009, 73833.84805)
    ops.uniaxialMaterial('Elastic', 402009, 95364.00125)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302010, 209057.6361)
    ops.uniaxialMaterial('Elastic', 402010, 311036.97075)
    ...
    # Central joint node
    ops.node(2011, 9.0, 7.9, 6.3, '-mass', 30.003664627930675, 30.003664627930675, 30.003664627930675, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302011, 269163.05005)
    ops.uniaxialMaterial('Elastic', 402011, 400462.09885)
    ...
    # Central joint node
    ops.node(2012, 14.95, 7.9, 6.3, '-mass', 18.206852701325175, 18.206852701325175, 18.206852701325175, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52012, 14.75, 7.9, 6.3)
    ...
    ops.node(62012, 14.95, 7.7, 6.3)
    ops.element('elasticBeamColumn', 62012, 62012, 2012, 99999, 77777)
    ops.node(42012, 14.95, 8.1, 6.3)
    ops.element('elasticBeamColumn', 42012, 2012, 42012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302012, 141766.65615)
    ops.uniaxialMaterial('Elastic', 402012, 169763.90715)
    ...
    # Central joint node
    ops.node(2013, 0.0, 11.85, 6.3, '-mass', 10.241679408766565, 10.241679408766565, 10.241679408766565, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32013, 0.15, 11.85, 6.3)
    ...
    ops.node(62013, 0.0, 11.7, 6.3)
    ops.element('elasticBeamColumn', 62013, 62013, 2013, 99999, 77777)
    ops.node(42013, 0.0, 12.0, 6.3)
    ops.element('elasticBeamColumn', 42013, 2013, 42013, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302013, 73833.84805)
    ops.uniaxialMaterial('Elastic', 402013, 95364.00125)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302014, 209057.6361)
    ops.uniaxialMaterial('Elastic', 402014, 311036.97075)
    ...
    # Central joint node
    ops.node(2015, 9.0, 11.85, 6.3, '-mass', 30.00366462793068, 30.00366462793068, 30.00366462793068, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302015, 269163.05005)
    ops.uniaxialMaterial('Elastic', 402015, 400462.09885)
    ...
    # Central joint node
    ops.node(2016, 14.95, 11.85, 6.3, '-mass', 18.206852701325175, 18.206852701325175, 18.206852701325175, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52016, 14.75, 11.85, 6.3)
    ...
    ops.node(62016, 14.95, 11.65, 6.3)
    ops.element('elasticBeamColumn', 62016, 62016, 2016, 99999, 77777)
    ops.node(42016, 14.95, 12.05, 6.3)
    ops.element('elasticBeamColumn', 42016, 2016, 42016, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302016, 141766.65615)
    ops.uniaxialMaterial('Elastic', 402016, 169763.90715)
    ...
    # Central joint node
    ops.node(2017, 0.0, 15.8, 6.3, '-mass', 6.723311671763508, 6.723311671763508, 6.723311671763508, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32017, 0.125, 15.8, 6.3)
    ...
    ops.node(62017, 0.0, 15.675, 6.3)
    ops.element('elasticBeamColumn', 62017, 62017, 2017, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302017, 38446.23065)
    ops.uniaxialMaterial('Elastic', 402017, 52612.8253)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302018, 101799.53945)
    ops.uniaxialMaterial('Elastic', 402018, 178636.1484)
    ...
    # Central joint node
    ops.node(2019, 9.0, 15.8, 6.3, '-mass', 20.709044342507642, 20.709044342507642, 20.709044342507642, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52019, 8.775, 15.8, 6.3)
    ops.element('elasticBeamColumn', 52019, 52019, 2019, 99999, 88888)
    ops.node(32019, 9.225, 15.8, 6.3)
    ...
    ops.node(62019, 9.0, 15.575, 6.3)
    ops.element('elasticBeamColumn', 62019, 62019, 2019, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302019, 131959.1038)
    ops.uniaxialMaterial('Elastic', 402019, 233010.5023)
    ...
    # Central joint node
    ops.node(2020, 14.95, 15.8, 6.3, '-mass', 11.906458970438328, 11.906458970438328, 11.906458970438328, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52020, 14.8, 15.8, 6.3)
    ...
    ops.node(62020, 14.95, 15.65, 6.3)
    ops.element('elasticBeamColumn', 62020, 62020, 2020, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302020, 63911.18795)
    ops.uniaxialMaterial('Elastic', 402020, 83482.33)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303001, 29778.1357)
    ops.uniaxialMaterial('Elastic', 403001, 44490.23005)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303002, 60739.77135)
    ops.uniaxialMaterial('Elastic', 403002, 148452.65115)
    ...
    # Central joint node
    ops.node(3003, 9.0, 0.0, 9.45, '-mass', 20.15919724770642, 20.15919724770642, 20.15919724770642, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53003, 8.825, 0.0, 9.45)
    ops.element('elasticBeamColumn', 53003, 53003, 3003, 99999, 88888)
    ops.node(33003, 9.175, 0.0, 9.45)
    ...
    ops.node(43003, 9.0, 0.175, 9.45)
    ops.element('elasticBeamColumn', 43003, 3003, 43003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303003, 64127.07175)
    ops.uniaxialMaterial('Elastic', 403003, 145720.6688)
    ...
    # Central joint node
    ops.node(3004, 14.95, 0.0, 9.45, '-mass', 11.740098114169216, 11.740098114169216, 11.740098114169216, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303004, 41371.80105)
    ops.uniaxialMaterial('Elastic', 403004, 56545.81705)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303005, 53092.6127)
    ops.uniaxialMaterial('Elastic', 403005, 63867.06395)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303006, 108066.50245)
    ops.uniaxialMaterial('Elastic', 403006, 206907.8157)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303007, 157247.3788)
    ops.uniaxialMaterial('Elastic', 403007, 301071.2009)
    ...
    # Central joint node
    ops.node(3008, 14.95, 3.95, 9.45, '-mass', 17.9415621814475, 17.9415621814475, 17.9415621814475, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303008, 88462.3537)
    ops.uniaxialMaterial('Elastic', 403008, 122502.75725)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303009, 54214.2743)
    ops.uniaxialMaterial('Elastic', 403009, 65091.97)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303010, 107078.4705)
    ops.uniaxialMaterial('Elastic', 403010, 205016.096)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303011, 157247.3788)
    ops.uniaxialMaterial('Elastic', 403011, 301071.2009)
    ...
    # Central joint node
    ops.node(3012, 14.95, 7.9, 9.45, '-mass', 17.941562181447498, 17.941562181447498, 17.941562181447498, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303012, 88462.3537)
    ops.uniaxialMaterial('Elastic', 403012, 122502.75725)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303013, 54214.2743)
    ops.uniaxialMaterial('Elastic', 403013, 65091.97)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303014, 107078.4705)
    ops.uniaxialMaterial('Elastic', 403014, 205016.096)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303015, 157247.3788)
    ops.uniaxialMaterial('Elastic', 403015, 301071.2009)
    ...
    # Central joint node
    ops.node(3016, 14.95, 11.85, 9.45, '-mass', 17.9415621814475, 17.9415621814475, 17.9415621814475, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303016, 88462.3537)
    ops.uniaxialMaterial('Elastic', 403016, 122502.75725)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303017, 31161.1399)
    ops.uniaxialMaterial('Elastic', 403017, 42820.3359)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303018, 55770.80215)
    ops.uniaxialMaterial('Elastic', 403018, 126060.9442)
    ...
    # Central joint node
    ops.node(3019, 9.0, 15.8, 9.45, '-mass', 20.15919724770642, 20.15919724770642, 20.15919724770642, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53019, 8.825, 15.8, 9.45)
    ops.element('elasticBeamColumn', 53019, 53019, 3019, 99999, 88888)
    ops.node(33019, 9.175, 15.8, 9.45)
    ...
    ops.node(63019, 9.0, 15.625, 9.45)
    ops.element('elasticBeamColumn', 63019, 63019, 3019, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303019, 64127.07175)
    ops.uniaxialMaterial('Elastic', 403019, 145720.6688)
    ...
    # Central joint node
    ops.node(3020, 14.95, 15.8, 9.45, '-mass', 11.740098114169216, 11.740098114169216, 11.740098114169216, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303020, 41371.80105)
    ops.uniaxialMaterial('Elastic', 403020, 56545.81705)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304001, 12248.64375)
    ops.uniaxialMaterial('Elastic', 404001, 22841.71235)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304002, 49053.87505)
    ops.uniaxialMaterial('Elastic', 404002, 72346.3761)
    ...
    # Central joint node
    ops.node(4003, 9.0, 0.0, 12.6, '-mass', 12.81203873598369, 12.81203873598369, 12.81203873598369, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54003, 8.825, 0.0, 12.6)
    ops.element('elasticBeamColumn', 54003, 54003, 4003, 99999, 88888)
    ops.node(34003, 9.175, 0.0, 12.6)
    ...
    ops.node(44003, 9.0, 0.175, 12.6)
    ops.element('elasticBeamColumn', 44003, 4003, 44003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304003, 54871.43775)
    ops.uniaxialMaterial('Elastic', 404003, 94403.9837)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304004, 28572.3391)
    ops.uniaxialMaterial('Elastic', 404004, 49778.6039)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304005, 32429.44535)
    ops.uniaxialMaterial('Elastic', 404005, 57917.2394)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304006, 81240.22585)
    ops.uniaxialMaterial('Elastic', 404006, 144350.51695)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304007, 101459.99565)
    ops.uniaxialMaterial('Elastic', 404007, 198765.8173)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304008, 54869.00405)
    ops.uniaxialMaterial('Elastic', 404008, 115090.30195)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304009, 32885.0068)
    ops.uniaxialMaterial('Elastic', 404009, 58684.4854)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304010, 81622.40705)
    ops.uniaxialMaterial('Elastic', 404010, 145004.09605)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304011, 101459.99565)
    ops.uniaxialMaterial('Elastic', 404011, 198765.8173)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304012, 54869.00405)
    ops.uniaxialMaterial('Elastic', 404012, 115090.30195)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304013, 32885.0068)
    ops.uniaxialMaterial('Elastic', 404013, 58684.4854)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304014, 81622.40705)
    ops.uniaxialMaterial('Elastic', 404014, 145004.09605)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304015, 101459.99565)
    ops.uniaxialMaterial('Elastic', 404015, 198765.8173)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304016, 54869.00405)
    ops.uniaxialMaterial('Elastic', 404016, 115090.30195)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304017, 20715.36275)
    ops.uniaxialMaterial('Elastic', 404017, 36756.07245)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304018, 56239.03305)
    ops.uniaxialMaterial('Elastic', 404018, 82585.3898)
    ...
    # Central joint node
    ops.node(4019, 9.0, 15.8, 12.6, '-mass', 12.81203873598369, 12.81203873598369, 12.81203873598369, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54019, 8.825, 15.8, 12.6)
    ops.element('elasticBeamColumn', 54019, 54019, 4019, 99999, 88888)
    ops.node(34019, 9.175, 15.8, 12.6)
    ...
    ops.node(64019, 9.0, 15.625, 12.6)
    ops.element('elasticBeamColumn', 64019, 64019, 4019, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304019, 54871.43775)
    ops.uniaxialMaterial('Elastic', 404019, 94403.9837)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304020, 28572.3391)
    ops.uniaxialMaterial('Elastic', 404020, 49778.6039)
