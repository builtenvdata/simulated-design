...
def add_joints() -> None:
    ...
    # Central joint node
    ops.node(4030, 13.45, 0.0, 7.25, '-mass', 3.166188837920488, 3.166188837920488, 3.166188837920488, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54030, 13.3, 0.0, 7.25)
    ...
    # Central joint node
    ops.node(4031, 10.6, 0.0, 10.15, '-mass', 3.166188837920488, 3.166188837920488, 3.166188837920488, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34031, 10.75, 0.0, 10.15)
    ...
    # Central joint node
    ops.node(4032, 13.45, 0.0, 10.15, '-mass', 3.166188837920488, 3.166188837920488, 3.166188837920488, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54032, 13.3, 0.0, 10.15)
    ...
    # Central joint node
    ops.node(1001, 0.0, 0.0, 2.9, '-mass', 8.761411932959431, 8.761411932959431, 8.761411932959431, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1002, 5.3, 0.0, 2.9, '-mass', 13.785005313421413, 13.785005313421413, 13.785005313421413, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1003, 10.6, 0.0, 2.9, '-mass', 9.584806428372275, 9.584806428372275, 9.584806428372275, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1004, 13.45, 0.0, 2.9, '-mass', 9.584806428372275, 9.584806428372275, 9.584806428372275, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1005, 18.75, 0.0, 2.9, '-mass', 13.785005313421415, 13.785005313421415, 13.785005313421415, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(41005, 18.75, 0.225, 2.9)
    ...
    # Central joint node
    ops.node(1006, 24.05, 0.0, 2.9, '-mass', 8.761411932959433, 8.761411932959433, 8.761411932959433, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(41006, 24.05, 0.125, 2.9)
    ...
    # Central joint node
    ops.node(1007, 0.0, 4.25, 2.9, '-mass', 13.328736200271564, 13.328736200271564, 13.328736200271564, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31007, 0.2, 4.25, 2.9)
    ...
    # Central joint node
    ops.node(1008, 5.3, 4.25, 2.9, '-mass', 18.49009217628217, 18.49009217628217, 18.49009217628217, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51008, 5.025, 4.25, 2.9)
    ops.element('elasticBeamColumn', 51008, 51008, 1008, 99999, 88888)
    ops.node(31008, 5.575, 4.25, 2.9)
    ...
    # Central joint node
    ops.node(1009, 10.6, 4.25, 2.9, '-mass', 17.070461109669292, 17.070461109669292, 17.070461109669292, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51009, 10.35, 4.25, 2.9)
    ops.element('elasticBeamColumn', 51009, 51009, 1009, 99999, 88888)
    ops.node(31009, 10.85, 4.25, 2.9)
    ...
    # Central joint node
    ops.node(1010, 13.45, 4.25, 2.9, '-mass', 17.070461109669296, 17.070461109669296, 17.070461109669296, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51010, 13.2, 4.25, 2.9)
    ops.element('elasticBeamColumn', 51010, 51010, 1010, 99999, 88888)
    ops.node(31010, 13.7, 4.25, 2.9)
    ...
    # Central joint node
    ops.node(1011, 18.75, 4.25, 2.9, '-mass', 18.490092176282175, 18.490092176282175, 18.490092176282175, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51011, 18.475, 4.25, 2.9)
    ops.element('elasticBeamColumn', 51011, 51011, 1011, 99999, 88888)
    ops.node(31011, 19.025, 4.25, 2.9)
    ...
    # Central joint node
    ops.node(1012, 24.05, 4.25, 2.9, '-mass', 13.328736200271564, 13.328736200271564, 13.328736200271564, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51012, 23.85, 4.25, 2.9)
    ...
    ops.node(61012, 24.05, 4.075, 2.9)
    ops.element('elasticBeamColumn', 61012, 61012, 1012, 99999, 77777)
    ops.node(41012, 24.05, 4.425, 2.9)
    ...
    # Central joint node
    ops.node(1013, 0.0, 8.5, 2.9, '-mass', 13.328736200271564, 13.328736200271564, 13.328736200271564, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31013, 0.2, 8.5, 2.9)
    ...
    # Central joint node
    ops.node(1014, 5.3, 8.5, 2.9, '-mass', 18.49009217628217, 18.49009217628217, 18.49009217628217, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51014, 5.025, 8.5, 2.9)
    ops.element('elasticBeamColumn', 51014, 51014, 1014, 99999, 88888)
    ops.node(31014, 5.575, 8.5, 2.9)
    ...
    # Central joint node
    ops.node(1015, 10.6, 8.5, 2.9, '-mass', 14.810695193378951, 14.810695193378951, 14.810695193378951, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51015, 10.375, 8.5, 2.9)
    ops.element('elasticBeamColumn', 51015, 51015, 1015, 99999, 88888)
    ops.node(31015, 10.825, 8.5, 2.9)
    ...
    # Central joint node
    ops.node(1016, 13.45, 8.5, 2.9, '-mass', 14.810695193378951, 14.810695193378951, 14.810695193378951, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51016, 13.225, 8.5, 2.9)
    ops.element('elasticBeamColumn', 51016, 51016, 1016, 99999, 88888)
    ops.node(31016, 13.675, 8.5, 2.9)
    ...
    # Central joint node
    ops.node(1017, 18.75, 8.5, 2.9, '-mass', 18.490092176282175, 18.490092176282175, 18.490092176282175, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51017, 18.475, 8.5, 2.9)
    ops.element('elasticBeamColumn', 51017, 51017, 1017, 99999, 88888)
    ops.node(31017, 19.025, 8.5, 2.9)
    ...
    # Central joint node
    ops.node(1018, 24.05, 8.5, 2.9, '-mass', 13.328736200271564, 13.328736200271564, 13.328736200271564, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51018, 23.85, 8.5, 2.9)
    ...
    ops.node(61018, 24.05, 8.325, 2.9)
    ops.element('elasticBeamColumn', 61018, 61018, 1018, 99999, 77777)
    ops.node(41018, 24.05, 8.675, 2.9)
    ...
    # Central joint node
    ops.node(1019, 0.0, 12.75, 2.9, '-mass', 8.761411932959431, 8.761411932959431, 8.761411932959431, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1020, 5.3, 12.75, 2.9, '-mass', 13.660846292014684, 13.660846292014684, 13.660846292014684, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1021, 10.6, 12.75, 2.9, '-mass', 10.79168806559875, 10.79168806559875, 10.79168806559875, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1022, 13.45, 12.75, 2.9, '-mass', 10.791688065598752, 10.791688065598752, 10.791688065598752, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1023, 18.75, 12.75, 2.9, '-mass', 13.660846292014686, 13.660846292014686, 13.660846292014686, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(61023, 18.75, 12.55, 2.9)
    ...
    # Central joint node
    ops.node(1024, 24.05, 12.75, 2.9, '-mass', 8.761411932959433, 8.761411932959433, 8.761411932959433, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(61024, 24.05, 12.625, 2.9)
    ...
    # Central joint node
    ops.node(2001, 0.0, 0.0, 5.8, '-mass', 8.761411932959431, 8.761411932959431, 8.761411932959431, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2002, 5.3, 0.0, 5.8, '-mass', 13.536687270607958, 13.536687270607958, 13.536687270607958, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2003, 10.6, 0.0, 5.8, '-mass', 9.522726917668912, 9.522726917668912, 9.522726917668912, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2004, 13.45, 0.0, 5.8, '-mass', 9.522726917668912, 9.522726917668912, 9.522726917668912, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2005, 18.75, 0.0, 5.8, '-mass', 13.53668727060796, 13.53668727060796, 13.53668727060796, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(42005, 18.75, 0.225, 5.8)
    ...
    # Central joint node
    ops.node(2006, 24.05, 0.0, 5.8, '-mass', 8.761411932959433, 8.761411932959433, 8.761411932959433, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(42006, 24.05, 0.125, 5.8)
    ...
    # Central joint node
    ops.node(2007, 0.0, 4.25, 5.8, '-mass', 13.142497668161473, 13.142497668161473, 13.142497668161473, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32007, 0.2, 4.25, 5.8)
    ...
    # Central joint node
    ops.node(2008, 5.3, 4.25, 5.8, '-mass', 18.232905631939666, 18.232905631939666, 18.232905631939666, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52008, 5.025, 4.25, 5.8)
    ops.element('elasticBeamColumn', 52008, 52008, 2008, 99999, 88888)
    ops.node(32008, 5.575, 4.25, 5.8)
    ...
    # Central joint node
    ops.node(2009, 10.6, 4.25, 5.8, '-mass', 16.857617072972044, 16.857617072972044, 16.857617072972044, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52009, 10.35, 4.25, 5.8)
    ops.element('elasticBeamColumn', 52009, 52009, 2009, 99999, 88888)
    ops.node(32009, 10.85, 4.25, 5.8)
    ...
    # Central joint node
    ops.node(2010, 13.45, 4.25, 5.8, '-mass', 16.857617072972047, 16.857617072972047, 16.857617072972047, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52010, 13.2, 4.25, 5.8)
    ops.element('elasticBeamColumn', 52010, 52010, 2010, 99999, 88888)
    ops.node(32010, 13.7, 4.25, 5.8)
    ...
    # Central joint node
    ops.node(2011, 18.75, 4.25, 5.8, '-mass', 18.23290563193967, 18.23290563193967, 18.23290563193967, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52011, 18.475, 4.25, 5.8)
    ops.element('elasticBeamColumn', 52011, 52011, 2011, 99999, 88888)
    ops.node(32011, 19.025, 4.25, 5.8)
    ...
    # Central joint node
    ops.node(2012, 24.05, 4.25, 5.8, '-mass', 13.142497668161473, 13.142497668161473, 13.142497668161473, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52012, 23.85, 4.25, 5.8)
    ...
    ops.node(62012, 24.05, 4.075, 5.8)
    ops.element('elasticBeamColumn', 62012, 62012, 2012, 99999, 77777)
    ops.node(42012, 24.05, 4.425, 5.8)
    ...
    # Central joint node
    ops.node(2013, 0.0, 8.5, 5.8, '-mass', 13.142497668161473, 13.142497668161473, 13.142497668161473, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32013, 0.2, 8.5, 5.8)
    ...
    # Central joint node
    ops.node(2014, 5.3, 8.5, 5.8, '-mass', 18.232905631939666, 18.232905631939666, 18.232905631939666, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52014, 5.025, 8.5, 5.8)
    ops.element('elasticBeamColumn', 52014, 52014, 2014, 99999, 88888)
    ops.node(32014, 5.575, 8.5, 5.8)
    ...
    # Central joint node
    ops.node(2015, 10.6, 8.5, 5.8, '-mass', 14.562377150565496, 14.562377150565496, 14.562377150565496, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52015, 10.375, 8.5, 5.8)
    ops.element('elasticBeamColumn', 52015, 52015, 2015, 99999, 88888)
    ops.node(32015, 10.825, 8.5, 5.8)
    ...
    # Central joint node
    ops.node(2016, 13.45, 8.5, 5.8, '-mass', 14.562377150565496, 14.562377150565496, 14.562377150565496, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52016, 13.225, 8.5, 5.8)
    ops.element('elasticBeamColumn', 52016, 52016, 2016, 99999, 88888)
    ops.node(32016, 13.675, 8.5, 5.8)
    ...
    # Central joint node
    ops.node(2017, 18.75, 8.5, 5.8, '-mass', 18.23290563193967, 18.23290563193967, 18.23290563193967, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52017, 18.475, 8.5, 5.8)
    ops.element('elasticBeamColumn', 52017, 52017, 2017, 99999, 88888)
    ops.node(32017, 19.025, 8.5, 5.8)
    ...
    # Central joint node
    ops.node(2018, 24.05, 8.5, 5.8, '-mass', 13.142497668161473, 13.142497668161473, 13.142497668161473, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52018, 23.85, 8.5, 5.8)
    ...
    ops.node(62018, 24.05, 8.325, 5.8)
    ops.element('elasticBeamColumn', 62018, 62018, 2018, 99999, 77777)
    ops.node(42018, 24.05, 8.675, 5.8)
    ...
    # Central joint node
    ops.node(2019, 0.0, 12.75, 5.8, '-mass', 8.761411932959431, 8.761411932959431, 8.761411932959431, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2020, 5.3, 12.75, 5.8, '-mass', 13.474607759904593, 13.474607759904593, 13.474607759904593, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2021, 10.6, 12.75, 5.8, '-mass', 10.694134548779179, 10.694134548779179, 10.694134548779179, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2022, 13.45, 12.75, 5.8, '-mass', 10.69413454877918, 10.69413454877918, 10.69413454877918, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(2023, 18.75, 12.75, 5.8, '-mass', 13.474607759904595, 13.474607759904595, 13.474607759904595, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(62023, 18.75, 12.55, 5.8)
    ...
    # Central joint node
    ops.node(2024, 24.05, 12.75, 5.8, '-mass', 8.761411932959433, 8.761411932959433, 8.761411932959433, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(62024, 24.05, 12.625, 5.8)
    ...
    # Central joint node
    ops.node(3001, 0.0, 0.0, 8.7, '-mass', 8.52746697883099, 8.52746697883099, 8.52746697883099, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3002, 5.3, 0.0, 8.7, '-mass', 13.236381460210405, 13.236381460210405, 13.236381460210405, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3003, 10.6, 0.0, 8.7, '-mass', 9.200708569045059, 9.200708569045059, 9.200708569045059, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53003, 10.45, 0.0, 8.7)
    ops.element('elasticBeamColumn', 53003, 53003, 3003, 99999, 88888)
    ops.node(33003, 10.75, 0.0, 8.7)
    ...
    # Central joint node
    ops.node(3004, 13.45, 0.0, 8.7, '-mass', 9.200708569045062, 9.200708569045062, 9.200708569045062, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53004, 13.3, 0.0, 8.7)
    ops.element('elasticBeamColumn', 53004, 53004, 3004, 99999, 88888)
    ops.node(33004, 13.6, 0.0, 8.7)
    ...
    ops.node(43004, 13.45, 0.175, 8.7)
    ...
    # Central joint node
    ops.node(3005, 18.75, 0.0, 8.7, '-mass', 13.236381460210406, 13.236381460210406, 13.236381460210406, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(43005, 18.75, 0.175, 8.7)
    ...
    # Central joint node
    ops.node(3006, 24.05, 0.0, 8.7, '-mass', 8.527466978830994, 8.527466978830994, 8.527466978830994, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3007, 0.0, 4.25, 8.7, '-mass', 12.488369227794502, 12.488369227794502, 12.488369227794502, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33007, 0.175, 4.25, 8.7)
    ...
    # Central joint node
    ops.node(3008, 5.3, 4.25, 8.7, '-mass', 17.87174355242896, 17.87174355242896, 17.87174355242896, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53008, 5.05, 4.25, 8.7)
    ops.element('elasticBeamColumn', 53008, 53008, 3008, 99999, 88888)
    ops.node(33008, 5.55, 4.25, 8.7)
    ...
    # Central joint node
    ops.node(3009, 10.6, 4.25, 8.7, '-mass', 16.12489536043382, 16.12489536043382, 16.12489536043382, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53009, 10.4, 4.25, 8.7)
    ops.element('elasticBeamColumn', 53009, 53009, 3009, 99999, 88888)
    ops.node(33009, 10.8, 4.25, 8.7)
    ...
    # Central joint node
    ops.node(3010, 13.45, 4.25, 8.7, '-mass', 16.12489536043382, 16.12489536043382, 16.12489536043382, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53010, 13.25, 4.25, 8.7)
    ops.element('elasticBeamColumn', 53010, 53010, 3010, 99999, 88888)
    ops.node(33010, 13.65, 4.25, 8.7)
    ...
    # Central joint node
    ops.node(3011, 18.75, 4.25, 8.7, '-mass', 17.871743552428963, 17.871743552428963, 17.871743552428963, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53011, 18.5, 4.25, 8.7)
    ops.element('elasticBeamColumn', 53011, 53011, 3011, 99999, 88888)
    ops.node(33011, 19.0, 4.25, 8.7)
    ...
    # Central joint node
    ops.node(3012, 24.05, 4.25, 8.7, '-mass', 12.488369227794502, 12.488369227794502, 12.488369227794502, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53012, 23.875, 4.25, 8.7)
    ...
    ops.node(63012, 24.05, 4.125, 8.7)
    ops.element('elasticBeamColumn', 63012, 63012, 3012, 99999, 77777)
    ops.node(43012, 24.05, 4.375, 8.7)
    ...
    # Central joint node
    ops.node(3013, 0.0, 8.5, 8.7, '-mass', 12.488369227794502, 12.488369227794502, 12.488369227794502, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33013, 0.175, 8.5, 8.7)
    ...
    # Central joint node
    ops.node(3014, 5.3, 8.5, 8.7, '-mass', 17.87174355242896, 17.87174355242896, 17.87174355242896, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53014, 5.05, 8.5, 8.7)
    ops.element('elasticBeamColumn', 53014, 53014, 3014, 99999, 88888)
    ops.node(33014, 5.55, 8.5, 8.7)
    ...
    # Central joint node
    ops.node(3015, 10.6, 8.5, 8.7, '-mass', 13.794181431911062, 13.794181431911062, 13.794181431911062, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53015, 10.425, 8.5, 8.7)
    ops.element('elasticBeamColumn', 53015, 53015, 3015, 99999, 88888)
    ops.node(33015, 10.775, 8.5, 8.7)
    ...
    # Central joint node
    ops.node(3016, 13.45, 8.5, 8.7, '-mass', 13.794181431911063, 13.794181431911063, 13.794181431911063, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53016, 13.275, 8.5, 8.7)
    ops.element('elasticBeamColumn', 53016, 53016, 3016, 99999, 88888)
    ops.node(33016, 13.625, 8.5, 8.7)
    ...
    # Central joint node
    ops.node(3017, 18.75, 8.5, 8.7, '-mass', 17.871743552428963, 17.871743552428963, 17.871743552428963, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53017, 18.5, 8.5, 8.7)
    ops.element('elasticBeamColumn', 53017, 53017, 3017, 99999, 88888)
    ops.node(33017, 19.0, 8.5, 8.7)
    ...
    # Central joint node
    ops.node(3018, 24.05, 8.5, 8.7, '-mass', 12.488369227794502, 12.488369227794502, 12.488369227794502, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53018, 23.875, 8.5, 8.7)
    ...
    ops.node(63018, 24.05, 8.375, 8.7)
    ops.element('elasticBeamColumn', 63018, 63018, 3018, 99999, 77777)
    ops.node(43018, 24.05, 8.625, 8.7)
    ...
    # Central joint node
    ops.node(3019, 0.0, 12.75, 8.7, '-mass', 8.52746697883099, 8.52746697883099, 8.52746697883099, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3020, 5.3, 12.75, 8.7, '-mass', 13.236381460210405, 13.236381460210405, 13.236381460210405, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(3021, 10.6, 12.75, 8.7, '-mass', 10.336642194039118, 10.336642194039118, 10.336642194039118, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(63021, 10.6, 12.625, 8.7)
    ...
    # Central joint node
    ops.node(3022, 13.45, 12.75, 8.7, '-mass', 10.33664219403912, 10.33664219403912, 10.33664219403912, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(63022, 13.45, 12.625, 8.7)
    ...
    # Central joint node
    ops.node(3023, 18.75, 12.75, 8.7, '-mass', 13.236381460210406, 13.236381460210406, 13.236381460210406, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(63023, 18.75, 12.575, 8.7)
    ...
    # Central joint node
    ops.node(3024, 24.05, 12.75, 8.7, '-mass', 8.527466978830994, 8.527466978830994, 8.527466978830994, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4002, 5.3, 0.0, 11.6, '-mass', 7.774556791505001, 7.774556791505001, 7.774556791505001, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4003, 10.6, 0.0, 11.6, '-mass', 4.622446591471155, 4.622446591471155, 4.622446591471155, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54003, 10.45, 0.0, 11.6)
    ops.element('elasticBeamColumn', 54003, 54003, 4003, 99999, 88888)
    ops.node(34003, 10.75, 0.0, 11.6)
    ...
    ops.node(44003, 10.6, 0.175, 11.6)
    ...
    # Central joint node
    ops.node(4004, 13.45, 0.0, 11.6, '-mass', 4.622446591471155, 4.622446591471155, 4.622446591471155, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54004, 13.3, 0.0, 11.6)
    ops.element('elasticBeamColumn', 54004, 54004, 4004, 99999, 88888)
    ops.node(34004, 13.6, 0.0, 11.6)
    ...
    ops.node(44004, 13.45, 0.175, 11.6)
    ...
    # Central joint node
    ops.node(4005, 18.75, 0.0, 11.6, '-mass', 7.7745567915050025, 7.7745567915050025, 7.7745567915050025, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(44005, 18.75, 0.175, 11.6)
    ...
    # Central joint node
    ops.node(4007, 0.0, 4.25, 11.6, '-mass', 7.9406118373765615, 7.9406118373765615, 7.9406118373765615, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34007, 0.175, 4.25, 11.6)
    ...
    ops.node(64007, 0.0, 4.125, 11.6)
    ops.element('elasticBeamColumn', 64007, 64007, 4007, 99999, 77777)
    ops.node(44007, 0.0, 4.375, 11.6)
    ...
    # Central joint node
    ops.node(4008, 5.3, 4.25, 11.6, '-mass', 15.257370463743946, 15.257370463743946, 15.257370463743946, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54008, 5.05, 4.25, 11.6)
    ops.element('elasticBeamColumn', 54008, 54008, 4008, 99999, 88888)
    ops.node(34008, 5.55, 4.25, 11.6)
    ...
    # Central joint node
    ops.node(4009, 10.6, 4.25, 11.6, '-mass', 12.530412689689681, 12.530412689689681, 12.530412689689681, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54009, 10.4, 4.25, 11.6)
    ops.element('elasticBeamColumn', 54009, 54009, 4009, 99999, 88888)
    ops.node(34009, 10.8, 4.25, 11.6)
    ...
    # Central joint node
    ops.node(4010, 13.45, 4.25, 11.6, '-mass', 12.530412689689681, 12.530412689689681, 12.530412689689681, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54010, 13.25, 4.25, 11.6)
    ops.element('elasticBeamColumn', 54010, 54010, 4010, 99999, 88888)
    ops.node(34010, 13.65, 4.25, 11.6)
    ...
    # Central joint node
    ops.node(4011, 18.75, 4.25, 11.6, '-mass', 15.25737046374395, 15.25737046374395, 15.25737046374395, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54011, 18.5, 4.25, 11.6)
    ops.element('elasticBeamColumn', 54011, 54011, 4011, 99999, 88888)
    ops.node(34011, 19.0, 4.25, 11.6)
    ...
    # Central joint node
    ops.node(4012, 24.05, 4.25, 11.6, '-mass', 7.940611837376563, 7.940611837376563, 7.940611837376563, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54012, 23.875, 4.25, 11.6)
    ...
    ops.node(64012, 24.05, 4.125, 11.6)
    ops.element('elasticBeamColumn', 64012, 64012, 4012, 99999, 77777)
    ops.node(44012, 24.05, 4.375, 11.6)
    ...
    # Central joint node
    ops.node(4013, 0.0, 8.5, 11.6, '-mass', 7.9406118373765615, 7.9406118373765615, 7.9406118373765615, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34013, 0.175, 8.5, 11.6)
    ...
    ops.node(64013, 0.0, 8.375, 11.6)
    ops.element('elasticBeamColumn', 64013, 64013, 4013, 99999, 77777)
    ops.node(44013, 0.0, 8.625, 11.6)
    ...
    # Central joint node
    ops.node(4014, 5.3, 8.5, 11.6, '-mass', 15.257370463743946, 15.257370463743946, 15.257370463743946, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54014, 5.05, 8.5, 11.6)
    ops.element('elasticBeamColumn', 54014, 54014, 4014, 99999, 88888)
    ops.node(34014, 5.55, 8.5, 11.6)
    ...
    # Central joint node
    ops.node(4015, 10.6, 8.5, 11.6, '-mass', 11.717040759128185, 11.717040759128185, 11.717040759128185, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54015, 10.425, 8.5, 11.6)
    ops.element('elasticBeamColumn', 54015, 54015, 4015, 99999, 88888)
    ops.node(34015, 10.775, 8.5, 11.6)
    ...
    # Central joint node
    ops.node(4016, 13.45, 8.5, 11.6, '-mass', 11.717040759128187, 11.717040759128187, 11.717040759128187, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54016, 13.275, 8.5, 11.6)
    ops.element('elasticBeamColumn', 54016, 54016, 4016, 99999, 88888)
    ops.node(34016, 13.625, 8.5, 11.6)
    ...
    # Central joint node
    ops.node(4017, 18.75, 8.5, 11.6, '-mass', 15.25737046374395, 15.25737046374395, 15.25737046374395, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54017, 18.5, 8.5, 11.6)
    ops.element('elasticBeamColumn', 54017, 54017, 4017, 99999, 88888)
    ops.node(34017, 19.0, 8.5, 11.6)
    ...
    # Central joint node
    ops.node(4018, 24.05, 8.5, 11.6, '-mass', 7.940611837376563, 7.940611837376563, 7.940611837376563, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54018, 23.875, 8.5, 11.6)
    ...
    ops.node(64018, 24.05, 8.375, 11.6)
    ops.element('elasticBeamColumn', 64018, 64018, 4018, 99999, 77777)
    ops.node(44018, 24.05, 8.625, 11.6)
    ...
    # Central joint node
    ops.node(4020, 5.3, 12.75, 11.6, '-mass', 7.774556791505001, 7.774556791505001, 7.774556791505001, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(64020, 5.3, 12.575, 11.6)
    ...
    # Central joint node
    ops.node(4021, 10.6, 12.75, 11.6, '-mass', 6.037190104334736, 6.037190104334736, 6.037190104334736, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(64021, 10.6, 12.625, 11.6)
    ...
    # Central joint node
    ops.node(4022, 13.45, 12.75, 11.6, '-mass', 6.037190104334736, 6.037190104334736, 6.037190104334736, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(64022, 13.45, 12.625, 11.6)
    ...
    # Central joint node
    ops.node(4023, 18.75, 12.75, 11.6, '-mass', 7.7745567915050025, 7.7745567915050025, 7.7745567915050025, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(64023, 18.75, 12.575, 11.6)
