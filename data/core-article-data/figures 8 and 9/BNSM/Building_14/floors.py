...
def add_floors() -> None:
    ...
    # Retained floor node
    ops.node(91000, 6.39671004, 8.04262943, 3.05)
    ...
    # Retained floor node
    ops.node(92000, 6.39227671, 8.02531145, 5.8)
    # Rigid floor diaphragm - multi-point constraints
    ...
    # Retained floor node
    ops.node(93000, 6.38643391, 8.02510355, 8.55)
    # Rigid floor diaphragm - multi-point constraints
    ...
    # Retained floor node
    ops.node(94000, 6.46966519, 8.06592275, 11.3)
    # Rigid floor diaphragm - multi-point constraints
