...
def add_joints() -> None:
    ...
    # Central joint node
    ops.node(4029, 0.0, 0.0, 1.375, '-mass', 3.3139908256880735, 3.3139908256880735, 3.3139908256880735, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34029, 0.15, 0.0, 1.375)
    ...
    # Central joint node
    ops.node(4030, 3.15, 0.0, 1.375, '-mass', 3.364449541284403, 3.364449541284403, 3.364449541284403, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4031, 0.0, 0.0, 4.125, '-mass', 3.2754587155963297, 3.2754587155963297, 3.2754587155963297, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34031, 0.15, 0.0, 4.125)
    ...
    # Central joint node
    ops.node(4032, 3.15, 0.0, 4.125, '-mass', 3.3259174311926594, 3.3259174311926594, 3.3259174311926594, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4034, 3.15, 0.0, 6.875, '-mass', 3.233409785932721, 3.233409785932721, 3.233409785932721, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(4036, 3.15, 0.0, 9.625, '-mass', 3.233409785932721, 3.233409785932721, 3.233409785932721, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Central joint node
    ops.node(1001, 0.0, 0.0, 2.75, '-mass', 2.6434250764525995, 2.6434250764525995, 2.6434250764525995, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.uniaxialMaterial('Elastic', 301001, 48114.3968)
    ops.uniaxialMaterial('Elastic', 401001, 65349.20975)
    ...
    # Central joint node
    ops.node(1002, 3.15, 0.0, 2.75, '-mass', 10.906809378185525, 10.906809378185525, 10.906809378185525, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(41002, 3.15, 0.15, 2.75)
    ops.element('elasticBeamColumn', 41002, 1002, 41002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301002, 83214.4414)
    ops.uniaxialMaterial('Elastic', 401002, 161127.62925)
    ...
    # Central joint node
    ops.node(1003, 8.5, 0.0, 2.75, '-mass', 17.54328236493374, 17.54328236493374, 17.54328236493374, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51003, 8.35, 0.0, 2.75)
    ops.element('elasticBeamColumn', 51003, 51003, 1003, 99999, 88888)
    ops.node(31003, 8.65, 0.0, 2.75)
    ...
    ops.node(41003, 8.5, 0.175, 2.75)
    ops.element('elasticBeamColumn', 41003, 1003, 41003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301003, 88371.8319)
    ops.uniaxialMaterial('Elastic', 401003, 164532.1806)
    ...
    # Central joint node
    ops.node(1004, 13.85, 0.0, 2.75, '-mass', 10.491518858307847, 10.491518858307847, 10.491518858307847, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(41004, 13.85, 0.125, 2.75)
    ops.element('elasticBeamColumn', 41004, 1004, 41004, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301004, 45293.0824)
    ops.uniaxialMaterial('Elastic', 401004, 69173.83025)
    ...
    # Central joint node
    ops.node(1005, 0.0, 4.2, 2.75, '-mass', 9.748337155963302, 9.748337155963302, 9.748337155963302, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31005, 0.125, 4.2, 2.75)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301005, 79930.4964)
    ops.uniaxialMaterial('Elastic', 401005, 67155.81565)
    ...
    # Central joint node
    ops.node(1006, 3.15, 4.2, 2.75, '-mass', 20.691517584097863, 20.691517584097863, 20.691517584097863, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51006, 2.925, 4.2, 2.75)
    ops.element('elasticBeamColumn', 51006, 51006, 1006, 99999, 88888)
    ops.node(31006, 3.375, 4.2, 2.75)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301006, 148814.90135)
    ops.uniaxialMaterial('Elastic', 401006, 192444.00355)
    ...
    # Central joint node
    ops.node(1007, 8.5, 4.2, 2.75, '-mass', 26.344464831804288, 26.344464831804288, 26.344464831804288, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51007, 8.2, 4.2, 2.75)
    ops.element('elasticBeamColumn', 51007, 51007, 1007, 99999, 88888)
    ops.node(31007, 8.8, 4.2, 2.75)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301007, 205718.17565)
    ops.uniaxialMaterial('Elastic', 401007, 291678.94445)
    ...
    # Central joint node
    ops.node(1008, 13.85, 4.2, 2.75, '-mass', 16.258776758409788, 16.258776758409788, 16.258776758409788, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51008, 13.675, 4.2, 2.75)
    ...
    ops.node(61008, 13.85, 4.075, 2.75)
    ops.element('elasticBeamColumn', 61008, 61008, 1008, 99999, 77777)
    ops.node(41008, 13.85, 4.325, 2.75)
    ops.element('elasticBeamColumn', 41008, 1008, 41008, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301008, 97224.2552)
    ops.uniaxialMaterial('Elastic', 401008, 102032.9338)
    ...
    # Central joint node
    ops.node(1009, 0.0, 8.4, 2.75, '-mass', 10.296215596330274, 10.296215596330274, 10.296215596330274, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31009, 0.125, 8.4, 2.75)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301009, 82008.89395)
    ops.uniaxialMaterial('Elastic', 401009, 68812.74995)
    ...
    # Central joint node
    ops.node(1010, 3.15, 8.4, 2.75, '-mass', 19.7409250764526, 19.7409250764526, 19.7409250764526, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51010, 2.925, 8.4, 2.75)
    ops.element('elasticBeamColumn', 51010, 51010, 1010, 99999, 88888)
    ops.node(31010, 3.375, 8.4, 2.75)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301010, 146390.34675)
    ops.uniaxialMaterial('Elastic', 401010, 189308.62535)
    ...
    # Central joint node
    ops.node(1011, 8.5, 8.4, 2.75, '-mass', 26.344464831804284, 26.344464831804284, 26.344464831804284, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51011, 8.2, 8.4, 2.75)
    ops.element('elasticBeamColumn', 51011, 51011, 1011, 99999, 88888)
    ops.node(31011, 8.8, 8.4, 2.75)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301011, 205718.17565)
    ops.uniaxialMaterial('Elastic', 401011, 291678.94445)
    ...
    # Central joint node
    ops.node(1012, 13.85, 8.4, 2.75, '-mass', 16.258776758409784, 16.258776758409784, 16.258776758409784, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51012, 13.675, 8.4, 2.75)
    ...
    ops.node(61012, 13.85, 8.275, 2.75)
    ops.element('elasticBeamColumn', 61012, 61012, 1012, 99999, 77777)
    ops.node(41012, 13.85, 8.525, 2.75)
    ops.element('elasticBeamColumn', 41012, 1012, 41012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301012, 97224.2552)
    ops.uniaxialMaterial('Elastic', 401012, 102032.9338)
    ...
    # Central joint node
    ops.node(1013, 0.0, 12.6, 2.75, '-mass', 10.296215596330276, 10.296215596330276, 10.296215596330276, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31013, 0.125, 12.6, 2.75)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301013, 82008.89395)
    ops.uniaxialMaterial('Elastic', 401013, 68812.74995)
    ...
    # Central joint node
    ops.node(1014, 3.15, 12.6, 2.75, '-mass', 19.740925076452598, 19.740925076452598, 19.740925076452598, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51014, 2.925, 12.6, 2.75)
    ops.element('elasticBeamColumn', 51014, 51014, 1014, 99999, 88888)
    ops.node(31014, 3.375, 12.6, 2.75)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301014, 146390.34675)
    ops.uniaxialMaterial('Elastic', 401014, 189308.62535)
    ...
    # Central joint node
    ops.node(1015, 8.5, 12.6, 2.75, '-mass', 26.344464831804284, 26.344464831804284, 26.344464831804284, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51015, 8.2, 12.6, 2.75)
    ops.element('elasticBeamColumn', 51015, 51015, 1015, 99999, 88888)
    ops.node(31015, 8.8, 12.6, 2.75)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301015, 205718.17565)
    ops.uniaxialMaterial('Elastic', 401015, 291678.94445)
    ...
    # Central joint node
    ops.node(1016, 13.85, 12.6, 2.75, '-mass', 16.258776758409784, 16.258776758409784, 16.258776758409784, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51016, 13.675, 12.6, 2.75)
    ...
    ops.node(61016, 13.85, 12.475, 2.75)
    ops.element('elasticBeamColumn', 61016, 61016, 1016, 99999, 77777)
    ops.node(41016, 13.85, 12.725, 2.75)
    ops.element('elasticBeamColumn', 41016, 1016, 41016, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301016, 97224.2552)
    ops.uniaxialMaterial('Elastic', 401016, 102032.9338)
    ...
    # Central joint node
    ops.node(1017, 0.0, 16.8, 2.75, '-mass', 10.296215596330276, 10.296215596330276, 10.296215596330276, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31017, 0.125, 16.8, 2.75)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301017, 82008.89395)
    ops.uniaxialMaterial('Elastic', 401017, 68812.74995)
    ...
    # Central joint node
    ops.node(1018, 3.15, 16.8, 2.75, '-mass', 19.7409250764526, 19.7409250764526, 19.7409250764526, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51018, 2.925, 16.8, 2.75)
    ops.element('elasticBeamColumn', 51018, 51018, 1018, 99999, 88888)
    ops.node(31018, 3.375, 16.8, 2.75)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301018, 146390.34675)
    ops.uniaxialMaterial('Elastic', 401018, 189308.62535)
    ...
    # Central joint node
    ops.node(1019, 8.5, 16.8, 2.75, '-mass', 26.344464831804284, 26.344464831804284, 26.344464831804284, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51019, 8.2, 16.8, 2.75)
    ops.element('elasticBeamColumn', 51019, 51019, 1019, 99999, 88888)
    ops.node(31019, 8.8, 16.8, 2.75)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301019, 205718.17565)
    ops.uniaxialMaterial('Elastic', 401019, 291678.94445)
    ...
    # Central joint node
    ops.node(1020, 13.85, 16.8, 2.75, '-mass', 16.258776758409784, 16.258776758409784, 16.258776758409784, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51020, 13.675, 16.8, 2.75)
    ...
    ops.node(61020, 13.85, 16.675, 2.75)
    ops.element('elasticBeamColumn', 61020, 61020, 1020, 99999, 77777)
    ops.node(41020, 13.85, 16.925, 2.75)
    ops.element('elasticBeamColumn', 41020, 1020, 41020, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301020, 97224.2552)
    ops.uniaxialMaterial('Elastic', 401020, 102032.9338)
    ...
    # Central joint node
    ops.node(1021, 0.0, 21.0, 2.75, '-mass', 10.296215596330274, 10.296215596330274, 10.296215596330274, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31021, 0.125, 21.0, 2.75)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301021, 82008.89395)
    ops.uniaxialMaterial('Elastic', 401021, 68812.74995)
    ...
    # Central joint node
    ops.node(1022, 3.15, 21.0, 2.75, '-mass', 19.740925076452598, 19.740925076452598, 19.740925076452598, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51022, 2.925, 21.0, 2.75)
    ops.element('elasticBeamColumn', 51022, 51022, 1022, 99999, 88888)
    ops.node(31022, 3.375, 21.0, 2.75)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301022, 146390.34675)
    ops.uniaxialMaterial('Elastic', 401022, 189308.62535)
    ...
    # Central joint node
    ops.node(1023, 8.5, 21.0, 2.75, '-mass', 26.34446483180428, 26.34446483180428, 26.34446483180428, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51023, 8.2, 21.0, 2.75)
    ops.element('elasticBeamColumn', 51023, 51023, 1023, 99999, 88888)
    ops.node(31023, 8.8, 21.0, 2.75)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301023, 205718.17565)
    ops.uniaxialMaterial('Elastic', 401023, 291678.94445)
    ...
    # Central joint node
    ops.node(1024, 13.85, 21.0, 2.75, '-mass', 16.258776758409784, 16.258776758409784, 16.258776758409784, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51024, 13.675, 21.0, 2.75)
    ...
    ops.node(61024, 13.85, 20.875, 2.75)
    ops.element('elasticBeamColumn', 61024, 61024, 1024, 99999, 77777)
    ops.node(41024, 13.85, 21.125, 2.75)
    ops.element('elasticBeamColumn', 41024, 1024, 41024, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301024, 97224.2552)
    ops.uniaxialMaterial('Elastic', 401024, 102032.9338)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301025, 42105.02095)
    ops.uniaxialMaterial('Elastic', 401025, 55205.2042)
    ...
    # Central joint node
    ops.node(1026, 3.15, 25.2, 2.75, '-mass', 13.57433613659531, 13.57433613659531, 13.57433613659531, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(61026, 3.15, 25.05, 2.75)
    ops.element('elasticBeamColumn', 61026, 61026, 1026, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301026, 72416.09015)
    ops.uniaxialMaterial('Elastic', 401026, 133903.05)
    ...
    # Central joint node
    ops.node(1027, 8.5, 25.2, 2.75, '-mass', 17.54328236493374, 17.54328236493374, 17.54328236493374, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51027, 8.35, 25.2, 2.75)
    ops.element('elasticBeamColumn', 51027, 51027, 1027, 99999, 88888)
    ops.node(31027, 8.65, 25.2, 2.75)
    ...
    ops.node(61027, 8.5, 25.025, 2.75)
    ops.element('elasticBeamColumn', 61027, 61027, 1027, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301027, 88371.8319)
    ops.uniaxialMaterial('Elastic', 401027, 164532.1806)
    ...
    # Central joint node
    ops.node(1028, 13.85, 25.2, 2.75, '-mass', 10.491518858307847, 10.491518858307847, 10.491518858307847, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(61028, 13.85, 25.075, 2.75)
    ops.element('elasticBeamColumn', 61028, 61028, 1028, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301028, 45293.0824)
    ops.uniaxialMaterial('Elastic', 401028, 69173.83025)
    ...
    # Central joint node
    ops.node(2001, 0.0, 0.0, 5.5, '-mass', 2.622400611620795, 2.622400611620795, 2.622400611620795, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302001, 40905.3163)
    ops.uniaxialMaterial('Elastic', 402001, 55587.62755)
    ...
    # Central joint node
    ops.node(2002, 3.15, 0.0, 5.5, '-mass', 10.860555555555555, 10.860555555555555, 10.860555555555555, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(42002, 3.15, 0.15, 5.5)
    ops.element('elasticBeamColumn', 42002, 2002, 42002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302002, 71490.2668)
    ops.uniaxialMaterial('Elastic', 402002, 137625.18025)
    ...
    # Central joint node
    ops.node(2003, 8.5, 0.0, 5.5, '-mass', 17.348939857288478, 17.348939857288478, 17.348939857288478, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52003, 8.35, 0.0, 5.5)
    ops.element('elasticBeamColumn', 52003, 52003, 2003, 99999, 88888)
    ops.node(32003, 8.65, 0.0, 5.5)
    ...
    ops.node(42003, 8.5, 0.175, 5.5)
    ops.element('elasticBeamColumn', 42003, 2003, 42003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302003, 65618.42435)
    ops.uniaxialMaterial('Elastic', 402003, 141974.0344)
    ...
    # Central joint node
    ops.node(2004, 13.85, 0.0, 5.5, '-mass', 10.491518858307847, 10.491518858307847, 10.491518858307847, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(42004, 13.85, 0.125, 5.5)
    ops.element('elasticBeamColumn', 42004, 2004, 42004, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302004, 39178.6491)
    ops.uniaxialMaterial('Elastic', 402004, 59994.3667)
    ...
    # Central joint node
    ops.node(2005, 0.0, 4.2, 5.5, '-mass', 9.748337155963302, 9.748337155963302, 9.748337155963302, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32005, 0.125, 4.2, 5.5)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302005, 68912.57525)
    ops.uniaxialMaterial('Elastic', 402005, 58370.5177)
    ...
    # Central joint node
    ops.node(2006, 3.15, 4.2, 5.5, '-mass', 20.531731651376152, 20.531731651376152, 20.531731651376152, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52006, 2.925, 4.2, 5.5)
    ops.element('elasticBeamColumn', 52006, 52006, 2006, 99999, 88888)
    ops.node(32006, 3.375, 4.2, 5.5)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302006, 129662.1732)
    ops.uniaxialMaterial('Elastic', 402006, 167676.13655)
    ...
    # Central joint node
    ops.node(2007, 8.5, 4.2, 5.5, '-mass', 26.023058103975536, 26.023058103975536, 26.023058103975536, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52007, 8.2, 4.2, 5.5)
    ops.element('elasticBeamColumn', 52007, 52007, 2007, 99999, 88888)
    ops.node(32007, 8.8, 4.2, 5.5)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302007, 154616.1279)
    ops.uniaxialMaterial('Elastic', 402007, 254793.76175)
    ...
    # Central joint node
    ops.node(2008, 13.85, 4.2, 5.5, '-mass', 16.17467889908257, 16.17467889908257, 16.17467889908257, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52008, 13.675, 4.2, 5.5)
    ...
    ops.node(62008, 13.85, 4.075, 5.5)
    ops.element('elasticBeamColumn', 62008, 62008, 2008, 99999, 77777)
    ops.node(42008, 13.85, 4.325, 5.5)
    ops.element('elasticBeamColumn', 42008, 2008, 42008, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302008, 84173.46815)
    ops.uniaxialMaterial('Elastic', 402008, 88789.34865)
    ...
    # Central joint node
    ops.node(2009, 0.0, 8.4, 5.5, '-mass', 10.296215596330274, 10.296215596330274, 10.296215596330274, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32009, 0.125, 8.4, 5.5)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302009, 70657.07615)
    ops.uniaxialMaterial('Elastic', 402009, 59761.7317)
    ...
    # Central joint node
    ops.node(2010, 3.15, 8.4, 5.5, '-mass', 19.58113914373089, 19.58113914373089, 19.58113914373089, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52010, 2.925, 8.4, 5.5)
    ops.element('elasticBeamColumn', 52010, 52010, 2010, 99999, 88888)
    ops.node(32010, 3.375, 8.4, 5.5)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302010, 127837.98825)
    ops.uniaxialMaterial('Elastic', 402010, 165317.1426)
    ...
    # Central joint node
    ops.node(2011, 8.5, 8.4, 5.5, '-mass', 26.023058103975536, 26.023058103975536, 26.023058103975536, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52011, 8.2, 8.4, 5.5)
    ops.element('elasticBeamColumn', 52011, 52011, 2011, 99999, 88888)
    ops.node(32011, 8.8, 8.4, 5.5)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302011, 154616.1279)
    ops.uniaxialMaterial('Elastic', 402011, 254793.76175)
    ...
    # Central joint node
    ops.node(2012, 13.85, 8.4, 5.5, '-mass', 16.17467889908257, 16.17467889908257, 16.17467889908257, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52012, 13.675, 8.4, 5.5)
    ...
    ops.node(62012, 13.85, 8.275, 5.5)
    ops.element('elasticBeamColumn', 62012, 62012, 2012, 99999, 77777)
    ops.node(42012, 13.85, 8.525, 5.5)
    ops.element('elasticBeamColumn', 42012, 2012, 42012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302012, 84173.46815)
    ops.uniaxialMaterial('Elastic', 402012, 88789.34865)
    ...
    # Central joint node
    ops.node(2013, 0.0, 12.6, 5.5, '-mass', 10.296215596330276, 10.296215596330276, 10.296215596330276, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32013, 0.125, 12.6, 5.5)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302013, 70657.07615)
    ops.uniaxialMaterial('Elastic', 402013, 59761.7317)
    ...
    # Central joint node
    ops.node(2014, 3.15, 12.6, 5.5, '-mass', 19.581139143730887, 19.581139143730887, 19.581139143730887, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52014, 2.925, 12.6, 5.5)
    ops.element('elasticBeamColumn', 52014, 52014, 2014, 99999, 88888)
    ops.node(32014, 3.375, 12.6, 5.5)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302014, 127837.98825)
    ops.uniaxialMaterial('Elastic', 402014, 165317.1426)
    ...
    # Central joint node
    ops.node(2015, 8.5, 12.6, 5.5, '-mass', 26.023058103975536, 26.023058103975536, 26.023058103975536, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52015, 8.2, 12.6, 5.5)
    ops.element('elasticBeamColumn', 52015, 52015, 2015, 99999, 88888)
    ops.node(32015, 8.8, 12.6, 5.5)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302015, 154616.1279)
    ops.uniaxialMaterial('Elastic', 402015, 254793.76175)
    ...
    # Central joint node
    ops.node(2016, 13.85, 12.6, 5.5, '-mass', 16.17467889908257, 16.17467889908257, 16.17467889908257, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52016, 13.675, 12.6, 5.5)
    ...
    ops.node(62016, 13.85, 12.475, 5.5)
    ops.element('elasticBeamColumn', 62016, 62016, 2016, 99999, 77777)
    ops.node(42016, 13.85, 12.725, 5.5)
    ops.element('elasticBeamColumn', 42016, 2016, 42016, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302016, 84173.46815)
    ops.uniaxialMaterial('Elastic', 402016, 88789.34865)
    ...
    # Central joint node
    ops.node(2017, 0.0, 16.8, 5.5, '-mass', 10.296215596330276, 10.296215596330276, 10.296215596330276, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32017, 0.125, 16.8, 5.5)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302017, 70657.07615)
    ops.uniaxialMaterial('Elastic', 402017, 59761.7317)
    ...
    # Central joint node
    ops.node(2018, 3.15, 16.8, 5.5, '-mass', 19.58113914373089, 19.58113914373089, 19.58113914373089, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52018, 2.925, 16.8, 5.5)
    ops.element('elasticBeamColumn', 52018, 52018, 2018, 99999, 88888)
    ops.node(32018, 3.375, 16.8, 5.5)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302018, 127837.98825)
    ops.uniaxialMaterial('Elastic', 402018, 165317.1426)
    ...
    # Central joint node
    ops.node(2019, 8.5, 16.8, 5.5, '-mass', 26.023058103975536, 26.023058103975536, 26.023058103975536, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52019, 8.2, 16.8, 5.5)
    ops.element('elasticBeamColumn', 52019, 52019, 2019, 99999, 88888)
    ops.node(32019, 8.8, 16.8, 5.5)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302019, 154616.1279)
    ops.uniaxialMaterial('Elastic', 402019, 254793.76175)
    ...
    # Central joint node
    ops.node(2020, 13.85, 16.8, 5.5, '-mass', 16.17467889908257, 16.17467889908257, 16.17467889908257, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52020, 13.675, 16.8, 5.5)
    ...
    ops.node(62020, 13.85, 16.675, 5.5)
    ops.element('elasticBeamColumn', 62020, 62020, 2020, 99999, 77777)
    ops.node(42020, 13.85, 16.925, 5.5)
    ops.element('elasticBeamColumn', 42020, 2020, 42020, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302020, 84173.46815)
    ops.uniaxialMaterial('Elastic', 402020, 88789.34865)
    ...
    # Central joint node
    ops.node(2021, 0.0, 21.0, 5.5, '-mass', 10.296215596330274, 10.296215596330274, 10.296215596330274, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32021, 0.125, 21.0, 5.5)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302021, 70657.07615)
    ops.uniaxialMaterial('Elastic', 402021, 59761.7317)
    ...
    # Central joint node
    ops.node(2022, 3.15, 21.0, 5.5, '-mass', 19.581139143730887, 19.581139143730887, 19.581139143730887, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52022, 2.925, 21.0, 5.5)
    ops.element('elasticBeamColumn', 52022, 52022, 2022, 99999, 88888)
    ops.node(32022, 3.375, 21.0, 5.5)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302022, 127837.98825)
    ops.uniaxialMaterial('Elastic', 402022, 165317.1426)
    ...
    # Central joint node
    ops.node(2023, 8.5, 21.0, 5.5, '-mass', 26.023058103975536, 26.023058103975536, 26.023058103975536, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52023, 8.2, 21.0, 5.5)
    ops.element('elasticBeamColumn', 52023, 52023, 2023, 99999, 88888)
    ops.node(32023, 8.8, 21.0, 5.5)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302023, 154616.1279)
    ops.uniaxialMaterial('Elastic', 402023, 254793.76175)
    ...
    # Central joint node
    ops.node(2024, 13.85, 21.0, 5.5, '-mass', 16.174678899082565, 16.174678899082565, 16.174678899082565, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52024, 13.675, 21.0, 5.5)
    ...
    ops.node(62024, 13.85, 20.875, 5.5)
    ops.element('elasticBeamColumn', 62024, 62024, 2024, 99999, 77777)
    ops.node(42024, 13.85, 21.125, 5.5)
    ops.element('elasticBeamColumn', 42024, 2024, 42024, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302024, 84173.46815)
    ops.uniaxialMaterial('Elastic', 402024, 88789.34865)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302025, 36382.3969)
    ops.uniaxialMaterial('Elastic', 402025, 47812.22465)
    ...
    # Central joint node
    ops.node(2026, 3.15, 25.2, 5.5, '-mass', 13.48182849133537, 13.48182849133537, 13.48182849133537, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(62026, 3.15, 25.05, 5.5)
    ops.element('elasticBeamColumn', 62026, 62026, 2026, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302026, 62821.26105)
    ops.uniaxialMaterial('Elastic', 402026, 115537.79805)
    ...
    # Central joint node
    ops.node(2027, 8.5, 25.2, 5.5, '-mass', 17.348939857288478, 17.348939857288478, 17.348939857288478, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52027, 8.35, 25.2, 5.5)
    ops.element('elasticBeamColumn', 52027, 52027, 2027, 99999, 88888)
    ops.node(32027, 8.65, 25.2, 5.5)
    ...
    ops.node(62027, 8.5, 25.025, 5.5)
    ops.element('elasticBeamColumn', 62027, 62027, 2027, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302027, 65618.42435)
    ops.uniaxialMaterial('Elastic', 402027, 141974.0344)
    ...
    # Central joint node
    ops.node(2028, 13.85, 25.2, 5.5, '-mass', 10.491518858307847, 10.491518858307847, 10.491518858307847, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(62028, 13.85, 25.075, 5.5)
    ops.element('elasticBeamColumn', 62028, 62028, 2028, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302028, 39178.6491)
    ops.uniaxialMaterial('Elastic', 402028, 59994.3667)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303001, 28146.06625)
    ops.uniaxialMaterial('Elastic', 403001, 39076.82975)
    ...
    # Central joint node
    ops.node(3002, 3.15, 0.0, 8.25, '-mass', 10.762925586136594, 10.762925586136594, 10.762925586136594, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(43002, 3.15, 0.125, 8.25)
    ops.element('elasticBeamColumn', 43002, 3002, 43002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303002, 39582.6939)
    ops.uniaxialMaterial('Elastic', 403002, 90009.2576)
    ...
    # Central joint node
    ops.node(3003, 8.5, 0.0, 8.25, '-mass', 17.15459734964322, 17.15459734964322, 17.15459734964322, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(43003, 8.5, 0.125, 8.25)
    ops.element('elasticBeamColumn', 43003, 3003, 43003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303003, 34702.7038)
    ops.uniaxialMaterial('Elastic', 403003, 88617.05565)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303004, 31850.3468)
    ops.uniaxialMaterial('Elastic', 403004, 48996.81845)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303005, 55758.42365)
    ops.uniaxialMaterial('Elastic', 403005, 47876.6043)
    ...
    # Central joint node
    ops.node(3006, 3.15, 4.2, 8.25, '-mass', 20.26919342507646, 20.26919342507646, 20.26919342507646, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53006, 2.975, 4.2, 8.25)
    ops.element('elasticBeamColumn', 53006, 53006, 3006, 99999, 88888)
    ops.node(33006, 3.325, 4.2, 8.25)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303006, 74039.35495)
    ops.uniaxialMaterial('Elastic', 403006, 111250.72735)
    ...
    # Central joint node
    ops.node(3007, 8.5, 4.2, 8.25, '-mass', 25.701651376146792, 25.701651376146792, 25.701651376146792, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53007, 8.25, 4.2, 8.25)
    ops.element('elasticBeamColumn', 53007, 53007, 3007, 99999, 88888)
    ops.node(33007, 8.75, 4.2, 8.25)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303007, 98608.11795)
    ops.uniaxialMaterial('Elastic', 403007, 180331.33235)
    ...
    # Central joint node
    ops.node(3008, 13.85, 4.2, 8.25, '-mass', 16.090581039755353, 16.090581039755353, 16.090581039755353, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53008, 13.725, 4.2, 8.25)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303008, 63539.9164)
    ops.uniaxialMaterial('Elastic', 403008, 62291.335)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303009, 57091.03375)
    ops.uniaxialMaterial('Elastic', 403009, 48940.07845)
    ...
    # Central joint node
    ops.node(3010, 3.15, 8.4, 8.25, '-mass', 19.318600917431194, 19.318600917431194, 19.318600917431194, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53010, 2.975, 8.4, 8.25)
    ops.element('elasticBeamColumn', 53010, 53010, 3010, 99999, 88888)
    ops.node(33010, 3.325, 8.4, 8.25)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303010, 73310.4777)
    ops.uniaxialMaterial('Elastic', 403010, 110155.52435)
    ...
    # Central joint node
    ops.node(3011, 8.5, 8.4, 8.25, '-mass', 25.70165137614679, 25.70165137614679, 25.70165137614679, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53011, 8.25, 8.4, 8.25)
    ops.element('elasticBeamColumn', 53011, 53011, 3011, 99999, 88888)
    ops.node(33011, 8.75, 8.4, 8.25)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303011, 98608.11795)
    ops.uniaxialMaterial('Elastic', 403011, 180331.33235)
    ...
    # Central joint node
    ops.node(3012, 13.85, 8.4, 8.25, '-mass', 16.09058103975535, 16.09058103975535, 16.09058103975535, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53012, 13.725, 8.4, 8.25)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303012, 63539.9164)
    ops.uniaxialMaterial('Elastic', 403012, 62291.335)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303013, 57091.03375)
    ops.uniaxialMaterial('Elastic', 403013, 48940.07845)
    ...
    # Central joint node
    ops.node(3014, 3.15, 12.6, 8.25, '-mass', 19.318600917431194, 19.318600917431194, 19.318600917431194, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53014, 2.975, 12.6, 8.25)
    ops.element('elasticBeamColumn', 53014, 53014, 3014, 99999, 88888)
    ops.node(33014, 3.325, 12.6, 8.25)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303014, 73310.4777)
    ops.uniaxialMaterial('Elastic', 403014, 110155.52435)
    ...
    # Central joint node
    ops.node(3015, 8.5, 12.6, 8.25, '-mass', 25.70165137614679, 25.70165137614679, 25.70165137614679, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53015, 8.25, 12.6, 8.25)
    ops.element('elasticBeamColumn', 53015, 53015, 3015, 99999, 88888)
    ops.node(33015, 8.75, 12.6, 8.25)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303015, 98608.11795)
    ops.uniaxialMaterial('Elastic', 403015, 180331.33235)
    ...
    # Central joint node
    ops.node(3016, 13.85, 12.6, 8.25, '-mass', 16.09058103975535, 16.09058103975535, 16.09058103975535, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53016, 13.725, 12.6, 8.25)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303016, 63539.9164)
    ops.uniaxialMaterial('Elastic', 403016, 62291.335)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303017, 57091.03375)
    ops.uniaxialMaterial('Elastic', 403017, 48940.07845)
    ...
    # Central joint node
    ops.node(3018, 3.15, 16.8, 8.25, '-mass', 19.318600917431194, 19.318600917431194, 19.318600917431194, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53018, 2.975, 16.8, 8.25)
    ops.element('elasticBeamColumn', 53018, 53018, 3018, 99999, 88888)
    ops.node(33018, 3.325, 16.8, 8.25)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303018, 73310.4777)
    ops.uniaxialMaterial('Elastic', 403018, 110155.52435)
    ...
    # Central joint node
    ops.node(3019, 8.5, 16.8, 8.25, '-mass', 25.70165137614679, 25.70165137614679, 25.70165137614679, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53019, 8.25, 16.8, 8.25)
    ops.element('elasticBeamColumn', 53019, 53019, 3019, 99999, 88888)
    ops.node(33019, 8.75, 16.8, 8.25)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303019, 98608.11795)
    ops.uniaxialMaterial('Elastic', 403019, 180331.33235)
    ...
    # Central joint node
    ops.node(3020, 13.85, 16.8, 8.25, '-mass', 16.09058103975535, 16.09058103975535, 16.09058103975535, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53020, 13.725, 16.8, 8.25)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303020, 63539.9164)
    ops.uniaxialMaterial('Elastic', 403020, 62291.335)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303021, 57091.03375)
    ops.uniaxialMaterial('Elastic', 403021, 48940.07845)
    ...
    # Central joint node
    ops.node(3022, 3.15, 21.0, 8.25, '-mass', 19.318600917431194, 19.318600917431194, 19.318600917431194, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53022, 2.975, 21.0, 8.25)
    ops.element('elasticBeamColumn', 53022, 53022, 3022, 99999, 88888)
    ops.node(33022, 3.325, 21.0, 8.25)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303022, 73310.4777)
    ops.uniaxialMaterial('Elastic', 403022, 110155.52435)
    ...
    # Central joint node
    ops.node(3023, 8.5, 21.0, 8.25, '-mass', 25.70165137614679, 25.70165137614679, 25.70165137614679, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53023, 8.25, 21.0, 8.25)
    ops.element('elasticBeamColumn', 53023, 53023, 3023, 99999, 88888)
    ops.node(33023, 8.75, 21.0, 8.25)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303023, 98608.11795)
    ops.uniaxialMaterial('Elastic', 403023, 180331.33235)
    ...
    # Central joint node
    ops.node(3024, 13.85, 21.0, 8.25, '-mass', 16.09058103975535, 16.09058103975535, 16.09058103975535, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53024, 13.725, 21.0, 8.25)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303024, 63539.9164)
    ops.uniaxialMaterial('Elastic', 403024, 62291.335)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303025, 29484.7545)
    ops.uniaxialMaterial('Elastic', 403025, 38905.3638)
    ...
    # Central joint node
    ops.node(3026, 3.15, 25.2, 8.25, '-mass', 13.33794469928644, 13.33794469928644, 13.33794469928644, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(63026, 3.15, 25.075, 8.25)
    ops.element('elasticBeamColumn', 63026, 63026, 3026, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303026, 36559.80315)
    ops.uniaxialMaterial('Elastic', 403026, 77858.5021)
    ...
    # Central joint node
    ops.node(3027, 8.5, 25.2, 8.25, '-mass', 17.15459734964322, 17.15459734964322, 17.15459734964322, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(63027, 8.5, 25.075, 8.25)
    ops.element('elasticBeamColumn', 63027, 63027, 3027, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303027, 34702.7038)
    ops.uniaxialMaterial('Elastic', 403027, 88617.05565)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303028, 31850.3468)
    ops.uniaxialMaterial('Elastic', 403028, 48996.81845)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304001, 12981.9927)
    ops.uniaxialMaterial('Elastic', 404001, 18507.97395)
    ...
    # Central joint node
    ops.node(4002, 3.15, 0.0, 11.0, '-mass', 6.179006116207951, 6.179006116207951, 6.179006116207951, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(44002, 3.15, 0.125, 11.0)
    ops.element('elasticBeamColumn', 44002, 4002, 44002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304002, 30946.8973)
    ops.uniaxialMaterial('Elastic', 404002, 42319.65905)
    ...
    # Central joint node
    ops.node(4003, 8.5, 0.0, 11.0, '-mass', 11.433241590214067, 11.433241590214067, 11.433241590214067, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(44003, 8.5, 0.125, 11.0)
    ops.element('elasticBeamColumn', 44003, 4003, 44003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304003, 41121.19925)
    ops.uniaxialMaterial('Elastic', 404003, 55862.96)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304004, 30563.81595)
    ops.uniaxialMaterial('Elastic', 404004, 41810.04185)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304005, 30413.6364)
    ops.uniaxialMaterial('Elastic', 404005, 53367.182)
    ...
    # Central joint node
    ops.node(4006, 3.15, 4.2, 11.0, '-mass', 16.680374617737005, 16.680374617737005, 16.680374617737005, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54006, 2.975, 4.2, 11.0)
    ops.element('elasticBeamColumn', 54006, 54006, 4006, 99999, 88888)
    ops.node(34006, 3.325, 4.2, 11.0)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304006, 54981.52045)
    ops.uniaxialMaterial('Elastic', 404006, 92669.6605)
    ...
    # Central joint node
    ops.node(4007, 8.5, 4.2, 11.0, '-mass', 22.5765749235474, 22.5765749235474, 22.5765749235474, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54007, 8.25, 4.2, 11.0)
    ops.element('elasticBeamColumn', 54007, 54007, 4007, 99999, 88888)
    ops.node(34007, 8.75, 4.2, 11.0)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304007, 82697.1128)
    ops.uniaxialMaterial('Elastic', 404007, 151524.8709)
    ...
    # Central joint node
    ops.node(4008, 13.85, 4.2, 11.0, '-mass', 11.512446483180426, 11.512446483180426, 11.512446483180426, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54008, 13.725, 4.2, 11.0)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304008, 41253.42505)
    ops.uniaxialMaterial('Elastic', 404008, 71364.38425)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304009, 30914.6761)
    ops.uniaxialMaterial('Elastic', 404009, 54197.9121)
    ...
    # Central joint node
    ops.node(4010, 3.15, 8.4, 11.0, '-mass', 16.899525993883792, 16.899525993883792, 16.899525993883792, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54010, 2.975, 8.4, 11.0)
    ops.element('elasticBeamColumn', 54010, 54010, 4010, 99999, 88888)
    ops.node(34010, 3.325, 8.4, 11.0)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304010, 55313.9009)
    ops.uniaxialMaterial('Elastic', 404010, 93223.2297)
    ...
    # Central joint node
    ops.node(4011, 8.5, 8.4, 11.0, '-mass', 22.5765749235474, 22.5765749235474, 22.5765749235474, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54011, 8.25, 8.4, 11.0)
    ops.element('elasticBeamColumn', 54011, 54011, 4011, 99999, 88888)
    ops.node(34011, 8.75, 8.4, 11.0)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304011, 82697.1128)
    ops.uniaxialMaterial('Elastic', 404011, 151524.8709)
    ...
    # Central joint node
    ops.node(4012, 13.85, 8.4, 11.0, '-mass', 11.512446483180426, 11.512446483180426, 11.512446483180426, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54012, 13.725, 8.4, 11.0)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304012, 41253.42505)
    ops.uniaxialMaterial('Elastic', 404012, 71364.38425)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304013, 30914.6761)
    ops.uniaxialMaterial('Elastic', 404013, 54197.9121)
    ...
    # Central joint node
    ops.node(4014, 3.15, 12.6, 11.0, '-mass', 16.899525993883792, 16.899525993883792, 16.899525993883792, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54014, 2.975, 12.6, 11.0)
    ops.element('elasticBeamColumn', 54014, 54014, 4014, 99999, 88888)
    ops.node(34014, 3.325, 12.6, 11.0)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304014, 55313.9009)
    ops.uniaxialMaterial('Elastic', 404014, 93223.2297)
    ...
    # Central joint node
    ops.node(4015, 8.5, 12.6, 11.0, '-mass', 22.5765749235474, 22.5765749235474, 22.5765749235474, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54015, 8.25, 12.6, 11.0)
    ops.element('elasticBeamColumn', 54015, 54015, 4015, 99999, 88888)
    ops.node(34015, 8.75, 12.6, 11.0)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304015, 82697.1128)
    ops.uniaxialMaterial('Elastic', 404015, 151524.8709)
    ...
    # Central joint node
    ops.node(4016, 13.85, 12.6, 11.0, '-mass', 11.512446483180426, 11.512446483180426, 11.512446483180426, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54016, 13.725, 12.6, 11.0)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304016, 41253.42505)
    ops.uniaxialMaterial('Elastic', 404016, 71364.38425)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304017, 30914.6761)
    ops.uniaxialMaterial('Elastic', 404017, 54197.9121)
    ...
    # Central joint node
    ops.node(4018, 3.15, 16.8, 11.0, '-mass', 16.899525993883792, 16.899525993883792, 16.899525993883792, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54018, 2.975, 16.8, 11.0)
    ops.element('elasticBeamColumn', 54018, 54018, 4018, 99999, 88888)
    ops.node(34018, 3.325, 16.8, 11.0)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304018, 55313.9009)
    ops.uniaxialMaterial('Elastic', 404018, 93223.2297)
    ...
    # Central joint node
    ops.node(4019, 8.5, 16.8, 11.0, '-mass', 22.5765749235474, 22.5765749235474, 22.5765749235474, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54019, 8.25, 16.8, 11.0)
    ops.element('elasticBeamColumn', 54019, 54019, 4019, 99999, 88888)
    ops.node(34019, 8.75, 16.8, 11.0)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304019, 82697.1128)
    ops.uniaxialMaterial('Elastic', 404019, 151524.8709)
    ...
    # Central joint node
    ops.node(4020, 13.85, 16.8, 11.0, '-mass', 11.512446483180426, 11.512446483180426, 11.512446483180426, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54020, 13.725, 16.8, 11.0)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304020, 41253.42505)
    ops.uniaxialMaterial('Elastic', 404020, 71364.38425)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304021, 30914.6761)
    ops.uniaxialMaterial('Elastic', 404021, 54197.9121)
    ...
    # Central joint node
    ops.node(4022, 3.15, 21.0, 11.0, '-mass', 16.899525993883792, 16.899525993883792, 16.899525993883792, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54022, 2.975, 21.0, 11.0)
    ops.element('elasticBeamColumn', 54022, 54022, 4022, 99999, 88888)
    ops.node(34022, 3.325, 21.0, 11.0)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304022, 55313.9009)
    ops.uniaxialMaterial('Elastic', 404022, 93223.2297)
    ...
    # Central joint node
    ops.node(4023, 8.5, 21.0, 11.0, '-mass', 22.5765749235474, 22.5765749235474, 22.5765749235474, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54023, 8.25, 21.0, 11.0)
    ops.element('elasticBeamColumn', 54023, 54023, 4023, 99999, 88888)
    ops.node(34023, 8.75, 21.0, 11.0)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304023, 82697.1128)
    ops.uniaxialMaterial('Elastic', 404023, 151524.8709)
    ...
    # Central joint node
    ops.node(4024, 13.85, 21.0, 11.0, '-mass', 11.512446483180426, 11.512446483180426, 11.512446483180426, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54024, 13.725, 21.0, 11.0)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304024, 41253.42505)
    ops.uniaxialMaterial('Elastic', 404024, 71364.38425)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304025, 23368.7273)
    ops.uniaxialMaterial('Elastic', 404025, 32246.0807)
    ...
    # Central joint node
    ops.node(4026, 3.15, 25.2, 11.0, '-mass', 8.69479357798165, 8.69479357798165, 8.69479357798165, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(64026, 3.15, 25.075, 11.0)
    ops.element('elasticBeamColumn', 64026, 64026, 4026, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304026, 36235.27335)
    ops.uniaxialMaterial('Elastic', 404026, 49357.4967)
    ...
    # Central joint node
    ops.node(4027, 8.5, 25.2, 11.0, '-mass', 11.433241590214067, 11.433241590214067, 11.433241590214067, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.node(64027, 8.5, 25.075, 11.0)
    ops.element('elasticBeamColumn', 64027, 64027, 4027, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304027, 41121.19925)
    ops.uniaxialMaterial('Elastic', 404027, 55862.96)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304028, 30563.81595)
    ops.uniaxialMaterial('Elastic', 404028, 41810.04185)
