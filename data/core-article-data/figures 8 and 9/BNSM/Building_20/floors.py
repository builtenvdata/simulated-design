...
def add_floors() -> None:
    ...
    # Retained floor node
    ops.node(91000, 6.69744345, 9.71938253, 3.35)
    ...
    # Retained floor node
    ops.node(92000, 6.70770647, 9.71692801, 6.15)
    # Rigid floor diaphragm - multi-point constraints
    ...
    # Retained floor node
    ops.node(93000, 6.73647223, 9.7169064, 8.95)
    # Rigid floor diaphragm - multi-point constraints
    ...
    # Retained floor node
    ops.node(94000, 6.77274033, 9.73399712, 11.75)
    # Rigid floor diaphragm - multi-point constraints
