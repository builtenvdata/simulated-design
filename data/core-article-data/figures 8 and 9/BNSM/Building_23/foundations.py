...
def add_foundations() -> None:
    ...
    # Foundation node
    ops.node(70001, 0.0, 0.0, 0.0, '-mass', 0.2036697247706422, 0.2036697247706422, 0.2036697247706422, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70025, 0.0, 25.5, 0.0, '-mass', 0.4073394495412844, 0.4073394495412844, 0.4073394495412844, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70006, 2.95, 4.25, 0.0, '-mass', 0.7241590214067279, 0.7241590214067279, 0.7241590214067279, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70026, 2.95, 25.5, 0.0, '-mass', 0.5544342507645259, 0.5544342507645259, 0.5544342507645259, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70004, 13.65, 0.0, 0.0, '-mass', 0.28287461773700306, 0.28287461773700306, 0.28287461773700306, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70028, 13.65, 25.5, 0.0, '-mass', 0.28287461773700306, 0.28287461773700306, 0.28287461773700306, 0.0, 0.0, 0.0)
