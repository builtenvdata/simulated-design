...
def add_joints() -> None:
    ...
    # Central joint node
    ops.node(4013, 6.7, 0.0, 1.5, '-mass', 3.2392392966360863, 3.2392392966360863, 3.2392392966360863, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34013, 6.9, 0.0, 1.5)
    ops.element('elasticBeamColumn', 34013, 4013, 34013, 99999, 88888)
    ops.node(24013, 6.7, 0.0, 1.3)
    ops.element('elasticBeamColumn', 24013, 24013, 4013, 99999, 99999)
    ops.node(74013, 6.7, 0.0, 1.7)
    ops.element('elasticBeamColumn', 74013, 4013, 74013, 99999, 99999)

    # Joint grid ids (x, y, z): (2, 0, 0.5)
    # Central joint node
    ops.node(4014, 9.55, 0.0, 1.5, '-mass', 3.2392392966360863, 3.2392392966360863, 3.2392392966360863, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54014, 9.35, 0.0, 1.5)
    ops.element('elasticBeamColumn', 54014, 54014, 4014, 99999, 88888)
    ops.node(24014, 9.55, 0.0, 1.3)
    ops.element('elasticBeamColumn', 24014, 24014, 4014, 99999, 99999)
    ops.node(74014, 9.55, 0.0, 1.7)
    ops.element('elasticBeamColumn', 74014, 4014, 74014, 99999, 99999)

    # Joint grid ids (x, y, z): (1, 0, 1.5)
    # Central joint node
    ops.node(4015, 6.7, 0.0, 4.5, '-mass', 3.2043769113149856, 3.2043769113149856, 3.2043769113149856, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34015, 6.9, 0.0, 4.5)
    ...
    # Central joint node
    ops.node(4016, 9.55, 0.0, 4.5, '-mass', 3.2043769113149856, 3.2043769113149856, 3.2043769113149856, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54016, 9.35, 0.0, 4.5)
    ...
    # Central joint node
    ops.node(1001, 0.0, 0.0, 3.0, '-mass', 13.828706676860348, 13.828706676860348, 13.828706676860348, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31001, 0.175, 0.0, 3.0)
    ...
    ops.node(41001, 0.0, 0.175, 3.0)
    ops.element('elasticBeamColumn', 41001, 1001, 41001, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301001, 85648.2128)
    ops.uniaxialMaterial('Elastic', 401001, 147462.0625)
    ...
    # Central joint node
    ops.node(1002, 6.7, 0.0, 3.0, '-mass', 14.552101172273192, 14.552101172273192, 14.552101172273192, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51002, 6.5, 0.0, 3.0)
    ops.element('elasticBeamColumn', 51002, 51002, 1002, 99999, 88888)
    ops.node(31002, 6.9, 0.0, 3.0)
    ...
    ops.node(41002, 6.7, 0.2, 3.0)
    ops.element('elasticBeamColumn', 41002, 1002, 41002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301002, 146602.4439)
    ops.uniaxialMaterial('Elastic', 401002, 344335.28515)
    ...
    # Central joint node
    ops.node(1003, 9.55, 0.0, 3.0, '-mass', 14.55210117227319, 14.55210117227319, 14.55210117227319, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51003, 9.35, 0.0, 3.0)
    ops.element('elasticBeamColumn', 51003, 51003, 1003, 99999, 88888)
    ops.node(31003, 9.75, 0.0, 3.0)
    ...
    ops.node(41003, 9.55, 0.2, 3.0)
    ops.element('elasticBeamColumn', 41003, 1003, 41003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301003, 146602.4439)
    ops.uniaxialMaterial('Elastic', 401003, 344335.28515)
    ...
    # Central joint node
    ops.node(1004, 16.25, 0.0, 3.0, '-mass', 13.828706676860348, 13.828706676860348, 13.828706676860348, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51004, 16.075, 0.0, 3.0)
    ...
    ops.node(41004, 16.25, 0.175, 3.0)
    ops.element('elasticBeamColumn', 41004, 1004, 41004, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301004, 85648.2128)
    ops.uniaxialMaterial('Elastic', 401004, 147462.0625)
    ...
    # Central joint node
    ops.node(1005, 0.0, 3.95, 3.0, '-mass', 21.00746432212029, 21.00746432212029, 21.00746432212029, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31005, 0.225, 3.95, 3.0)
    ...
    ops.node(61005, 0.0, 3.725, 3.0)
    ops.element('elasticBeamColumn', 61005, 61005, 1005, 99999, 77777)
    ops.node(41005, 0.0, 4.175, 3.0)
    ops.element('elasticBeamColumn', 41005, 1005, 41005, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301005, 198154.76245)
    ops.uniaxialMaterial('Elastic', 401005, 257794.27045)
    ...
    # Central joint node
    ops.node(1006, 6.7, 3.95, 3.0, '-mass', 25.571238532110094, 25.571238532110094, 25.571238532110094, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301006, 257088.69265)
    ops.uniaxialMaterial('Elastic', 401006, 418272.826)
    ...
    # Central joint node
    ops.node(1007, 9.55, 3.95, 3.0, '-mass', 25.571238532110094, 25.571238532110094, 25.571238532110094, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301007, 257088.69265)
    ops.uniaxialMaterial('Elastic', 401007, 418272.826)
    ...
    # Central joint node
    ops.node(1008, 16.25, 3.95, 3.0, '-mass', 21.007464322120285, 21.007464322120285, 21.007464322120285, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51008, 16.025, 3.95, 3.0)
    ...
    ops.node(61008, 16.25, 3.725, 3.0)
    ops.element('elasticBeamColumn', 61008, 61008, 1008, 99999, 77777)
    ops.node(41008, 16.25, 4.175, 3.0)
    ops.element('elasticBeamColumn', 41008, 1008, 41008, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301008, 198154.76245)
    ops.uniaxialMaterial('Elastic', 401008, 257794.27045)
    ...
    # Central joint node
    ops.node(1009, 0.0, 7.9, 3.0, '-mass', 13.828706676860348, 13.828706676860348, 13.828706676860348, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31009, 0.175, 7.9, 3.0)
    ...
    ops.node(61009, 0.0, 7.725, 3.0)
    ops.element('elasticBeamColumn', 61009, 61009, 1009, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301009, 85895.72585)
    ops.uniaxialMaterial('Elastic', 401009, 147878.68475)
    ...
    # Central joint node
    ops.node(1010, 6.7, 7.9, 3.0, '-mass', 17.098195718654438, 17.098195718654438, 17.098195718654438, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51010, 6.5, 7.9, 3.0)
    ops.element('elasticBeamColumn', 51010, 51010, 1010, 99999, 88888)
    ops.node(31010, 6.9, 7.9, 3.0)
    ...
    ops.node(61010, 6.7, 7.7, 3.0)
    ops.element('elasticBeamColumn', 61010, 61010, 1010, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301010, 124016.18195)
    ops.uniaxialMaterial('Elastic', 401010, 264738.9207)
    ...
    # Central joint node
    ops.node(1011, 9.55, 7.9, 3.0, '-mass', 17.098195718654434, 17.098195718654434, 17.098195718654434, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51011, 9.35, 7.9, 3.0)
    ops.element('elasticBeamColumn', 51011, 51011, 1011, 99999, 88888)
    ops.node(31011, 9.75, 7.9, 3.0)
    ...
    ops.node(61011, 9.55, 7.7, 3.0)
    ops.element('elasticBeamColumn', 61011, 61011, 1011, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301011, 124016.18195)
    ops.uniaxialMaterial('Elastic', 401011, 264738.9207)
    ...
    # Central joint node
    ops.node(1012, 16.25, 7.9, 3.0, '-mass', 13.828706676860348, 13.828706676860348, 13.828706676860348, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51012, 16.075, 7.9, 3.0)
    ...
    ops.node(61012, 16.25, 7.725, 3.0)
    ops.element('elasticBeamColumn', 61012, 61012, 1012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301012, 85895.72585)
    ops.uniaxialMaterial('Elastic', 401012, 147878.68475)
    ...
    # Central joint node
    ops.node(2001, 0.0, 0.0, 6.0, '-mass', 13.608523190621815, 13.608523190621815, 13.608523190621815, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32001, 0.175, 0.0, 6.0)
    ...
    ops.node(42001, 0.0, 0.175, 6.0)
    ops.element('elasticBeamColumn', 42001, 2001, 42001, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302001, 73943.57115)
    ops.uniaxialMaterial('Elastic', 402001, 127763.95615)
    ...
    # Central joint node
    ops.node(2002, 6.7, 0.0, 6.0, '-mass', 14.36249872579001, 14.36249872579001, 14.36249872579001, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52002, 6.5, 0.0, 6.0)
    ops.element('elasticBeamColumn', 52002, 52002, 2002, 99999, 88888)
    ops.node(32002, 6.9, 0.0, 6.0)
    ...
    ops.node(42002, 6.7, 0.2, 6.0)
    ops.element('elasticBeamColumn', 42002, 2002, 42002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302002, 126071.42165)
    ops.uniaxialMaterial('Elastic', 402002, 294422.9163)
    ...
    # Central joint node
    ops.node(2003, 9.55, 0.0, 6.0, '-mass', 14.36249872579001, 14.36249872579001, 14.36249872579001, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52003, 9.35, 0.0, 6.0)
    ops.element('elasticBeamColumn', 52003, 52003, 2003, 99999, 88888)
    ops.node(32003, 9.75, 0.0, 6.0)
    ...
    ops.node(42003, 9.55, 0.2, 6.0)
    ops.element('elasticBeamColumn', 42003, 2003, 42003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302003, 126071.42165)
    ops.uniaxialMaterial('Elastic', 402003, 294422.9163)
    ...
    # Central joint node
    ops.node(2004, 16.25, 0.0, 6.0, '-mass', 13.608523190621815, 13.608523190621815, 13.608523190621815, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52004, 16.075, 0.0, 6.0)
    ...
    ops.node(42004, 16.25, 0.175, 6.0)
    ops.element('elasticBeamColumn', 42004, 2004, 42004, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302004, 73943.57115)
    ops.uniaxialMaterial('Elastic', 402004, 127763.95615)
    ...
    # Central joint node
    ops.node(2005, 0.0, 3.95, 6.0, '-mass', 20.71388634046891, 20.71388634046891, 20.71388634046891, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32005, 0.225, 3.95, 6.0)
    ...
    ops.node(62005, 0.0, 3.725, 6.0)
    ops.element('elasticBeamColumn', 62005, 62005, 2005, 99999, 77777)
    ops.node(42005, 0.0, 4.175, 6.0)
    ops.element('elasticBeamColumn', 42005, 2005, 42005, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302005, 171423.6997)
    ops.uniaxialMaterial('Elastic', 402005, 224647.4403)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302006, 223469.074)
    ops.uniaxialMaterial('Elastic', 402006, 363575.0765)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302007, 223469.074)
    ops.uniaxialMaterial('Elastic', 402007, 363575.0765)
    ...
    # Central joint node
    ops.node(2008, 16.25, 3.95, 6.0, '-mass', 20.713886340468907, 20.713886340468907, 20.713886340468907, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52008, 16.025, 3.95, 6.0)
    ...
    ops.node(62008, 16.25, 3.725, 6.0)
    ops.element('elasticBeamColumn', 62008, 62008, 2008, 99999, 77777)
    ops.node(42008, 16.25, 4.175, 6.0)
    ops.element('elasticBeamColumn', 42008, 2008, 42008, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302008, 171423.6997)
    ops.uniaxialMaterial('Elastic', 402008, 224647.4403)
    ...
    # Central joint node
    ops.node(2009, 0.0, 7.9, 6.0, '-mass', 13.709440621814476, 13.709440621814476, 13.709440621814476, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32009, 0.175, 7.9, 6.0)
    ...
    ops.node(62009, 0.0, 7.725, 6.0)
    ops.element('elasticBeamColumn', 62009, 62009, 2009, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302009, 74231.88035)
    ops.uniaxialMaterial('Elastic', 402009, 128249.0639)
    ...
    # Central joint node
    ops.node(2010, 6.7, 7.9, 6.0, '-mass', 16.839785932721718, 16.839785932721718, 16.839785932721718, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52010, 6.5, 7.9, 6.0)
    ops.element('elasticBeamColumn', 52010, 52010, 2010, 99999, 88888)
    ops.node(32010, 6.9, 7.9, 6.0)
    ...
    ops.node(62010, 6.7, 7.7, 6.0)
    ops.element('elasticBeamColumn', 62010, 62010, 2010, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302010, 107442.29425)
    ops.uniaxialMaterial('Elastic', 402010, 228120.9281)
    ...
    # Central joint node
    ops.node(2011, 9.55, 7.9, 6.0, '-mass', 16.839785932721714, 16.839785932721714, 16.839785932721714, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52011, 9.35, 7.9, 6.0)
    ops.element('elasticBeamColumn', 52011, 52011, 2011, 99999, 88888)
    ops.node(32011, 9.75, 7.9, 6.0)
    ...
    ops.node(62011, 9.55, 7.7, 6.0)
    ops.element('elasticBeamColumn', 62011, 62011, 2011, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302011, 107442.29425)
    ops.uniaxialMaterial('Elastic', 402011, 228120.9281)
    ...
    # Central joint node
    ops.node(2012, 16.25, 7.9, 6.0, '-mass', 13.709440621814476, 13.709440621814476, 13.709440621814476, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52012, 16.075, 7.9, 6.0)
    ...
    ops.node(62012, 16.25, 7.725, 6.0)
    ops.element('elasticBeamColumn', 62012, 62012, 2012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302012, 74231.88035)
    ops.uniaxialMaterial('Elastic', 402012, 128249.0639)
    ...
    # Central joint node
    ops.node(3001, 0.0, 0.0, 9.0, '-mass', 13.231306065239552, 13.231306065239552, 13.231306065239552, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33001, 0.125, 0.0, 9.0)
    ...
    ops.node(43001, 0.0, 0.125, 9.0)
    ops.element('elasticBeamColumn', 43001, 3001, 43001, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303001, 44380.64145)
    ops.uniaxialMaterial('Elastic', 403001, 74224.39895)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303002, 64953.7764)
    ops.uniaxialMaterial('Elastic', 403002, 203666.5697)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303003, 64953.7764)
    ops.uniaxialMaterial('Elastic', 403003, 203666.5697)
    ...
    # Central joint node
    ops.node(3004, 16.25, 0.0, 9.0, '-mass', 13.23130606523955, 13.23130606523955, 13.23130606523955, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53004, 16.125, 0.0, 9.0)
    ...
    ops.node(43004, 16.25, 0.125, 9.0)
    ops.element('elasticBeamColumn', 43004, 3004, 43004, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303004, 44380.64145)
    ops.uniaxialMaterial('Elastic', 403004, 74224.39895)
    ...
    # Central joint node
    ops.node(3005, 0.0, 3.95, 9.0, '-mass', 20.10624108053007, 20.10624108053007, 20.10624108053007, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33005, 0.175, 3.95, 9.0)
    ...
    ops.node(63005, 0.0, 3.775, 9.0)
    ops.element('elasticBeamColumn', 63005, 63005, 3005, 99999, 77777)
    ops.node(43005, 0.0, 4.125, 9.0)
    ops.element('elasticBeamColumn', 43005, 3005, 43005, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303005, 101401.5974)
    ops.uniaxialMaterial('Elastic', 403005, 143880.69495)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303006, 113945.22)
    ops.uniaxialMaterial('Elastic', 403006, 238963.48645)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303007, 113945.22)
    ops.uniaxialMaterial('Elastic', 403007, 238963.48645)
    ...
    # Central joint node
    ops.node(3008, 16.25, 3.95, 9.0, '-mass', 20.10624108053007, 20.10624108053007, 20.10624108053007, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53008, 16.075, 3.95, 9.0)
    ...
    ops.node(63008, 16.25, 3.775, 9.0)
    ops.element('elasticBeamColumn', 63008, 63008, 3008, 99999, 77777)
    ops.node(43008, 16.25, 4.125, 9.0)
    ops.element('elasticBeamColumn', 43008, 3008, 43008, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303008, 101401.5974)
    ops.uniaxialMaterial('Elastic', 403008, 143880.69495)
    ...
    # Central joint node
    ops.node(3009, 0.0, 7.9, 9.0, '-mass', 13.433140927624875, 13.433140927624875, 13.433140927624875, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33009, 0.15, 7.9, 9.0)
    ...
    ops.node(63009, 0.0, 7.75, 9.0)
    ops.element('elasticBeamColumn', 63009, 63009, 3009, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303009, 48682.36455)
    ops.uniaxialMaterial('Elastic', 403009, 89658.6219)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303010, 58883.48145)
    ops.uniaxialMaterial('Elastic', 403010, 161307.66885)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303011, 58883.48145)
    ops.uniaxialMaterial('Elastic', 403011, 161307.66885)
    ...
    # Central joint node
    ops.node(3012, 16.25, 7.9, 9.0, '-mass', 13.433140927624873, 13.433140927624873, 13.433140927624873, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53012, 16.1, 7.9, 9.0)
    ...
    ops.node(63012, 16.25, 7.75, 9.0)
    ops.element('elasticBeamColumn', 63012, 63012, 3012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303012, 48682.36455)
    ops.uniaxialMaterial('Elastic', 403012, 89658.6219)
    ...
    # Central joint node
    ops.node(4001, 0.0, 0.0, 12.0, '-mass', 7.759918450560653, 7.759918450560653, 7.759918450560653, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34001, 0.125, 0.0, 12.0)
    ...
    ops.node(44001, 0.0, 0.125, 12.0)
    ops.element('elasticBeamColumn', 44001, 4001, 44001, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304001, 34033.9575)
    ops.uniaxialMaterial('Elastic', 404001, 59533.32695)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304002, 52955.14585)
    ops.uniaxialMaterial('Elastic', 404002, 86536.86075)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304003, 52955.14585)
    ops.uniaxialMaterial('Elastic', 404003, 86536.86075)
    ...
    # Central joint node
    ops.node(4004, 16.25, 0.0, 12.0, '-mass', 7.759918450560651, 7.759918450560651, 7.759918450560651, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54004, 16.125, 0.0, 12.0)
    ...
    ops.node(44004, 16.25, 0.125, 12.0)
    ops.element('elasticBeamColumn', 44004, 4004, 44004, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304004, 34033.9575)
    ops.uniaxialMaterial('Elastic', 404004, 59533.32695)
    ...
    # Central joint node
    ops.node(4005, 0.0, 3.95, 12.0, '-mass', 14.814026503567788, 14.814026503567788, 14.814026503567788, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34005, 0.175, 3.95, 12.0)
    ...
    ops.node(64005, 0.0, 3.775, 12.0)
    ops.element('elasticBeamColumn', 64005, 64005, 4005, 99999, 77777)
    ops.node(44005, 0.0, 4.125, 12.0)
    ops.element('elasticBeamColumn', 44005, 4005, 44005, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304005, 58699.6424)
    ops.uniaxialMaterial('Elastic', 404005, 145310.9785)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304006, 84908.3056)
    ops.uniaxialMaterial('Elastic', 404006, 178145.429)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304007, 84908.3056)
    ops.uniaxialMaterial('Elastic', 404007, 178145.429)
    ...
    # Central joint node
    ops.node(4008, 16.25, 3.95, 12.0, '-mass', 14.814026503567787, 14.814026503567787, 14.814026503567787, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54008, 16.075, 3.95, 12.0)
    ...
    ops.node(64008, 16.25, 3.775, 12.0)
    ops.element('elasticBeamColumn', 64008, 64008, 4008, 99999, 77777)
    ops.node(44008, 16.25, 4.125, 12.0)
    ops.element('elasticBeamColumn', 44008, 4008, 44008, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304008, 58699.6424)
    ops.uniaxialMaterial('Elastic', 404008, 145310.9785)
    ...
    # Central joint node
    ops.node(4009, 0.0, 7.9, 12.0, '-mass', 7.860835881753313, 7.860835881753313, 7.860835881753313, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34009, 0.15, 7.9, 12.0)
    ...
    ops.node(64009, 0.0, 7.75, 12.0)
    ops.element('elasticBeamColumn', 64009, 64009, 4009, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304009, 37401.94295)
    ops.uniaxialMaterial('Elastic', 404009, 72121.84275)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304010, 59325.49915)
    ops.uniaxialMaterial('Elastic', 404010, 96516.88425)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304011, 59325.49915)
    ops.uniaxialMaterial('Elastic', 404011, 96516.88425)
    ...
    # Central joint node
    ops.node(4012, 16.25, 7.9, 12.0, '-mass', 7.860835881753311, 7.860835881753311, 7.860835881753311, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54012, 16.1, 7.9, 12.0)
    ...
    ops.node(64012, 16.25, 7.75, 12.0)
    ops.element('elasticBeamColumn', 64012, 64012, 4012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304012, 37401.94295)
    ops.uniaxialMaterial('Elastic', 404012, 72121.84275)
