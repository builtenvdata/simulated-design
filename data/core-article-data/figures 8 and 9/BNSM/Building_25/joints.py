...
def add_joints() -> None:
    ...
    # Central joint node
    ops.node(1001, 0.0, 0.0, 2.6, '-mass', 9.885805300713555, 9.885805300713555, 9.885805300713555, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    ops.uniaxialMaterial('Elastic', 301001, 48109.58985)
    ops.uniaxialMaterial('Elastic', 401001, 84522.49275)
    ...
    # Central joint node
    ops.node(1002, 7.45, 0.0, 2.6, '-mass', 11.552446483180427, 11.552446483180427, 11.552446483180427, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51002, 7.325, 0.0, 2.6)
    ops.element('elasticBeamColumn', 51002, 51002, 1002, 99999, 88888)
    ops.node(31002, 7.575, 0.0, 2.6)
    ...
    ops.node(41002, 7.45, 0.125, 2.6)
    ops.element('elasticBeamColumn', 41002, 1002, 41002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301002, 52352.6004)
    ops.uniaxialMaterial('Elastic', 401002, 128046.55115)
    ...
    # Central joint node
    ops.node(1003, 10.3, 0.0, 2.6, '-mass', 11.552446483180427, 11.552446483180427, 11.552446483180427, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51003, 10.175, 0.0, 2.6)
    ops.element('elasticBeamColumn', 51003, 51003, 1003, 99999, 88888)
    ops.node(31003, 10.425, 0.0, 2.6)
    ...
    ops.node(41003, 10.3, 0.125, 2.6)
    ops.element('elasticBeamColumn', 41003, 1003, 41003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301003, 52352.6004)
    ops.uniaxialMaterial('Elastic', 401003, 128046.55115)
    ...
    # Central joint node
    ops.node(1004, 17.75, 0.0, 2.6, '-mass', 9.885805300713555, 9.885805300713555, 9.885805300713555, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301004, 48109.58985)
    ops.uniaxialMaterial('Elastic', 401004, 84522.49275)
    ...
    # Central joint node
    ops.node(1005, 0.0, 3.5, 2.6, '-mass', 12.691080530071353, 12.691080530071353, 12.691080530071353, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31005, 0.125, 3.5, 2.6)
    ...
    ops.node(61005, 0.0, 3.375, 2.6)
    ops.element('elasticBeamColumn', 61005, 61005, 1005, 99999, 77777)
    ops.node(41005, 0.0, 3.625, 2.6)
    ops.element('elasticBeamColumn', 41005, 1005, 41005, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301005, 86241.0631)
    ops.uniaxialMaterial('Elastic', 401005, 97679.5432)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301006, 120774.18815)
    ops.uniaxialMaterial('Elastic', 401006, 258547.48105)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301007, 120774.18815)
    ops.uniaxialMaterial('Elastic', 401007, 258547.48105)
    ...
    # Central joint node
    ops.node(1008, 17.75, 3.5, 2.6, '-mass', 12.691080530071352, 12.691080530071352, 12.691080530071352, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51008, 17.625, 3.5, 2.6)
    ...
    ops.node(61008, 17.75, 3.375, 2.6)
    ops.element('elasticBeamColumn', 61008, 61008, 1008, 99999, 77777)
    ops.node(41008, 17.75, 3.625, 2.6)
    ops.element('elasticBeamColumn', 41008, 1008, 41008, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301008, 86241.0631)
    ops.uniaxialMaterial('Elastic', 401008, 97679.5432)
    ...
    # Central joint node
    ops.node(1009, 0.0, 7.0, 2.6, '-mass', 12.691080530071353, 12.691080530071353, 12.691080530071353, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(31009, 0.125, 7.0, 2.6)
    ...
    ops.node(61009, 0.0, 6.875, 2.6)
    ops.element('elasticBeamColumn', 61009, 61009, 1009, 99999, 77777)
    ops.node(41009, 0.0, 7.125, 2.6)
    ops.element('elasticBeamColumn', 41009, 1009, 41009, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301009, 86241.0631)
    ops.uniaxialMaterial('Elastic', 401009, 97679.5432)
    ...
    # Central joint node
    ops.node(1010, 7.45, 7.0, 2.6, '-mass', 15.47947247706422, 15.47947247706422, 15.47947247706422, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51010, 7.275, 7.0, 2.6)
    ops.element('elasticBeamColumn', 51010, 51010, 1010, 99999, 88888)
    ops.node(31010, 7.625, 7.0, 2.6)
    ...
    ops.node(61010, 7.45, 6.825, 2.6)
    ops.element('elasticBeamColumn', 61010, 61010, 1010, 99999, 77777)
    ops.node(41010, 7.45, 7.175, 2.6)
    ops.element('elasticBeamColumn', 41010, 1010, 41010, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301010, 105654.3753)
    ops.uniaxialMaterial('Elastic', 401010, 198471.43695)
    ...
    # Central joint node
    ops.node(1011, 10.3, 7.0, 2.6, '-mass', 15.479472477064219, 15.479472477064219, 15.479472477064219, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51011, 10.125, 7.0, 2.6)
    ops.element('elasticBeamColumn', 51011, 51011, 1011, 99999, 88888)
    ops.node(31011, 10.475, 7.0, 2.6)
    ...
    ops.node(61011, 10.3, 6.825, 2.6)
    ops.element('elasticBeamColumn', 61011, 61011, 1011, 99999, 77777)
    ops.node(41011, 10.3, 7.175, 2.6)
    ops.element('elasticBeamColumn', 41011, 1011, 41011, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301011, 105654.3753)
    ops.uniaxialMaterial('Elastic', 401011, 198471.43695)
    ...
    # Central joint node
    ops.node(1012, 17.75, 7.0, 2.6, '-mass', 12.691080530071352, 12.691080530071352, 12.691080530071352, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51012, 17.625, 7.0, 2.6)
    ...
    ops.node(61012, 17.75, 6.875, 2.6)
    ops.element('elasticBeamColumn', 61012, 61012, 1012, 99999, 77777)
    ops.node(41012, 17.75, 7.125, 2.6)
    ops.element('elasticBeamColumn', 41012, 1012, 41012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301012, 86241.0631)
    ops.uniaxialMaterial('Elastic', 401012, 97679.5432)
    ...
    # Central joint node
    ops.node(1013, 0.0, 10.5, 2.6, '-mass', 9.885805300713555, 9.885805300713555, 9.885805300713555, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301013, 48109.58985)
    ops.uniaxialMaterial('Elastic', 401013, 84522.49275)
    ...
    # Central joint node
    ops.node(1014, 7.45, 10.5, 2.6, '-mass', 11.552446483180427, 11.552446483180427, 11.552446483180427, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51014, 7.325, 10.5, 2.6)
    ops.element('elasticBeamColumn', 51014, 51014, 1014, 99999, 88888)
    ops.node(31014, 7.575, 10.5, 2.6)
    ...
    ops.node(61014, 7.45, 10.375, 2.6)
    ops.element('elasticBeamColumn', 61014, 61014, 1014, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301014, 52352.6004)
    ops.uniaxialMaterial('Elastic', 401014, 128046.55115)
    ...
    # Central joint node
    ops.node(1015, 10.3, 10.5, 2.6, '-mass', 11.552446483180427, 11.552446483180427, 11.552446483180427, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(51015, 10.175, 10.5, 2.6)
    ops.element('elasticBeamColumn', 51015, 51015, 1015, 99999, 88888)
    ops.node(31015, 10.425, 10.5, 2.6)
    ...
    ops.node(61015, 10.3, 10.375, 2.6)
    ops.element('elasticBeamColumn', 61015, 61015, 1015, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301015, 52352.6004)
    ops.uniaxialMaterial('Elastic', 401015, 128046.55115)
    ...
    # Central joint node
    ops.node(1016, 17.75, 10.5, 2.6, '-mass', 9.885805300713555, 9.885805300713555, 9.885805300713555, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 301016, 48109.58985)
    ops.uniaxialMaterial('Elastic', 401016, 84522.49275)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302001, 34678.1623)
    ops.uniaxialMaterial('Elastic', 402001, 73141.74855)
    ...
    # Central joint node
    ops.node(2002, 7.45, 0.0, 5.2, '-mass', 11.509633027522934, 11.509633027522934, 11.509633027522934, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52002, 7.325, 0.0, 5.2)
    ops.element('elasticBeamColumn', 52002, 52002, 2002, 99999, 88888)
    ops.node(32002, 7.575, 0.0, 5.2)
    ...
    ops.node(42002, 7.45, 0.125, 5.2)
    ops.element('elasticBeamColumn', 42002, 2002, 42002, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302002, 37862.4094)
    ops.uniaxialMaterial('Elastic', 402002, 109988.67535)
    ...
    # Central joint node
    ops.node(2003, 10.3, 0.0, 5.2, '-mass', 11.509633027522934, 11.509633027522934, 11.509633027522934, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52003, 10.175, 0.0, 5.2)
    ops.element('elasticBeamColumn', 52003, 52003, 2003, 99999, 88888)
    ops.node(32003, 10.425, 0.0, 5.2)
    ...
    ops.node(42003, 10.3, 0.125, 5.2)
    ops.element('elasticBeamColumn', 42003, 2003, 42003, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302003, 37862.4094)
    ops.uniaxialMaterial('Elastic', 402003, 109988.67535)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302004, 34678.1623)
    ops.uniaxialMaterial('Elastic', 402004, 73141.74855)
    ...
    # Central joint node
    ops.node(2005, 0.0, 3.5, 5.2, '-mass', 12.605453618756368, 12.605453618756368, 12.605453618756368, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32005, 0.125, 3.5, 5.2)
    ...
    ops.node(62005, 0.0, 3.375, 5.2)
    ops.element('elasticBeamColumn', 62005, 62005, 2005, 99999, 77777)
    ops.node(42005, 0.0, 3.625, 5.2)
    ops.element('elasticBeamColumn', 42005, 2005, 42005, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302005, 62830.45185)
    ops.uniaxialMaterial('Elastic', 402005, 85182.4689)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302006, 86042.72785)
    ops.uniaxialMaterial('Elastic', 402006, 223457.4037)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302007, 86042.72785)
    ops.uniaxialMaterial('Elastic', 402007, 223457.4037)
    ...
    # Central joint node
    ops.node(2008, 17.75, 3.5, 5.2, '-mass', 12.605453618756366, 12.605453618756366, 12.605453618756366, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52008, 17.625, 3.5, 5.2)
    ...
    ops.node(62008, 17.75, 3.375, 5.2)
    ops.element('elasticBeamColumn', 62008, 62008, 2008, 99999, 77777)
    ops.node(42008, 17.75, 3.625, 5.2)
    ops.element('elasticBeamColumn', 42008, 2008, 42008, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302008, 62830.45185)
    ops.uniaxialMaterial('Elastic', 402008, 85182.4689)
    ...
    # Central joint node
    ops.node(2009, 0.0, 7.0, 5.2, '-mass', 12.605453618756368, 12.605453618756368, 12.605453618756368, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(32009, 0.125, 7.0, 5.2)
    ...
    ops.node(62009, 0.0, 6.875, 5.2)
    ops.element('elasticBeamColumn', 62009, 62009, 2009, 99999, 77777)
    ops.node(42009, 0.0, 7.125, 5.2)
    ops.element('elasticBeamColumn', 42009, 2009, 42009, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302009, 62830.45185)
    ops.uniaxialMaterial('Elastic', 402009, 85182.4689)
    ...
    # Central joint node
    ops.node(2010, 7.45, 7.0, 5.2, '-mass', 15.203019877675839, 15.203019877675839, 15.203019877675839, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52010, 7.275, 7.0, 5.2)
    ops.element('elasticBeamColumn', 52010, 52010, 2010, 99999, 88888)
    ops.node(32010, 7.625, 7.0, 5.2)
    ...
    ops.node(62010, 7.45, 6.825, 5.2)
    ops.element('elasticBeamColumn', 62010, 62010, 2010, 99999, 77777)
    ops.node(42010, 7.45, 7.175, 5.2)
    ops.element('elasticBeamColumn', 42010, 2010, 42010, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302010, 77423.13845)
    ops.uniaxialMaterial('Elastic', 402010, 172645.54145)
    ...
    # Central joint node
    ops.node(2011, 10.3, 7.0, 5.2, '-mass', 15.203019877675837, 15.203019877675837, 15.203019877675837, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52011, 10.125, 7.0, 5.2)
    ops.element('elasticBeamColumn', 52011, 52011, 2011, 99999, 88888)
    ops.node(32011, 10.475, 7.0, 5.2)
    ...
    ops.node(62011, 10.3, 6.825, 5.2)
    ops.element('elasticBeamColumn', 62011, 62011, 2011, 99999, 77777)
    ops.node(42011, 10.3, 7.175, 5.2)
    ops.element('elasticBeamColumn', 42011, 2011, 42011, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302011, 77423.13845)
    ops.uniaxialMaterial('Elastic', 402011, 172645.54145)
    ...
    # Central joint node
    ops.node(2012, 17.75, 7.0, 5.2, '-mass', 12.605453618756366, 12.605453618756366, 12.605453618756366, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52012, 17.625, 7.0, 5.2)
    ...
    ops.node(62012, 17.75, 6.875, 5.2)
    ops.element('elasticBeamColumn', 62012, 62012, 2012, 99999, 77777)
    ops.node(42012, 17.75, 7.125, 5.2)
    ops.element('elasticBeamColumn', 42012, 2012, 42012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302012, 62830.45185)
    ops.uniaxialMaterial('Elastic', 402012, 85182.4689)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302013, 34678.1623)
    ops.uniaxialMaterial('Elastic', 402013, 73141.74855)
    ...
    # Central joint node
    ops.node(2014, 7.45, 10.5, 5.2, '-mass', 11.509633027522934, 11.509633027522934, 11.509633027522934, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52014, 7.325, 10.5, 5.2)
    ops.element('elasticBeamColumn', 52014, 52014, 2014, 99999, 88888)
    ops.node(32014, 7.575, 10.5, 5.2)
    ...
    ops.node(62014, 7.45, 10.375, 5.2)
    ops.element('elasticBeamColumn', 62014, 62014, 2014, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302014, 37862.4094)
    ops.uniaxialMaterial('Elastic', 402014, 109988.67535)
    ...
    # Central joint node
    ops.node(2015, 10.3, 10.5, 5.2, '-mass', 11.509633027522934, 11.509633027522934, 11.509633027522934, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(52015, 10.175, 10.5, 5.2)
    ops.element('elasticBeamColumn', 52015, 52015, 2015, 99999, 88888)
    ops.node(32015, 10.425, 10.5, 5.2)
    ...
    ops.node(62015, 10.3, 10.375, 5.2)
    ops.element('elasticBeamColumn', 62015, 62015, 2015, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302015, 37862.4094)
    ops.uniaxialMaterial('Elastic', 402015, 109988.67535)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 302016, 34678.1623)
    ops.uniaxialMaterial('Elastic', 402016, 73141.74855)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303001, 27953.2425)
    ops.uniaxialMaterial('Elastic', 403001, 59482.7479)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303002, 30699.1768)
    ops.uniaxialMaterial('Elastic', 403002, 88403.3688)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303003, 30699.1768)
    ops.uniaxialMaterial('Elastic', 403003, 88403.3688)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303004, 27953.2425)
    ops.uniaxialMaterial('Elastic', 403004, 59482.7479)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303005, 51246.88835)
    ops.uniaxialMaterial('Elastic', 403005, 70436.1556)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303006, 58811.8792)
    ops.uniaxialMaterial('Elastic', 403006, 128833.51695)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303007, 58811.8792)
    ops.uniaxialMaterial('Elastic', 403007, 128833.51695)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303008, 51246.88835)
    ops.uniaxialMaterial('Elastic', 403008, 70436.1556)
    ...
    # Central joint node
    ops.node(3009, 0.0, 7.0, 7.8, '-mass', 12.605453618756368, 12.605453618756368, 12.605453618756368, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(33009, 0.125, 7.0, 7.8)
    ...
    ops.node(63009, 0.0, 6.875, 7.8)
    ops.element('elasticBeamColumn', 63009, 63009, 3009, 99999, 77777)
    ops.node(43009, 0.0, 7.125, 7.8)
    ops.element('elasticBeamColumn', 43009, 3009, 43009, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303009, 51246.88835)
    ops.uniaxialMaterial('Elastic', 403009, 70436.1556)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303010, 53826.22555)
    ops.uniaxialMaterial('Elastic', 403010, 101250.13685)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303011, 53826.22555)
    ops.uniaxialMaterial('Elastic', 403011, 101250.13685)
    ...
    # Central joint node
    ops.node(3012, 17.75, 7.0, 7.8, '-mass', 12.605453618756366, 12.605453618756366, 12.605453618756366, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(53012, 17.625, 7.0, 7.8)
    ...
    ops.node(63012, 17.75, 6.875, 7.8)
    ops.element('elasticBeamColumn', 63012, 63012, 3012, 99999, 77777)
    ops.node(43012, 17.75, 7.125, 7.8)
    ops.element('elasticBeamColumn', 43012, 3012, 43012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303012, 51246.88835)
    ops.uniaxialMaterial('Elastic', 403012, 70436.1556)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303013, 27953.2425)
    ops.uniaxialMaterial('Elastic', 403013, 59482.7479)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303014, 30699.1768)
    ops.uniaxialMaterial('Elastic', 403014, 88403.3688)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303015, 30699.1768)
    ops.uniaxialMaterial('Elastic', 403015, 88403.3688)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 303016, 27953.2425)
    ops.uniaxialMaterial('Elastic', 403016, 59482.7479)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304001, 27809.7229)
    ops.uniaxialMaterial('Elastic', 404001, 49052.5667)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304002, 31494.186)
    ops.uniaxialMaterial('Elastic', 404002, 55158.93035)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304003, 31494.186)
    ops.uniaxialMaterial('Elastic', 404003, 55158.93035)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304004, 27809.7229)
    ops.uniaxialMaterial('Elastic', 404004, 49052.5667)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304005, 39986.7163)
    ops.uniaxialMaterial('Elastic', 404005, 70083.2886)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304006, 40406.04335)
    ops.uniaxialMaterial('Elastic', 404006, 70782.7977)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304007, 40406.04335)
    ops.uniaxialMaterial('Elastic', 404007, 70782.7977)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304008, 39986.7163)
    ops.uniaxialMaterial('Elastic', 404008, 70083.2886)
    ...
    # Central joint node
    ops.node(4009, 0.0, 7.0, 10.4, '-mass', 8.701732925586134, 8.701732925586134, 8.701732925586134, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(34009, 0.125, 7.0, 10.4)
    ...
    ops.node(64009, 0.0, 6.875, 10.4)
    ops.element('elasticBeamColumn', 64009, 64009, 4009, 99999, 77777)
    ops.node(44009, 0.0, 7.125, 10.4)
    ops.element('elasticBeamColumn', 44009, 4009, 44009, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304009, 39986.7163)
    ops.uniaxialMaterial('Elastic', 404009, 70083.2886)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304010, 43513.5523)
    ops.uniaxialMaterial('Elastic', 404010, 75968.10105)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304011, 43513.5523)
    ops.uniaxialMaterial('Elastic', 404011, 75968.10105)
    ...
    # Central joint node
    ops.node(4012, 17.75, 7.0, 10.4, '-mass', 8.701732925586134, 8.701732925586134, 8.701732925586134, 0.0, 0.0, 0.0)
    # Rigid-joint offset elements
    ops.node(54012, 17.625, 7.0, 10.4)
    ...
    ops.node(64012, 17.75, 6.875, 10.4)
    ops.element('elasticBeamColumn', 64012, 64012, 4012, 99999, 77777)
    ops.node(44012, 17.75, 7.125, 10.4)
    ops.element('elasticBeamColumn', 44012, 4012, 44012, 99999, 77777)
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304012, 39986.7163)
    ops.uniaxialMaterial('Elastic', 404012, 70083.2886)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304013, 27809.7229)
    ops.uniaxialMaterial('Elastic', 404013, 49052.5667)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304014, 31494.186)
    ops.uniaxialMaterial('Elastic', 404014, 55158.93035)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304015, 31494.186)
    ops.uniaxialMaterial('Elastic', 404015, 55158.93035)
    ...
    # Joint flexibility element: Elastic
    ops.uniaxialMaterial('Elastic', 304016, 27809.7229)
    ops.uniaxialMaterial('Elastic', 404016, 49052.5667)
