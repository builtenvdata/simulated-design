...
def do_gravity() -> None:
    ...
    ops.eleLoad('-ele', 4045, '-type', '-beamUniform', -20.2, 0.0)
    ...
    ops.eleLoad('-ele', 1029, '-type', '-beamUniform', -16.52, 0.0)
    ops.eleLoad('-ele', 1030, '-type', '-beamUniform', -17.42, 0.0)
    ops.eleLoad('-ele', 1031, '-type', '-beamUniform', -17.42, 0.0)
    ops.eleLoad('-ele', 1032, '-type', '-beamUniform', -16.52, 0.0)
    ops.eleLoad('-ele', 1033, '-type', '-beamUniform', -16.52, 0.0)
    ops.eleLoad('-ele', 1034, '-type', '-beamUniform', -20.14159091, 0.0)
    ops.eleLoad('-ele', 1035, '-type', '-beamUniform', -20.14159091, 0.0)
    ops.eleLoad('-ele', 1036, '-type', '-beamUniform', -16.52, 0.0)
    ops.eleLoad('-ele', 1037, '-type', '-beamUniform', -16.52, 0.0)
    ops.eleLoad('-ele', 1038, '-type', '-beamUniform', -20.14159091, 0.0)
    ops.eleLoad('-ele', 1039, '-type', '-beamUniform', -20.14159091, 0.0)
    ops.eleLoad('-ele', 1040, '-type', '-beamUniform', -16.52, 0.0)
    ...
    ops.load(170001, 0.0, 0.0, -3.024, 0.0, 0.0, 0.0)
    ops.load(121001, 0.0, 0.0, -3.024, 0.0, 0.0, 0.0)
    ops.load(170004, 0.0, 0.0, -3.024, 0.0, 0.0, 0.0)
    ops.load(121004, 0.0, 0.0, -3.024, 0.0, 0.0, 0.0)
    ops.load(170005, 0.0, 0.0, -5.376, 0.0, 0.0, 0.0)
    ops.load(121005, 0.0, 0.0, -5.376, 0.0, 0.0, 0.0)
    ...
    ops.load(170008, 0.0, 0.0, -5.376, 0.0, 0.0, 0.0)
    ops.load(121008, 0.0, 0.0, -5.376, 0.0, 0.0, 0.0)
    ops.load(170009, 0.0, 0.0, -5.376, 0.0, 0.0, 0.0)
    ops.load(121009, 0.0, 0.0, -5.376, 0.0, 0.0, 0.0)
    ops.load(170010, 0.0, 0.0, -6.804, 0.0, 0.0, 0.0)
    ops.load(121010, 0.0, 0.0, -6.804, 0.0, 0.0, 0.0)
    ops.load(170011, 0.0, 0.0, -6.804, 0.0, 0.0, 0.0)
    ops.load(121011, 0.0, 0.0, -6.804, 0.0, 0.0, 0.0)
    ops.load(170012, 0.0, 0.0, -5.376, 0.0, 0.0, 0.0)
    ops.load(121012, 0.0, 0.0, -5.376, 0.0, 0.0, 0.0)
    ops.load(170013, 0.0, 0.0, -3.024, 0.0, 0.0, 0.0)
    ops.load(121013, 0.0, 0.0, -3.024, 0.0, 0.0, 0.0)
    ops.load(170014, 0.0, 0.0, -4.116, 0.0, 0.0, 0.0)
    ops.load(121014, 0.0, 0.0, -4.116, 0.0, 0.0, 0.0)
    ops.load(170015, 0.0, 0.0, -4.116, 0.0, 0.0, 0.0)
    ops.load(121015, 0.0, 0.0, -4.116, 0.0, 0.0, 0.0)
    ops.load(170016, 0.0, 0.0, -3.024, 0.0, 0.0, 0.0)
    ops.load(121016, 0.0, 0.0, -3.024, 0.0, 0.0, 0.0)
    ...
    ops.load(171011, 0.0, 0.0, -6.804, 0.0, 0.0, 0.0)
    ops.load(122011, 0.0, 0.0, -6.804, 0.0, 0.0, 0.0)
    ops.load(171012, 0.0, 0.0, -5.376, 0.0, 0.0, 0.0)
    ops.load(122012, 0.0, 0.0, -5.376, 0.0, 0.0, 0.0)
    ops.load(171013, 0.0, 0.0, -3.024, 0.0, 0.0, 0.0)
    ops.load(122013, 0.0, 0.0, -3.024, 0.0, 0.0, 0.0)
