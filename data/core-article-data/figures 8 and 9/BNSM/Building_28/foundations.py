...
def add_foundations() -> None:
    ...
    # Foundation node
    ops.node(70013, 0.0, 11.0, 0.0, '-mass', 0.23700305810397554, 0.23700305810397554, 0.23700305810397554, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70002, 4.25, 0.0, 0.0, '-mass', 0.3412844036697248, 0.3412844036697248, 0.3412844036697248, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70008, 4.25, 5.5, 0.0, '-mass', 0.7678899082568807, 0.7678899082568807, 0.7678899082568807, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70014, 4.25, 11.0, 0.0, '-mass', 0.3412844036697248, 0.3412844036697248, 0.3412844036697248, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70005, 15.6, 0.0, 0.0, '-mass', 0.3412844036697248, 0.3412844036697248, 0.3412844036697248, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70011, 15.6, 5.5, 0.0, '-mass', 0.7678899082568807, 0.7678899082568807, 0.7678899082568807, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70017, 15.6, 11.0, 0.0, '-mass', 0.3412844036697248, 0.3412844036697248, 0.3412844036697248, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70006, 19.85, 0.0, 0.0, '-mass', 0.23700305810397554, 0.23700305810397554, 0.23700305810397554, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70018, 19.85, 11.0, 0.0, '-mass', 0.23700305810397554, 0.23700305810397554, 0.23700305810397554, 0.0, 0.0, 0.0)
