...
def add_foundations() -> None:
    ...
    # Foundation node
    ops.node(70001, 0.0, 0.0, 0.0, '-mass', 0.2110091743119266, 0.2110091743119266, 0.2110091743119266, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70005, 0.0, 4.45, 0.0, '-mass', 0.37981651376146786, 0.37981651376146786, 0.37981651376146786, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70009, 0.0, 8.9, 0.0, '-mass', 0.37981651376146786, 0.37981651376146786, 0.37981651376146786, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70013, 0.0, 13.35, 0.0, '-mass', 0.2110091743119266, 0.2110091743119266, 0.2110091743119266, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70002, 5.45, 0.0, 0.0, '-mass', 0.16880733944954127, 0.16880733944954127, 0.16880733944954127, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70006, 5.45, 4.45, 0.0, '-mass', 0.6189602446483181, 0.6189602446483181, 0.6189602446483181, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70010, 5.45, 8.9, 0.0, '-mass', 0.492354740061162, 0.492354740061162, 0.492354740061162, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70014, 5.45, 13.35, 0.0, '-mass', 0.2954128440366972, 0.2954128440366972, 0.2954128440366972, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70003, 8.35, 0.0, 0.0, '-mass', 0.16880733944954127, 0.16880733944954127, 0.16880733944954127, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70007, 8.35, 4.45, 0.0, '-mass', 0.6189602446483181, 0.6189602446483181, 0.6189602446483181, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70011, 8.35, 8.9, 0.0, '-mass', 0.492354740061162, 0.492354740061162, 0.492354740061162, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70015, 8.35, 13.35, 0.0, '-mass', 0.2954128440366972, 0.2954128440366972, 0.2954128440366972, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70004, 13.8, 0.0, 0.0, '-mass', 0.2110091743119266, 0.2110091743119266, 0.2110091743119266, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70008, 13.8, 4.45, 0.0, '-mass', 0.37981651376146786, 0.37981651376146786, 0.37981651376146786, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70012, 13.8, 8.9, 0.0, '-mass', 0.37981651376146786, 0.37981651376146786, 0.37981651376146786, 0.0, 0.0, 0.0)
    ...
    # Foundation node
    ops.node(70016, 13.8, 13.35, 0.0, '-mass', 0.2110091743119266, 0.2110091743119266, 0.2110091743119266, 0.0, 0.0, 0.0)
