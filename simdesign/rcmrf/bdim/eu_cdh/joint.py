...
class Joint(JointBase):
    ...
    Attributes
    ----------
    left_beam : ~simdesign.rcmrf.bdim.eu_cdh.beam.Beam, optional
        Beam located on the left side of the joint (along global X-axis).
    right_beam : ~simdesign.rcmrf.bdim.eu_cdh.beam.Beam, optional
        Beam located on the right side of the joint (along global X-axis).
    front_beam : ~simdesign.rcmrf.bdim.eu_cdh.beam.Beam, optional
        Beam located in front of the joint (along global Y-axis).
    rear_beam : ~simdesign.rcmrf.bdim.eu_cdh.beam.Beam, optional
        Beam located behind the joint (along global Y-axis).
    top_column : ~simdesign.rcmrf.bdim.eu_cdh.column.Column, optional
        Column located on top of the joint (along global Z-axis).
    bottom_column : ~simdesign.rcmrf.bdim.eu_cdh.column.Column, optional
