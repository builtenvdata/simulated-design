...
the ``eu_cdm`` design class in the BDIM layer.
"""
...
class Steel(SteelBase):
    """Steel model implementation for design class ``eu_cdm``.
...
class Concrete(ConcreteBase):
    """Concrete model implementation for design class ``eu_cdm``.
...
class MaterialData(MaterialDataBase):
    """Materials data model implementation for design class ``eu_cdm``.
...
class Materials(MaterialsBase):
    """Materials implementation for design class ``eu_cdm``.
