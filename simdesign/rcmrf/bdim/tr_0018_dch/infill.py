...
masonry infill walls for the ``tr_0018_dch`` design class in the BDIM layer.
"""
...
class Infill(InfillBase):
    """Masonry infill wall implementation for design class ``tr_0018_dch``.

    This class extends ``InfillBase`` by narrowing the attribute types.

    Attributes
    ----------
    beams : List[~simdesign.rcmrf.bdim.tr_0018_dch.beam.Beam or None]
