"""
Pydantic models for defining loads in tr_0018_dch buildings.
"""
...
class Variable(VariableBase):
    """
    Model representing live loads (Q) for design class tr_0018_dch.
...
class Combination(CombinationBase):
    """
    Model representing a load combination for design class tr_0018_dch.
...
class LoadsData(LoadsDataBase):
    """
    Model representing the format of loads data for design class tr_0018_dch.
