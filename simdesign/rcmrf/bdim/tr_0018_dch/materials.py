...
class Steel(SteelBase):
    """Steel model implementation for design class ``tr_0018_dch``.
...
class Concrete(ConcreteBase):
    """Concrete model implementation for design class ``tr_0018_dch``.
...
class MaterialData(MaterialDataBase):
    """Materials data model implementation for design class ``tr_0018_dch``.
...
class Materials(MaterialsBase):
    """Materials implementation for design class ``tr_0018_dch``.
