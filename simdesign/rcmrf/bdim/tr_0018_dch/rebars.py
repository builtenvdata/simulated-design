...
detailing of structural members for the``tr_0018_dch`` design class in the BDIM
layer.
"""
...
class Rebars(RebarsBase):
    """Rebars implementation for design class ``tr_0018_dch``.

    This class extends ``RebarsBase`` by providing the detailing rules
    appropriate for the ``tr_0018_dch`` design class.
