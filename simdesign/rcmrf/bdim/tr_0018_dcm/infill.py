...
masonry infill walls for the ``tr_0018_dcm`` design class in the BDIM layer.
"""
...
class Infill(InfillBase):
    """Masonry infill wall implementation for design class ``tr_0018_dcm``.

    This class extends ``InfillBase`` by narrowing the attribute types.

    Attributes
    ----------
    beams : List[~simdesign.rcmrf.bdim.tr_0018_dcm.beam.Beam or None]
