...
the ``tr_post18_dch`` design class in the BDIM layer.
"""
...
class Steel(SteelBase):
    """Steel model implementation for design class ``tr_post18_dch``.
...
class Concrete(ConcreteBase):
    """Concrete model implementation for design class ``tr_post18_dch``.
...
class MaterialData(MaterialDataBase):
    """Materials data model implementation for design class ``tr_post18_dch``.
...
class Materials(MaterialsBase):
    """Materials implementation for design class ``tr_post18_dch``.
