...
beam-column joints for the ``tr_post18_dcm`` design class in the BDIM layer.
"""
...
class Joint(JointBase):
    """Joint implementation for design class ``tr_post18_dcm``.

    This class extends ``JointBase`` by narrowing the attribute types.

    Attributes
    ----------
    left_beam : ~simdesign.rcmrf.bdim.tr_post18_dcm.beam.Beam, optional
        Beam located on the left side of the joint (along global X-axis).
    right_beam : ~simdesign.rcmrf.bdim.tr_post18_dcm.beam.Beam, optional
        Beam located on the right side of the joint (along global X-axis).
    front_beam : ~simdesign.rcmrf.bdim.tr_post18_dcm.beam.Beam, optional
        Beam located in front of the joint (along global Y-axis).
    rear_beam : ~simdesign.rcmrf.bdim.tr_post18_dcm.beam.Beam, optional
        Beam located behind the joint (along global Y-axis).
    top_column : ~simdesign.rcmrf.bdim.tr_post18_dcm.column.Column, optional
        Column located on top of the joint (along global Z-axis).
    bottom_column : ~simdesign.rcmrf.bdim.tr_post18_dcm.column.Column, optional
