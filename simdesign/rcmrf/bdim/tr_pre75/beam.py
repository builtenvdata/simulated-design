...
class Beam(BeamBase):
    ...
    def verify_section_adequacy(self) -> None:
        ...
        z = 0.9 * d
        # Maximum of envelope shear forces
    ...
    def compute_required_longitudinal_reinforcement(self) -> None:
        ...
        # Verify minimum reinforcement
        rhol_min = 0.003  # TS500-1975, Section 7.4.2
        Asl_min = rhol_min * self.Ag
        Asl_avail = self.Asl_top_req + self.Asl_bot_req
        mask = Asl_avail < Asl_min
        Asl_incr = (Asl_min - Asl_avail[mask]) / 2
        self.Asl_top_req[mask] += Asl_incr
        self.Asl_bot_req[mask] += Asl_incr
