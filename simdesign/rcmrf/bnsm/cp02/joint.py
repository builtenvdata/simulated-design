"""This module provides the joint class implementations for the ``CP02`` model
in the BNSM layer.
"""
...
class StairsJoint(StairsJointBase):
    """Stairs joint implementation for the ``CP02`` model.
...
class FloorJoint(FloorJointBase):
    """Floor joint implementation for the ``CP02`` model.
