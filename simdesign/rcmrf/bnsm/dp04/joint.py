"""This module provides the joint class implementations for the ``DP04`` model
in the BNSM layer.
"""
...
class StairsJoint(StairsJointBase):
    """Stairs joint implementation for the ``DP04`` model
...
class FloorJoint(FloorJointBase):
    """Floor joint implementation for the ``DP04`` model.
