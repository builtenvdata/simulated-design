...
(BCIM → BDIM → BNSM). Both classes inherit from
:class:`~simdesign.rcmrf.geometry.base.GeometryBase` and
...
- :class:`~simdesign.rcmrf.geometry.standard.StandardGeometry` —
  regular frames with uniform bay widths and
...
- :class:`~simdesign.rcmrf.geometry.custom.CustomGeometry` —
  irregular or non-uniform frames loaded from an
